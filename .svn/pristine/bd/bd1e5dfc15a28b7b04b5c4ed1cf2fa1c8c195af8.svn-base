 ...
 * Date: 26.09.2004
 * Time: 10:08:15
 * $Id: EducationTypeList.java,v 1.3 2010/12/05 07:56:44 ohapon Exp $
 */
public class EducationTypeList extends EXTListForm {

    public EducationTypeList() throws ApplicationException {
        super(GUIPersonalityEnvironment.getResources());
        initialize();
    }

    public EducationTypeList(Window window) throws ApplicationException {
    ...
    private void initialize() {
        ...
        this.setEntityEditFormClass(EducationTypeEdit.class);
    }
