...
/** 
 * @author Oleh Hapon
 * $Id: SaleOrderItemEditForm.java,v 1.3 2010/04/28 06:31:06 ohapon Exp $
 */

public class SaleOrderItemEditForm extends AbstractGoodsDocumentItemEditForm {
    ...
    public  SaleOrderItemEditForm(Composite parent, int style) {
	super(parent, style);
	initialize();
    }
	...
	goodsLabel.setText(Messages.getString("SaleOrderItemEditForm.goodsLabel.text")); //$NON-NLS-1$
	...
	gridData.widthHint = 300;
    	...
    	productFeatureLabel.setText(Messages.getString("SaleOrderItemEditForm.productFeatureLabel.text")); //$NON-NLS-1$
	...
	unitLabel = new Label(this, SWT.NONE);
    	unitLabel.setText(Messages.getString("SaleOrderItemEditForm.unitLabel.text")); //$NON-NLS-1$
    	...
    	currencyBasePriceLabel.setText(Messages.getString("SaleOrderItemEditForm.currencyBasePriceLabel.text")); //$NON-NLS-1$
    	...
    	unitRateLabel.setText(Messages.getString("SaleOrderItemEditForm.unitRateLabel.text")); //$NON-NLS-1$
    	...
    	pricePercentLabel.setText(Messages.getString("SaleOrderItemEditForm.pricePercentLabel.text")); //$NON-NLS-1$
	...
	quantityLabel.setText(Messages.getString("SaleOrderItemEditForm.quantityLabel.text")); //$NON-NLS-1$
    	...
    	currencyPriceLabel.setText(Messages.getString("SaleOrderItemEditForm.currencyPriceLabel.text")); //$NON-NLS-1$
	...
	label = new Label(this, SWT.NONE);
    	...
    	currencyAmountLabel.setText(Messages.getString("SaleOrderItemEditForm.currencyAmountLabel.text")); //$NON-NLS-1$
	...
	taxLabel.setText(Messages.getString("SaleOrderItemEditForm.taxLabel.text")); //$NON-NLS-1$
	...
	currencyTaxAmountLabel.setText(Messages.getString("SaleOrderItemEditForm.currencyTaxAmountLabel.text")); //$NON-NLS-1$
