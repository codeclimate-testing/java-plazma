...
public class AddressEdit extends AbstractContactableItemEdit {
	...
	addressStringField.setText(addressFormatter.formatFullAddress((City) cityComboEdit
		.getValue(), (Locality) localityComboEdit.getValue(),
		(StreetType) streetTypeComboEdit.getValue(), streetField
			.getText(), houseNumField.getText(),
		"", // caseNumField.getText(),
		(ApartmentType) appartmentTypeComboEdit.getValue(),
		appartNumField.getText()));
    }
	...
	if (panelController == null) {
	    if (LocaleManager.COMPLEX_ADDRESS.equals(LocaleManager
		    .getAddressVariant())) {
	...
	public JPanel createPanel() throws ApplicationException {
	    ...
	    /*
                 ...
                 * editPanel.add(houseNumField);
                 * 
                 * editPanel.addByX(Box.createHorizontalStrut(10));
                 * editPanel.addByX(appartmentTypeComboEdit);
                 * 
                 * editPanel.addByX(appartNumField);
                 */
