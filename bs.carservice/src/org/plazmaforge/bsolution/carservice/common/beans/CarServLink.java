...
public class CarServLink extends BaseEntity {
    
    private CarServ carServ;
    
    private CarServ carServLink;
    ...
    public CarServ getCarServLink() {
        return carServLink;
    }

    public void setCarServLink(CarServ carServLink) {
        this.carServLink = carServLink;
    }
