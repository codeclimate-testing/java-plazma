 ...
 * Date: 19.09.2004
 * Time: 12:21:05
 * $Id: MilitaryStatusList.java,v 1.3 2010/12/05 07:56:44 ohapon Exp $
 */
public class MilitaryStatusList extends EXTListForm {

    public MilitaryStatusList() throws ApplicationException {
        super(GUIPersonalityEnvironment.getResources());
        initialize();
    }

    public MilitaryStatusList(Window window) throws ApplicationException {
    ...
    private void initialize() {
        ...
        this.setEntityEditFormClass(MilitaryStatusEdit.class);
    }
