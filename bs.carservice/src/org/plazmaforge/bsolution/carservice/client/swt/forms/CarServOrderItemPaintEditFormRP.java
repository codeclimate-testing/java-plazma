 ...
 *  
 * @author Oleh Hapon
 * $Id: CarServOrderItemPaintEditFormRP.java,v 1.4 2010/04/28 06:23:01 ohapon Exp $
 */
public class CarServOrderItemPaintEditFormRP extends AbstractGoodsDocumentItemEditForm {
    ...
    public CarServOrderItemPaintEditFormRP(Composite parent, int style) {
	super(parent, style);
	initialize();
    }
	...
	goodsLabel.setText(Messages.getString("CarServOrderItemEditForm.paintLabel.text")); //$NON-NLS-1$
