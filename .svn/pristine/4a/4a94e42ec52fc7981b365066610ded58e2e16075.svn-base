...
/** 
 * @author Oleh Hapon
 * $Id: InventoryRestListForm.java,v 1.5 2010/12/05 07:57:21 ohapon Exp $
 */

public class InventoryRestListForm extends AbstractFinanceDocumentListForm {
    ...
    public InventoryRestListForm(Composite parent, int style) {
	super(parent, style);
	initialize();
    }
	...
	setTitle(Messages.getString("InventoryRestListForm.title")); //$NON-NLS-1$
        ...
        documentNoColumn.setText(Messages.getString("InventoryRestListForm.documentNoColumn.text")); //$NON-NLS-1$

        documentDateColumn = new TableColumn(table, SWT.NONE);
        documentDateColumn.setMoveable(true);
        documentDateColumn.setWidth(100);
        documentDateColumn.setText(Messages.getString("InventoryRestListForm.documentDateColumn.text")); //$NON-NLS-1$

        warehouseColumn = new TableColumn(table, SWT.NONE);
        warehouseColumn.setMoveable(true);
        warehouseColumn.setWidth(200);
        warehouseColumn.setText(Messages.getString("InventoryRestListForm.warehouseColumn.text")); //$NON-NLS-1$
        ...
        mtrlResponsibleColumn.setText(Messages.getString("InventoryRestListForm.mtrlResponsibleColumn.text")); //$NON-NLS-1$
    	
              
        currencyTotalColumn = new TableColumn(table, SWT.RIGHT);
        currencyTotalColumn.setMoveable(true);
        currencyTotalColumn.setWidth(120);
        currencyTotalColumn.setText(Messages.getString("InventoryRestListForm.totalColumn.text")); //$NON-NLS-1$
    }
