...
public class UnitListForm_Gen extends ListForm {


  public UnitListForm_Gen() {
  }
  ...
  public void createUI() {
    ...
    setName("UnitListForm");
    setType("ListForm");
    setTitle(getString("UnitListForm.title"));
  ...
  public Composite createContent() {
    ...
    column1.setText(getString("UnitListForm.codeColumn.text"));
    ...
    column2.setText(getString("UnitListForm.nameColumn.text"));
    ...
    column3.setText(getString("UnitListForm.fullNameColumn.text"));
    column3.setWidth(300);
    column3.setProperty("fullName");
