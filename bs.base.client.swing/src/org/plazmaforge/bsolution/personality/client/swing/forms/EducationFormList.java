 ...
 * Date: 26.09.2004
 * Time: 10:07:24
 * $Id: EducationFormList.java,v 1.3 2010/12/05 07:56:44 ohapon Exp $
 */
public class EducationFormList extends EXTListForm {

    public EducationFormList() throws ApplicationException {
        super(GUIPersonalityEnvironment.getResources());
        initialize();
    }

    public EducationFormList(Window window) throws ApplicationException {
    ...
    private void initialize() {
        ...
        this.setEntityEditFormClass(EducationFormEdit.class);
