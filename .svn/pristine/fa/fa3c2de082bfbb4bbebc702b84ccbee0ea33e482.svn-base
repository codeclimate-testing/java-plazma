...
/** 
 * @author Oleh Hapon
 * $Id: SaleInvoiceListForm.java,v 1.7 2010/12/05 07:57:21 ohapon Exp $
 */

public class SaleInvoiceListForm extends AbstractFinanceDocumentListForm {
    ...
    public SaleInvoiceListForm(Composite parent, int style) {
	super(parent, style);
	initialize();
    }
	...
	setTitle(Messages.getString("SaleInvoiceListForm.title")); //$NON-NLS-1$
        ...
        documentNoColumn.setText(Messages.getString("SaleInvoiceListForm.documentNoColumn.text")); //$NON-NLS-1$

        documentDateColumn = new TableColumn(table, SWT.NONE);
        documentDateColumn.setMoveable(true);
        documentDateColumn.setWidth(100);
        documentDateColumn.setText(Messages.getString("SaleInvoiceListForm.documentDateColumn.text")); //$NON-NLS-1$

        partnerColumn = new TableColumn(table, SWT.NONE);
        partnerColumn.setMoveable(true);
        partnerColumn.setWidth(200);
        partnerColumn.setText(Messages.getString("SaleInvoiceListForm.partnerColumn.text")); //$NON-NLS-1$
	...
	documentStatusColumn = new TableColumn(table, SWT.NONE);
    	...
    	documentStatusColumn.setText(Messages.getString("SaleInvoiceListForm.documentStatusColumn.text")); //$NON-NLS-1$

        responsibleColumn = new TableColumn(table, SWT.NONE);
        responsibleColumn.setMoveable(true);
        responsibleColumn.setWidth(200);
        responsibleColumn.setText(Messages.getString("SaleInvoiceListForm.responsibleColumn.text")); //$NON-NLS-1$
        ...
        warehouseColumn.setText(Messages.getString("SaleInvoiceListForm.warehouseColumn.text")); //$NON-NLS-1$
        ...
        mtrlResponsibleColumn.setText(Messages.getString("SaleInvoiceListForm.mtrlResponsibleColumn.text")); //$NON-NLS-1$
        */
        ////
        ...
        currencyTotalColumn.setText(Messages.getString("SaleInvoiceListForm.currencyTotalColumn.text"));    	 //$NON-NLS-1$
    	
        currencyColumn = new TableColumn(table, SWT.CENTER);
        currencyColumn.setMoveable(true);
        currencyColumn.setWidth(70);
        currencyColumn.setText(Messages.getString("SaleInvoiceListForm.currencyColumn.text")); //$NON-NLS-1$
        
        totalColumn = new TableColumn(table, SWT.RIGHT);
        totalColumn.setMoveable(true);
        totalColumn.setWidth(120);
        totalColumn.setText(Messages.getString("SaleInvoiceListForm.totalColumn.text")); //$NON-NLS-1$
        
        projectColumn = new TableColumn(table, SWT.NONE);
        projectColumn.setMoveable(true);
        projectColumn.setWidth(200);
        projectColumn.setText(Messages.getString("SaleInvoiceListForm.projectColumn.text")); //$NON-NLS-1$
    }
