...
/** 
 * @author Oleh Hapon
 * $Id: PurchaseOrderListForm.java,v 1.7 2010/12/05 07:57:18 ohapon Exp $
 */

public class PurchaseOrderListForm extends AbstractFinanceDocumentListForm {
    ...
    public PurchaseOrderListForm(Composite parent, int style) {
	super(parent, style);
	initialize();
    }
	...
	setTitle(Messages.getString("PurchaseOrderListForm.title")); //$NON-NLS-1$
	TableColumn paidColumn;
        ...
        documentNoColumn.setText(Messages.getString("PurchaseOrderListForm.documentNoColumn.text")); //$NON-NLS-1$

        documentDateColumn = new TableColumn(table, SWT.NONE);
        documentDateColumn.setMoveable(true);
        documentDateColumn.setWidth(100);
        documentDateColumn.setText(Messages.getString("PurchaseOrderListForm.documentDateColumn.text")); //$NON-NLS-1$

        partnerColumn = new TableColumn(table, SWT.NONE);
        partnerColumn.setMoveable(true);
        partnerColumn.setWidth(200);
        partnerColumn.setText(Messages.getString("PurchaseOrderListForm.partnerColumn.text")); //$NON-NLS-1$
	...
	documentStatusColumn = new TableColumn(table, SWT.NONE);
    	...
    	documentStatusColumn.setText(Messages.getString("PurchaseOrderListForm.documentStatusColumn.text")); //$NON-NLS-1$
    	
        warehouseColumn = new TableColumn(table, SWT.NONE);
        warehouseColumn.setMoveable(true);
        warehouseColumn.setWidth(100);
        warehouseColumn.setText(Messages.getString("PurchaseOrderListForm.warehouseColumn.text")); //$NON-NLS-1$
    	
        responsibleColumn = new TableColumn(table, SWT.NONE);
        responsibleColumn.setMoveable(true);
        responsibleColumn.setWidth(200);
        responsibleColumn.setText(Messages.getString("PurchaseOrderListForm.responsibleColumn.text")); //$NON-NLS-1$
    	
        currencyTotalColumn = new TableColumn(table, SWT.RIGHT);
        currencyTotalColumn.setMoveable(true);
        currencyTotalColumn.setWidth(120);
        currencyTotalColumn.setText(Messages.getString("PurchaseOrderListForm.currencyTotalColumn.text"));    	 //$NON-NLS-1$
    	
        currencyColumn = new TableColumn(table, SWT.CENTER);
        currencyColumn.setMoveable(true);
        currencyColumn.setWidth(70);
        currencyColumn.setText(Messages.getString("PurchaseOrderListForm.currencyColumn.text")); //$NON-NLS-1$
        
        totalColumn = new TableColumn(table, SWT.RIGHT);
        totalColumn.setMoveable(true);
        totalColumn.setWidth(120);
        totalColumn.setText(Messages.getString("PurchaseOrderListForm.totalColumn.text")); //$NON-NLS-1$
    }
