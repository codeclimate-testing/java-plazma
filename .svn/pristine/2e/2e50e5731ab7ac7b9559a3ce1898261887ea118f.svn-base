...
import org.plazmaforge.bsolution.goods.client.swing.forms.GoodsIncomeEdit;
 ...
 * Date: 28.06.2004
 * Time: 15:42:31
 * $Id: GoodsIncomeList.java,v 1.3 2010/12/05 07:56:43 ohapon Exp $
 */
public class GoodsIncomeList extends AbstractFinanceDocumentList {

    public GoodsIncomeList() throws ApplicationException {
        super(GUIGoodsEnvironment.getResources());
        initialize();
    }

    public GoodsIncomeList(Window window) throws ApplicationException {
    ...
    private void initialize() {
        ...
        this.setEntityEditFormClass(GoodsIncomeEdit.class);
    }
