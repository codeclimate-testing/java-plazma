...
/**
 * @author Oleh Hapon Date: 26.12.2004 Time: 9:42:15 $Id: DocumentListAction.java,v 1.3 2010/12/05 07:56:48 ohapon Exp $
 */
public class DocumentListAction extends GUIDocumentAction {

    public void perform(ActionEvent e) throws ApplicationException {
	SwingFormManager.showListForm(DocumentList.class);
    }
}
