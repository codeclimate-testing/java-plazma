...
public interface EnterpriseContextService extends ContextService, EntityService<EnterpriseContext, Integer> {

    EnterpriseContext load() throws DAOException, FinderException;
