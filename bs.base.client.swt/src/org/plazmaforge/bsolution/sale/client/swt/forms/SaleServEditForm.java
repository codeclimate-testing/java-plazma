...
/** 
 * @author Oleh Hapon
 * $Id: SaleServEditForm.java,v 1.7 2010/12/05 07:57:21 ohapon Exp $
 */

public class SaleServEditForm extends AbstractGoodsDocumentEditForm {
     ...
     * @param style
     */
    public SaleServEditForm(Composite parent, int style) {
	super(parent, style);
	initialize();
	...
	setTitle(Messages.getString("SaleServEditForm.title")); //$NON-NLS-1$
	...
	setLayout(gridLayout);
    	...
    	generalTabItem.setText(Messages.getString("SaleServEditForm.generalTabItem.text")); //$NON-NLS-1$
    	...
    	documentNoLabel.setText(Messages.getString("SaleServEditForm.documentNoLabel.text")); //$NON-NLS-1$
	...
	documentDateLabel.setText(Messages.getString("SaleServEditForm.documentDateLabel.text")); //$NON-NLS-1$
	...
	gridData = new GridData(SWT.FILL, SWT.CENTER, false, false);
    	...
    	partnerLabel.setText(Messages.getString("SaleServEditForm.partnerLabel.text")); //$NON-NLS-1$
	...
	responsibleLabel.setText(Messages.getString("SaleServEditForm.responsibleLabel.text")); //$NON-NLS-1$
	...
	contractLabel.setText(Messages.getString("SaleServEditForm.contractLabel.text")); //$NON-NLS-1$
	...
	reasonDocumentLabel.setText(Messages.getString("SaleServEditForm.reasonDocumentLabel.text")); //$NON-NLS-1$
	...
	reasonLabel.setText(Messages.getString("SaleServEditForm.reasonLabel.text")); //$NON-NLS-1$
	...
	gridData = new GridData();
    	...
    	currencyLabel.setText(Messages.getString("SaleServEditForm.currencyLabel.text")); //$NON-NLS-1$
	...
	currencyRateLabel.setText(Messages.getString("SaleServEditForm.currencyRateLabel.text")); //$NON-NLS-1$
	...
	currencyRateDateLabel.setText(Messages.getString("SaleServEditForm.currencyRateDateLabel.text")); //$NON-NLS-1$
	...
	warehouseLabel.setText(Messages.getString("SaleServEditForm.warehouseLabel.text")); //$NON-NLS-1$
	...
	mtrlResponsibleLabel.setText(Messages.getString("SaleServEditForm.mtrlResponsibleLabel.text")); //$NON-NLS-1$
	...
	gridData = new GridData(SWT.FILL, SWT.CENTER, false, false, 5, 1);
    	...
    	noteTabItem.setText(Messages.getString("SaleServEditForm.noteTabItem.text")); //$NON-NLS-1$
    	...
    	createItemPanel();
    	createSummaryPanel();
    	AttributeValueView attributeView = new AttributeValueView(itemsTabFolder, SaleServ.class);
    	FileView fileView = new FileView(itemsTabFolder, SaleServ.class);
    ...
    private void createItemPanel() {
        ...
        productTabItem.setText(Messages.getString("SaleServEditForm.productTabItem.text")); //$NON-NLS-1$
        ...
        productNameColumn.setText(Messages.getString("SaleServEditForm.productNameColumn.text")); //$NON-NLS-1$

        TableColumn unitNameColumn = new TableColumn(productTable, SWT.CENTER);
        unitNameColumn.setWidth(60);
        unitNameColumn.setText(Messages.getString("SaleServEditForm.unitNameColumn.text")); //$NON-NLS-1$

        TableColumn unitRateColumn = new TableColumn(productTable, SWT.RIGHT);
        unitRateColumn.setWidth(50);
        unitRateColumn.setText(Messages.getString("SaleServEditForm.unitRateColumn.text")); //$NON-NLS-1$

        TableColumn quantityColumn = new TableColumn(productTable, SWT.RIGHT);
        quantityColumn.setWidth(80);
        quantityColumn.setText(Messages.getString("SaleServEditForm.quantityColumn.text")); //$NON-NLS-1$
         
        TableColumn currencyPriceColumn = new TableColumn(productTable, SWT.RIGHT);
        currencyPriceColumn.setWidth(80);
        currencyPriceColumn.setText(Messages.getString("SaleServEditForm.currencyPriceColumn.text")); //$NON-NLS-1$
        
        TableColumn currencyPriceAmountColumn = new TableColumn(productTable, SWT.RIGHT);
        currencyPriceAmountColumn.setWidth(80);
        currencyPriceAmountColumn.setText(Messages.getString("SaleServEditForm.currencyAmountColumn.text"));  //$NON-NLS-1$
        
        TableColumn currencyTaxAmountColumn = new TableColumn(productTable, SWT.RIGHT);
        currencyTaxAmountColumn.setWidth(80);
        currencyTaxAmountColumn.setText(Messages.getString("SaleServEditForm.currencyTaxAmountColumn.text"));  //$NON-NLS-1$
	...
	gridData = new GridData(SWT.FILL, SWT.CENTER, false, false);
    	...
    	currencyTotalLabel.setText(Messages.getString("SaleServEditForm.currencyTotalLabel.text")); //$NON-NLS-1$
	...
	gridData = new GridData();
    	...
    	currencyTaxTotalLabel.setText(Messages.getString("SaleServEditForm.currencyTaxTotalLabel.text")); //$NON-NLS-1$
	...
	gridData = new GridData();
    	...
    	currencyTotalWithTaxLabel.setText(Messages.getString("SaleServEditForm.currencyTotalWithTaxLabel.text")); //$NON-NLS-1$
	...
	public ProductItemProvider() {
	    setParentEntityClass(SaleServ.class); // OWNER
	    setEntityClass(SaleServItem.class); // FORM ID
    ...
    private SaleServ getSaleServ() {
	return (SaleServ) getEntity();
    }

    protected void initData() throws ApplicationException {
	super.initData();
	getSaleServ().setPartner(EnterpriseEnvironment.getCustomer());
    }
