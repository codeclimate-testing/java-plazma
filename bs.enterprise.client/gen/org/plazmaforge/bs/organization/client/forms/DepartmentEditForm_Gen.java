...
public class DepartmentEditForm_Gen extends EditForm {


  public DepartmentEditForm_Gen() {
  }
  ...
  public Composite createContent() {
    ...
    label1.setText(getString("DepartmentEditForm.codeLabel.text"));
    content.add(label1);
    ...
    label2.setText(getString("DepartmentEditForm.nameLabel.text"));
    content.add(label2);
