 ...
 * Date: 08.03.2004
 * Time: 18:36:13
 * $Id: PersonListAction.java,v 1.3 2010/12/05 07:56:43 ohapon Exp $
 */
public class PersonListAction  extends GUIPersonalityAction {

    public void perform(ActionEvent e) throws ApplicationException {
        SwingFormManager.showListForm(PersonList.class);
    }
