...
/** 
 * @author Oleh Hapon
 * $Id: InventoryMoveItemEditForm.java,v 1.2 2010/04/28 06:31:08 ohapon Exp $
 */

public class InventoryMoveItemEditForm extends AbstractGoodsDocumentItemEditForm {
    ...
    public  InventoryMoveItemEditForm(Composite parent, int style) {
	super(parent, style);
	initialize();
    }
	...
	goodsLabel.setText(Messages.getString("InventoryMoveItemEditForm.goodsLabel.text")); //$NON-NLS-1$
	...
	unitLabel = new Label(this, SWT.NONE);
    	unitLabel.setText(Messages.getString("InventoryMoveItemEditForm.unitLabel.text")); //$NON-NLS-1$
	...
	unitRateLabel.setText(Messages.getString("InventoryMoveItemEditForm.unitRateLabel.text")); //$NON-NLS-1$
	...
	quantityLabel.setText(Messages.getString("InventoryMoveItemEditForm.quantityLabel.text")); //$NON-NLS-1$
	...
	currencyPriceLabel.setText(Messages.getString("InventoryMoveItemEditForm.currencyPriceLabel.text")); //$NON-NLS-1$
	...
	currencyAmountLabel.setText(Messages.getString("InventoryMoveItemEditForm.currencyAmountLabel.text")); //$NON-NLS-1$
