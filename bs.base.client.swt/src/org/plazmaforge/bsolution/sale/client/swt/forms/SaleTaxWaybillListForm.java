...
/** 
 * @author Oleh Hapon
 * $Id: SaleTaxWaybillListForm.java,v 1.6 2010/12/05 07:57:21 ohapon Exp $
 */

public class SaleTaxWaybillListForm extends AbstractFinanceDocumentListForm {
    ...
    public SaleTaxWaybillListForm(Composite parent, int style) {
	super(parent, style);
	initialize();
    }
	...
	setTitle(Messages.getString("SaleTaxWaybillListForm.title")); //$NON-NLS-1$
        ...
        documentNoColumn.setText(Messages.getString("SaleTaxWaybillListForm.documentNoColumn.text")); //$NON-NLS-1$

        documentDateColumn = new TableColumn(table, SWT.NONE);
        documentDateColumn.setMoveable(true);
        documentDateColumn.setWidth(100);
        documentDateColumn.setText(Messages.getString("SaleTaxWaybillListForm.documentDateColumn.text")); //$NON-NLS-1$

        partnerColumn = new TableColumn(table, SWT.NONE);
        partnerColumn.setMoveable(true);
        partnerColumn.setWidth(200);
        partnerColumn.setText(Messages.getString("SaleTaxWaybillListForm.partnerColumn.text")); //$NON-NLS-1$
       	
        responsibleColumn = new TableColumn(table, SWT.NONE);
        responsibleColumn.setMoveable(true);
        responsibleColumn.setWidth(200);
        responsibleColumn.setText(Messages.getString("SaleTaxWaybillListForm.responsibleColumn.text")); //$NON-NLS-1$
        
        currencyTotalColumn = new TableColumn(table, SWT.RIGHT);
        currencyTotalColumn.setMoveable(true);
        currencyTotalColumn.setWidth(120);
        currencyTotalColumn.setText(Messages.getString("SaleTaxWaybillListForm.currencyTotalColumn.text"));    	 //$NON-NLS-1$
    	
        currencyColumn = new TableColumn(table, SWT.CENTER);
        currencyColumn.setMoveable(true);
        currencyColumn.setWidth(70);
        currencyColumn.setText(Messages.getString("SaleTaxWaybillListForm.currencyColumn.text")); //$NON-NLS-1$
        
        totalColumn = new TableColumn(table, SWT.RIGHT);
        totalColumn.setMoveable(true);
        totalColumn.setWidth(120);
        totalColumn.setText(Messages.getString("SaleTaxWaybillListForm.totalColumn.text")); //$NON-NLS-1$
    }
