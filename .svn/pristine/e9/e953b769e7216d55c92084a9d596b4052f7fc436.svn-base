...
/** 
 * @author Oleh Hapon
 * $Id: PurchasePlanItemEditForm.java,v 1.2 2010/04/28 06:31:04 ohapon Exp $
 */

public class PurchasePlanItemEditForm extends AbstractGoodsDocumentItemEditForm {
    ...
    public  PurchasePlanItemEditForm(Composite parent, int style) {
	super(parent, style);
	initialize();
    }
	...
	goodsLabel.setText(Messages.getString("PurchasePlanItemEditForm.goodsLabel.text")); //$NON-NLS-1$
	...
	unitLabel = new Label(this, SWT.NONE);
    	unitLabel.setText(Messages.getString("PurchasePlanItemEditForm.unitLabel.text")); //$NON-NLS-1$
	...
	unitRateLabel.setText(Messages.getString("PurchasePlanItemEditForm.unitRateLabel.text")); //$NON-NLS-1$
	...
	quantityLabel.setText(Messages.getString("PurchasePlanItemEditForm.quantityLabel.text")); //$NON-NLS-1$
	...
	currencyPriceLabel.setText(Messages.getString("PurchasePlanItemEditForm.currencyPriceLabel.text")); //$NON-NLS-1$
	...
	currencyAmountLabel.setText(Messages.getString("PurchasePlanItemEditForm.currencyAmountLabel.text")); //$NON-NLS-1$
	...
	taxLabel.setText(Messages.getString("PurchasePlanItemEditForm.taxLabel.text")); //$NON-NLS-1$
	...
	currencyTaxAmountLabel.setText(Messages.getString("PurchasePlanItemEditForm.currencyTaxAmountLabel.text")); //$NON-NLS-1$
