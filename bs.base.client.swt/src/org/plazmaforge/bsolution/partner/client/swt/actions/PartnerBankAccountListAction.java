...
/** 
 * @author Oleh Hapon
 * $Id: PartnerBankAccountListAction.java,v 1.2 2010/04/28 06:31:03 ohapon Exp $
 */

public class PartnerBankAccountListAction extends AbstractListFormAction  {

    public Class getListFormClass() {
	return PartnerBankAccountListForm.class;
    }
