...
public class CarMtrlFindReportListForm extends AbstractFinanceDocumentListForm {
    ...
    public CarMtrlFindReportListForm(Composite parent, int style) {
	super(parent, style);
	initialize();
    }
	...
	setTitle(Messages.getString("CarMtrlFindReportListForm.title")); //$NON-NLS-1$
        TableColumn tableColumn;
        
        TableColumn documentNoColumn;
        TableColumn documentDateColumn;
        TableColumn carMtrlFindRequestColumn;
        ...
        documentNoColumn.setText(Messages.getString("CarMtrlFindReportListForm.documentNoColumn.text")); //$NON-NLS-1$

        documentDateColumn = new TableColumn(table, SWT.NONE);
        documentDateColumn.setMoveable(true);
        documentDateColumn.setWidth(70);
        documentDateColumn.setText(Messages.getString("CarMtrlFindReportListForm.documentDateColumn.text")); //$NON-NLS-1$

        carMtrlFindRequestColumn = new TableColumn(table, SWT.NONE);
        carMtrlFindRequestColumn.setMoveable(true);
        carMtrlFindRequestColumn.setWidth(200);
        carMtrlFindRequestColumn.setText(Messages.getString("CarMtrlFindReportListForm.carMtrlFindRequestColumn.text")); //$NON-NLS-1$
    	
    	
        carServOrderColumn = new TableColumn(table, SWT.NONE);
        carServOrderColumn.setMoveable(true);
        carServOrderColumn.setWidth(200);
        carServOrderColumn.setText(Messages.getString("CarMtrlFindReportListForm.carServOrderColumn.text")); //$NON-NLS-1$
    	
        currencyTotalColumn = new TableColumn(table, SWT.RIGHT);
        currencyTotalColumn.setMoveable(true);
        currencyTotalColumn.setWidth(110);
        currencyTotalColumn.setText(Messages.getString("CarMtrlFindReportListForm.currencyTotalColumn.text"));    	 //$NON-NLS-1$
    	
        currencyColumn = new TableColumn(table, SWT.CENTER);
        currencyColumn.setMoveable(true);
        currencyColumn.setWidth(70);
        currencyColumn.setText(Messages.getString("CarMtrlFindReportListForm.currencyColumn.text")); //$NON-NLS-1$
        
        totalColumn = new TableColumn(table, SWT.RIGHT);
        totalColumn.setMoveable(true);
        totalColumn.setWidth(110);
        totalColumn.setText(Messages.getString("CarMtrlFindReportListForm.totalColumn.text")); //$NON-NLS-1$
    }
	...
	bindColumn("carMtrlFindRequestTitle");
