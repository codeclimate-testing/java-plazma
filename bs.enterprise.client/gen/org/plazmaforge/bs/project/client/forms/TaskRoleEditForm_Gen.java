...
public class TaskRoleEditForm_Gen extends EditForm {


  public TaskRoleEditForm_Gen() {
  }
  ...
  public void createUI() {
    ...
    setName("TaskRoleEditForm");
    setType("EditForm");
    setTitle(getString("TaskRoleEditForm.title"));
  ...
  public Composite createContent() {
    ...
    label1.setText(getString("TaskRoleEditForm.codeLabel.text"));
    content.add(label1);
    ...
    label2.setText(getString("TaskRoleEditForm.nameLabel.text"));
    content.add(label2);
    ...
    label3.setText(getString("TaskRoleEditForm.descriptionLabel.text"));
    content.add(label3);
