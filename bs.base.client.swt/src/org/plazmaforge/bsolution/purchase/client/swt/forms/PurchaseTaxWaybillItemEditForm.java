...
/** 
 * @author Oleh Hapon
 * $Id: PurchaseTaxWaybillItemEditForm.java,v 1.2 2010/04/28 06:31:04 ohapon Exp $
 */

public class PurchaseTaxWaybillItemEditForm extends AbstractGoodsDocumentItemEditForm {
    ...
    public  PurchaseTaxWaybillItemEditForm(Composite parent, int style) {
	super(parent, style);
	initialize();
    }
	...
	goodsLabel.setText(Messages.getString("PurchaseTaxWaybillItemEditForm.goodsLabel.text")); //$NON-NLS-1$
	...
	gridData.widthHint = 300;
    	...
    	productFeatureLabel.setText(Messages.getString("PurchaseTaxWaybillItemEditForm.productFeatureLabel.text")); //$NON-NLS-1$
	...
	unitLabel = new Label(this, SWT.NONE);
    	unitLabel.setText(Messages.getString("PurchaseTaxWaybillItemEditForm.unitLabel.text")); //$NON-NLS-1$
	...
	unitRateLabel.setText(Messages.getString("PurchaseTaxWaybillItemEditForm.unitRateLabel.text")); //$NON-NLS-1$
	...
	quantityLabel.setText(Messages.getString("PurchaseTaxWaybillItemEditForm.quantityLabel.text")); //$NON-NLS-1$
	...
	currencyPriceLabel.setText(Messages.getString("PurchaseTaxWaybillItemEditForm.currencyPriceLabel.text")); //$NON-NLS-1$
	...
	currencyAmountLabel.setText(Messages.getString("PurchaseTaxWaybillItemEditForm.currencyAmountLabel.text")); //$NON-NLS-1$
	...
	taxLabel.setText(Messages.getString("PurchaseTaxWaybillItemEditForm.taxLabel.text")); //$NON-NLS-1$
	...
	currencyTaxAmountLabel.setText(Messages.getString("PurchaseTaxWaybillItemEditForm.currencyTaxAmountLabel.text")); //$NON-NLS-1$
