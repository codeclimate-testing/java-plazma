 ...
 * Created 01.10.2006
 */
public class PayrollCalculateAction extends GUIPayrollAction {

    public void perform(ActionEvent e) throws ApplicationException {
	if (Message.confirmYesNo(SwingEnvironment.getFrame(), "Do you want to calculate payroll ?") != JOptionPane.OK_OPTION) {
	    return;
	}
