 ...
 * Created 24.07.2006
 */
public class SalePlanList extends AbstractFinanceDocumentList {

	
    public SalePlanList() throws ApplicationException {
        super(GUIGoodsEnvironment.getResources());
        initialize();
    }

    public SalePlanList(Window window) throws ApplicationException {
    ...
    private void initialize() {
        ...
        this.setEntityEditFormClass(SalePlanEdit.class);
    }
