...
/** 
 * @author Oleh Hapon
 * $Id: TaskRoleEditForm.java,v 1.1 2008/12/01 12:27:17 ohapon Exp $
 */

public class TaskRoleEditForm extends AbstractEditForm {
     ...
     * @param style
     */
    public TaskRoleEditForm(Composite parent, int style) {
	super(parent, style);
	initialize();
	...
	setTitle(Messages.getString("TaskRoleEditForm.title")); //$NON-NLS-1$
	GridData gridData;
	...
	codeLabel.setText(Messages.getString("TaskRoleEditForm.codeLabel.text")); //$NON-NLS-1$
	...
	nameLabel.setText(Messages.getString("TaskRoleEditForm.nameLabel.text")); //$NON-NLS-1$
	...
	descriptionLabel.setLayoutData(new GridData(SWT.LEFT, SWT.TOP, false, false));
    	descriptionLabel.setText(Messages.getString("TaskRoleEditForm.descriptionLabel.text")); //$NON-NLS-1$
