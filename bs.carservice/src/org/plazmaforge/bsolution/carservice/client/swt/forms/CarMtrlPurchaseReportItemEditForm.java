 ...
 * 
 * @author Oleh Hapon
 * $Id: CarMtrlPurchaseReportItemEditForm.java,v 1.2 2010/04/28 06:23:01 ohapon Exp $
 */
public class CarMtrlPurchaseReportItemEditForm extends AbstractGoodsDocumentItemEditForm {
    ...
    public  CarMtrlPurchaseReportItemEditForm(Composite parent, int style) {
	super(parent, style);
	initialize();
    }
	...
	goodsLabel.setText(Messages.getString("CarMtrlPurchaseReportItemEditForm.goodsLabel.text")); //$NON-NLS-1$
	...
	unitLabel = new Label(this, SWT.NONE);
    	unitLabel.setText(Messages.getString("CarMtrlPurchaseReportItemEditForm.unitLabel.text")); //$NON-NLS-1$
	...
	unitRateLabel.setText(Messages.getString("CarMtrlPurchaseReportItemEditForm.unitRateLabel.text")); //$NON-NLS-1$
	...
	quantityLabel.setText(Messages.getString("CarMtrlPurchaseReportItemEditForm.quantityLabel.text")); //$NON-NLS-1$
	...
	currencyPriceLabel.setText(Messages.getString("CarMtrlPurchaseReportItemEditForm.currencyPriceLabel.text")); //$NON-NLS-1$
	...
	currencyAmountLabel.setText(Messages.getString("CarMtrlPurchaseReportItemEditForm.currencyAmountLabel.text")); //$NON-NLS-1$
	...
	gridData = new GridData(SWT.FILL, SWT.CENTER, false, false);
    	...
    	supplierLabel.setText(Messages.getString("CarMtrlPurchaseReportItemEditForm.supplierLabel.text")); //$NON-NLS-1$
	...
	deliveryDateLabel.setText(Messages.getString("CarMtrlPurchaseReportItemEditForm.deliveryDateLabel.text")); //$NON-NLS-1$
