 ...
 * Date: 26.02.2004
 * Time: 9:50:36
 * $Id: SetupAction.java,v 1.3 2010/12/05 07:52:08 ohapon Exp $
 */
public class SetupAction  extends ListFormAction {

    public SetupAction(ListForm listForm, Resources resources) {
        super(listForm, resources);
    }

    public void perform(ActionEvent evt) throws ApplicationException {
        listForm.doSetupCommand();
    }
