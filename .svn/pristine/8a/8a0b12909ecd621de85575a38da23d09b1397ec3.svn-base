...
/**
 * @author Oleh Hapon $Id: MoneyUtils.java,v 1.2 2010/04/28 06:34:30 ohapon Exp $
 */
public class MoneyUtils implements MoneyConstants {
	...
	MoneyUtils.defaultCurrency = defaultCurrency;
    }
	...
	MoneyUtils.defaultLanguage = defaultLanguage;
    }
