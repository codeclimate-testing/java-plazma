...
public class TaskResultListForm_Gen extends ListForm {


  public TaskResultListForm_Gen() {
  }
  ...
  public void createUI() {
    ...
    setName("TaskResultListForm");
    setType("ListForm");
    setTitle(getString("TaskResultListForm.title"));
  ...
  public Composite createContent() {
    ...
    column1.setText(getString("TaskResultListForm.nameColumn.text"));
    ...
    column2.setText(getString("TaskResultListForm.codeColumn.text"));
