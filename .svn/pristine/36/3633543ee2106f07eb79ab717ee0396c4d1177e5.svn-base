...
/** 
 * @author Oleh Hapon
 * $Id: InventoryIncomeItemEditForm.java,v 1.2 2010/04/28 06:31:08 ohapon Exp $
 */

public class InventoryIncomeItemEditForm extends AbstractGoodsDocumentItemEditForm {
    ...
    public  InventoryIncomeItemEditForm(Composite parent, int style) {
	super(parent, style);
	initialize();
    }
	...
	goodsLabel.setText(Messages.getString("InventoryIncomeItemEditForm.goodsLabel.text")); //$NON-NLS-1$
	...
	gridData.widthHint = 300;
    	...
    	productFeatureLabel.setText(Messages.getString("InventoryIncomeItemEditForm.productFeatureLabel.text")); //$NON-NLS-1$
	...
	unitLabel = new Label(this, SWT.NONE);
    	unitLabel.setText(Messages.getString("InventoryIncomeItemEditForm.unitLabel.text")); //$NON-NLS-1$
	...
	unitRateLabel.setText(Messages.getString("InventoryIncomeItemEditForm.unitRateLabel.text")); //$NON-NLS-1$
	...
	quantityLabel.setText(Messages.getString("InventoryIncomeItemEditForm.quantityLabel.text")); //$NON-NLS-1$
	...
	currencyPriceLabel.setText(Messages.getString("InventoryIncomeItemEditForm.currencyPriceLabel.text")); //$NON-NLS-1$
	...
	currencyAmountLabel.setText(Messages.getString("InventoryIncomeItemEditForm.currencyAmountLabel.text")); //$NON-NLS-1$
	...
	taxLabel.setText(Messages.getString("InventoryIncomeItemEditForm.taxLabel.text")); //$NON-NLS-1$
	...
	currencyTaxAmountLabel.setText(Messages.getString("InventoryIncomeItemEditForm.currencyTaxAmountLabel.text")); //$NON-NLS-1$
