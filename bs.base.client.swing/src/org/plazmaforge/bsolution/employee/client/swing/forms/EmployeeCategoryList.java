...
import org.plazmaforge.bsolution.employee.client.swing.forms.EmployeeCategoryEdit;
 ...
 * Date: 04.10.2004
 * Time: 21:56:14
 * $Id: EmployeeCategoryList.java,v 1.3 2010/12/05 07:56:45 ohapon Exp $
 */
public class EmployeeCategoryList extends EXTListForm {

    public EmployeeCategoryList() throws ApplicationException {
        super(GUIEmployeeEnvironment.getResources());
        initialize();
    }

    public EmployeeCategoryList(Window window) throws ApplicationException {
    ...
    private void initialize() {
        ...
        this.setEntityEditFormClass(EmployeeCategoryEdit.class);        
    }
