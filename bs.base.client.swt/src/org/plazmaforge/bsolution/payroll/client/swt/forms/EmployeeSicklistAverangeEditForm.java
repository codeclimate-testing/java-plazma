...
/** 
 * @author Oleh Hapon
 * $Id: EmployeeSicklistAverangeEditForm.java,v 1.2 2010/04/28 06:31:06 ohapon Exp $
 */

public class EmployeeSicklistAverangeEditForm extends AbstractEditForm {
     ...
     * @param style
     */
    public EmployeeSicklistAverangeEditForm(Composite parent, int style) {
	super(parent, style);
	initialize();
	...
	setTitle(Messages.getString("EmployeeSicklistAverangeEditForm.title")); //$NON-NLS-1$
	...
	monthLabel.setText(Messages.getString("EmployeeSicklistAverangeEditForm.monthLabel.text")); //$NON-NLS-1$
    	...
    	workDayLabel.setText(Messages.getString("EmployeeSicklistAverangeEditForm.workDayLabel.text")); //$NON-NLS-1$
    	...
    	amountLabel.setText(Messages.getString("EmployeeSicklistAverangeEditForm.amountLabel.text")); //$NON-NLS-1$
