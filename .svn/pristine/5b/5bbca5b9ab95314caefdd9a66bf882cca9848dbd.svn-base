...
/** 
 * @author Oleh Hapon
 * $Id: PartnerTypeService.java,v 1.3 2010/12/05 07:56:03 ohapon Exp $
 */

public interface PartnerTypeService extends EntityService<PartnerType, Integer> {
    
    PartnerType sysFindById(Integer id) throws DAOException, FinderException;
}
