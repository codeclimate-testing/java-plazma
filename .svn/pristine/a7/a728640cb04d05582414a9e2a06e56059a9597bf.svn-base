...
import org.plazmaforge.bsolution.personality.common.services.FamilyStatusService;
 ...
 * Date: 19.09.2004
 * Time: 12:36:44
 * $Id: FamilyStatusEdit.java,v 1.3 2010/12/05 07:56:44 ohapon Exp $
 */
public class FamilyStatusEdit extends EXTEditForm {
    ...
    public FamilyStatusEdit() throws ApplicationException {
        super(GUIPersonalityEnvironment.getResources());
        initialize();
    }
    
    private void initialize() {
        this.setEntityClass(FamilyStatus.class);
        this.setEntityServiceClass(FamilyStatusService.class);
    }
    ...
    private FamilyStatus getFamilyStatus() {
        return (FamilyStatus) this.getEntity();
    }

    protected void updateView() throws ApplicationException {
        appendTitle(getFamilyStatus().getName());
        codeField.setText(getFamilyStatus().getCode());
        nameField.setText(getFamilyStatus().getName());
    }

    protected void populateData() throws ApplicationException {
        getFamilyStatus().setCode(codeField.getText());
        getFamilyStatus().setName(nameField.getText());
    }
