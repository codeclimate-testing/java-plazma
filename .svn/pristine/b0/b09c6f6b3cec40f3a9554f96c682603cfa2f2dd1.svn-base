...
public class LanguageListForm_Gen extends ListForm {


  public LanguageListForm_Gen() {
  }
  ...
  public void createUI() {
    ...
    setName("LanguageListForm");
    setType("ListForm");
    setTitle(getString("LanguageListForm.title"));
  ...
  public Composite createContent() {
    ...
    column1.setText(getString("LanguageListForm.codeColumn.text"));
    ...
    column2.setText(getString("LanguageListForm.code3Column.text"));
    ...
    column3.setText(getString("LanguageListForm.numericCodeColumn.text"));
    ...
    column4.setText(getString("LanguageListForm.nameColumn.text"));
