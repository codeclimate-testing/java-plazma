...
/** 
 * @author Oleh Hapon
 * $Id: SalePlanListForm.java,v 1.6 2010/12/05 07:57:21 ohapon Exp $
 */

public class SalePlanListForm extends AbstractFinanceDocumentListForm {
    ...
    public SalePlanListForm(Composite parent, int style) {
	super(parent, style);
	initialize();
    }
	...
	setTitle(Messages.getString("SalePlanListForm.title")); //$NON-NLS-1$
        ...
        documentNoColumn.setText(Messages.getString("SalePlanListForm.documentNoColumn.text")); //$NON-NLS-1$

        documentDateColumn = new TableColumn(table, SWT.NONE);
        documentDateColumn.setMoveable(true);
        documentDateColumn.setWidth(100);
        documentDateColumn.setText(Messages.getString("SalePlanListForm.documentDateColumn.text")); //$NON-NLS-1$

        departmentColumn = new TableColumn(table, SWT.NONE);
        departmentColumn.setMoveable(true);
        departmentColumn.setWidth(200);
        departmentColumn.setText(Messages.getString("SalePlanListForm.departmentColumn.text")); //$NON-NLS-1$
    	
        priceTypeColumn = new TableColumn(table, SWT.NONE);
        priceTypeColumn.setMoveable(true);
        priceTypeColumn.setWidth(100);
        priceTypeColumn.setText(Messages.getString("SalePlanListForm.priceTypeColumn.text")); //$NON-NLS-1$
    	
        responsibleColumn = new TableColumn(table, SWT.NONE);
        responsibleColumn.setMoveable(true);
        responsibleColumn.setWidth(200);
        responsibleColumn.setText(Messages.getString("SalePlanListForm.responsibleColumn.text")); //$NON-NLS-1$
    	
        currencyTotalColumn = new TableColumn(table, SWT.RIGHT);
        currencyTotalColumn.setMoveable(true);
        currencyTotalColumn.setWidth(120);
        currencyTotalColumn.setText(Messages.getString("SalePlanListForm.currencyTotalColumn.text"));    	 //$NON-NLS-1$
    	
        currencyColumn = new TableColumn(table, SWT.CENTER);
        currencyColumn.setMoveable(true);
        currencyColumn.setWidth(70);
        currencyColumn.setText(Messages.getString("SalePlanListForm.currencyColumn.text")); //$NON-NLS-1$
        
        totalColumn = new TableColumn(table, SWT.RIGHT);
        totalColumn.setMoveable(true);
        totalColumn.setWidth(120);
        totalColumn.setText(Messages.getString("SalePlanListForm.totalColumn.text")); //$NON-NLS-1$
        
        projectColumn = new TableColumn(table, SWT.NONE);
        projectColumn.setMoveable(true);
        projectColumn.setWidth(150);
        projectColumn.setText(Messages.getString("SalePlanListForm.projectColumn.text")); //$NON-NLS-1$
    }
	...
	bindColumn("departmentName");
	bindColumn("priceTypeName");
	bindColumn("responsibleName");
	
	bindColumn(getCurrencyEnterTotalProperty() /*"currencyEnterTotal"*/, getCurrencyFormat());
	bindColumn("currencyName");
	bindColumn(getEnterTotalProperty() /*"enterTotal"*/, getCurrencyFormat());
