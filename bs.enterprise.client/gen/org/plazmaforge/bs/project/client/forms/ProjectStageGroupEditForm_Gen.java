...
public class ProjectStageGroupEditForm_Gen extends EditForm {


  public ProjectStageGroupEditForm_Gen() {
  }
  ...
  public void createUI() {
    ...
    setName("ProjectStageGroupEditForm");
    setType("EditForm");
    setTitle(getString("ProjectStageGroupEditForm.title"));
  ...
  public Composite createContent() {
    ...
    label1.setText(getString("ProjectStageGroupEditForm.codeLabel.text"));
    content.add(label1);
    ...
    label2.setText(getString("ProjectStageGroupEditForm.nameLabel.text"));
    content.add(label2);
    ...
    label3.setText(getString("ProjectStageGroupEditForm.descriptionLabel.text"));
    content.add(label3);
