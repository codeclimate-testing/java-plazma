 ...
 * Date: 09.03.2004
 * Time: 8:15:00
 * $Id: EditChildAction.java,v 1.3 2010/12/05 07:52:08 ohapon Exp $
 */
public class EditChildAction extends EditFormAction {

    public EditChildAction(EditForm editForm, Resources resources) {
        super(editForm, resources);
    }

    public void perform(ActionEvent evt) throws ApplicationException {
        ((ParentEditForm) editForm).doEditChildCommand(EditableMode.EDIT);
    }
}
