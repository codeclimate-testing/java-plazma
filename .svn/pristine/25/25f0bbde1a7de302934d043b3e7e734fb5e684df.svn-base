...
/** 
 * @author Oleh Hapon
 * $Id: PurchaseInvoice.java,v 1.3 2010/04/28 06:24:18 ohapon Exp $
 */

public class PurchaseInvoice extends ProductDocument implements IPartnerableDocument, IPayReasonDocument {

    public static final String CLASS_ID = "PURCHASE_INVOICE";
