...
public class NewDocumentAction extends GUIDocumentAction {

    public void perform(ActionEvent e) throws ApplicationException {
	List entities = ((SystemEntityService) ServiceFactory.getService(SystemEntityService.class)).findByEntityType("DOCUMENT");
	SwingFormManager.showSelectedEditFormByAddMode(entities, null);
    }
