...
/** 
 * @author Oleh Hapon
 * $Id: SystemPreferenceService.java,v 1.3 2010/12/05 07:55:56 ohapon Exp $
 */

public interface SystemPreferenceService extends EntityService<SystemPreference, Integer>{

    SystemPreference load() throws DAOException, FinderException;
