 ...
 * Date: 09.03.2004
 * Time: 8:14:47
 * $Id: DeleteChildAction.java,v 1.3 2010/12/05 07:52:08 ohapon Exp $
 */
public class DeleteChildAction extends EditFormAction {

    public DeleteChildAction(ParentEditForm editForm, Resources resources) {
        super(editForm, resources);
    }

    public void perform(ActionEvent evt) throws ApplicationException {
        ((ParentEditForm) editForm).doDeleteChildCommand();
    }
}
