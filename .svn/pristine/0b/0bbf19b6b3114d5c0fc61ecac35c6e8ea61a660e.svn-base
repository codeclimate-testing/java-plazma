...
/** 
 * @author Oleh Hapon
 * $Id: DatabaseXLSExporter.java,v 1.2 2010/04/28 06:34:40 ohapon Exp $
 */

public class DatabaseXLSExporter extends AbstractDatabaseExporter {
	...
	XLSExporter dataSetExporter =  new XLSExporter();
