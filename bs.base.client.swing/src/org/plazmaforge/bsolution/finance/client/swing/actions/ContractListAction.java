 ...
 * Date: 26.12.2004
 * Time: 12:09:14
 * $Id: ContractListAction.java,v 1.3 2010/12/05 07:56:46 ohapon Exp $
 */
public class ContractListAction extends GUIFinanceAction {

    public void perform(ActionEvent e) throws ApplicationException {
        SwingFormManager.showListForm(ContractList.class);
    }
}
