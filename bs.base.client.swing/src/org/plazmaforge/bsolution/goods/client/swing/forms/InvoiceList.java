 ...
 * Date: 12.09.2004
 * Time: 16:15:46
 * $Id: InvoiceList.java,v 1.3 2010/12/05 07:56:43 ohapon Exp $
 */
public class InvoiceList extends AbstractFinanceDocumentList  {

    public InvoiceList() throws ApplicationException {
        super(GUIGoodsEnvironment.getResources());
        initialize();
    }

    public InvoiceList(Window window) throws ApplicationException {
    ...
    private void initialize() {
        ...
        this.setEntityEditFormClass(InvoiceEdit.class);
    }
