...
import org.plazmaforge.bsolution.partner.client.swing.forms.IndustryList;
 ...
 */
public class IndustryListAction extends GUIPartnerAction {

    public void perform(ActionEvent e) throws ApplicationException {
        SwingFormManager.showListForm(IndustryList.class);
    }
}
