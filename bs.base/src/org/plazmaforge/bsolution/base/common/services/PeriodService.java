 ...
 * Date: 07.05.2004
 * Time: 17:52:36
 * $Id: PeriodService.java,v 1.3 2010/12/05 07:55:56 ohapon Exp $
 */
public interface PeriodService extends EntityService<Period, Integer> {
	
    Period sysFindById(Integer id) throws DAOException, FinderException;
    
    Integer registerPeriod(Integer organization, Integer currPeriod, CompressionExecutor[] executors) throws DAOException, FinderException, CreateException;
}
