 ...
 * Date: 06.05.2004
 * Time: 19:52:25
 * $Id: ResponsibleListAction.java,v 1.3 2010/12/05 07:56:44 ohapon Exp $
 */
public class ResponsibleListAction extends GUIOrganizationAction {

    public void perform(ActionEvent e) throws ApplicationException {
        SwingFormManager.showListForm(ResponsibleList.class);
    }
}
