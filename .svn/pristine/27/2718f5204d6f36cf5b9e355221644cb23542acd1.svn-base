 ...
 * Date: 26.02.2004
 * Time: 9:45:05
 * $Id: RefreshAction.java,v 1.3 2010/12/05 07:52:08 ohapon Exp $
 */
public class RefreshAction extends ListFormAction {

    public RefreshAction(ListForm listForm, Resources resources) {
        super(listForm, resources);
    }

    public void perform(ActionEvent evt) throws ApplicationException {
         listForm.doRefreshData();
    }
