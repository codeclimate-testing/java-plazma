 ...
 * Date: 08.10.2004
 * Time: 9:29:26
 * $Id: EmployeeDischargeService.java,v 1.2 2010/04/28 06:24:30 ohapon Exp $
 */
public interface EmployeeDischargeService extends DocumentService<EmployeeDischarge, Integer> {
