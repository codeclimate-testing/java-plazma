...
/** 
 * @author Oleh Hapon
 * $Id: RMIServiceProxy.java,v 1.2 2010/04/28 06:34:38 ohapon Exp $
 */

public class RMIServiceProxy  extends DefaultServiceProxy {

    public RMIServiceProxy(ServiceInvoker invoker) {
	super(invoker);
    }
}
