...
import org.plazmaforge.bs.web.client.TemplateService;
...
public class TemplateServiceImpl extends RemoteServiceServlet implements TemplateService {
    ...
    public IData getData(String path) throws UIResourceException {
	// Use classpath to provide (*.ui.xml) templates
	ClassTemplateProvider provider = new ClassTemplateProvider();
