...
public class TaskTypeListForm_Gen extends ListForm {


  public TaskTypeListForm_Gen() {
  }
  ...
  public void createUI() {
    ...
    setName("TaskTypeListForm");
    setType("ListForm");
    setTitle(getString("TaskTypeListForm.title"));
  ...
  public Composite createContent() {
    ...
    column1.setText(getString("TaskTypeListForm.nameColumn.text"));
    ...
    column2.setText(getString("TaskTypeListForm.descriptionColumn.text"));
    ...
    column3.setText(getString("TaskTypeListForm.codeColumn.text"));
