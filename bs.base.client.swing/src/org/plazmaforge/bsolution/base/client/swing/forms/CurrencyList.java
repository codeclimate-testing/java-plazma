...
/**
 * @author Oleh Hapon Date: 05.05.2004 Time: 16:41:36 $Id: CurrencyList.java,v 1.3 2010/12/05 07:56:44 ohapon Exp $
 */
public class CurrencyList extends EXTListForm {
    ...
    public CurrencyList(Window window) {
	...
	this.setEntityEditFormClass(CurrencyEdit.class);
    }
	...
	d.setName(getString("table.column-char-code.name"));
	d.setFieldName("charCode");
	d.setColumnClass(String.class);
	d.setSize(20);
	columns.add(d);
