...
/** 
 * @author Oleh Hapon
 * $Id: ProjectContextService.java,v 1.3 2010/12/05 07:56:05 ohapon Exp $
 */

public interface ProjectContextService extends	ContextService, EntityService<ProjectContext, Integer> {

    ProjectContext load() throws DAOException, FinderException;
