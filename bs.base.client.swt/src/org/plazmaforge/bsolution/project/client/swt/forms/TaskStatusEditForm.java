...
/** 
 * @author Oleh Hapon
 * $Id: TaskStatusEditForm.java,v 1.1 2008/12/01 12:27:17 ohapon Exp $
 */

public class TaskStatusEditForm extends AbstractEditForm {
     ...
     * @param style
     */
    public TaskStatusEditForm(Composite parent, int style) {
	super(parent, style);
	initialize();
	...
	setTitle(Messages.getString("TaskStatusEditForm.title")); //$NON-NLS-1$
	GridData gridData;
	...
	codeLabel.setText(Messages.getString("TaskStatusEditForm.codeLabel.text")); //$NON-NLS-1$
	...
	nameLabel.setText(Messages.getString("TaskStatusEditForm.nameLabel.text")); //$NON-NLS-1$
	...
	descriptionLabel.setLayoutData(new GridData(SWT.LEFT, SWT.TOP, false, false));
    	descriptionLabel.setText(Messages.getString("TaskStatusEditForm.descriptionLabel.text")); //$NON-NLS-1$
    	...
    	startStatusLabel.setText(Messages.getString("TaskStatusEditForm.startStatusLabel.text")); //$NON-NLS-1$

    	startStatusField = new XCheckBox(this, SWT.NONE);

    	finishStatusLabel = new Label(this, SWT.NONE);
    	finishStatusLabel.setText(Messages.getString("TaskStatusEditForm.finishStatusLabel.text")); //$NON-NLS-1$
