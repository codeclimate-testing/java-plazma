...
/** 
 * @author Oleh Hapon
 * $Id: DefaultWarehouseProductDocumentCreator.java,v 1.3 2010/12/05 07:56:04 ohapon Exp $
 */

public class WarehouseProductDocumentCreator extends ProductDocumentCreator {
	...
	WarehouseProductDocument parentWarehouseProductDocument = (WarehouseProductDocument) parentDocument;  
	WarehouseProductDocument productWarehouseDocument = (WarehouseProductDocument) document;
	
	productWarehouseDocument.setWarehouse(parentWarehouseProductDocument.getWarehouse());
	productWarehouseDocument.setMtrlResponsible(parentWarehouseProductDocument.getMtrlResponsible());
