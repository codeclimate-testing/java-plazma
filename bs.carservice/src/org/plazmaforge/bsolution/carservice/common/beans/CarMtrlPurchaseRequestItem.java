 ...
 * 
 * @author Oleh Hapon
 * $Id: CarMtrlPurchaseRequestItem.java,v 1.2 2010/04/28 06:22:48 ohapon Exp $
 */
public class CarMtrlPurchaseRequestItem extends ProductDocumentItem {
    ...
    public CarMtrlPurchaseRequest getCarMtrlPurchaseRequest() {
        return (CarMtrlPurchaseRequest) getProductDocument();
    }

    public void setCarMtrlPurchaseRequest(CarMtrlPurchaseRequest carMtrlPurchaseRequest) {
        setProductDocument(carMtrlPurchaseRequest);
    }
