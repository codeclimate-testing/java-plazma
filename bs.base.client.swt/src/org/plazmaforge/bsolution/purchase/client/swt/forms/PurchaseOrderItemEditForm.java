...
/** 
 * @author Oleh Hapon
 * $Id: PurchaseOrderItemEditForm.java,v 1.2 2010/04/28 06:31:04 ohapon Exp $
 */

public class PurchaseOrderItemEditForm extends AbstractGoodsDocumentItemEditForm {
    ...
    public  PurchaseOrderItemEditForm(Composite parent, int style) {
	super(parent, style);
	initialize();
    }
	...
	goodsLabel.setText(Messages.getString("PurchaseOrderItemEditForm.goodsLabel.text")); //$NON-NLS-1$
	...
	gridData.widthHint = 300;
    	...
    	productFeatureLabel.setText(Messages.getString("PurchaseOrderItemEditForm.productFeatureLabel.text")); //$NON-NLS-1$
	...
	unitLabel = new Label(this, SWT.NONE);
    	unitLabel.setText(Messages.getString("PurchaseOrderItemEditForm.unitLabel.text")); //$NON-NLS-1$
    	...
    	currencyBasePriceLabel.setText(Messages.getString("PurchaseOrderItemEditForm.currencyBasePriceLabel.text")); //$NON-NLS-1$
	...
	unitRateLabel.setText(Messages.getString("PurchaseOrderItemEditForm.unitRateLabel.text")); //$NON-NLS-1$
	...
	unitRateField.setLayoutData(gridData);
    	...
    	pricePercentLabel.setText(Messages.getString("PurchaseOrderItemEditForm.pricePercentLabel.text")); //$NON-NLS-1$
	...
	quantityLabel.setText(Messages.getString("PurchaseOrderItemEditForm.quantityLabel.text")); //$NON-NLS-1$
	...
	currencyPriceLabel.setText(Messages.getString("PurchaseOrderItemEditForm.currencyPriceLabel.text")); //$NON-NLS-1$
	...
	currencyAmountLabel.setText(Messages.getString("PurchaseOrderItemEditForm.currencyAmountLabel.text")); //$NON-NLS-1$
	...
	taxLabel.setText(Messages.getString("PurchaseOrderItemEditForm.taxLabel.text")); //$NON-NLS-1$
	...
	currencyTaxAmountLabel.setText(Messages.getString("PurchaseOrderItemEditForm.currencyTaxAmountLabel.text")); //$NON-NLS-1$
