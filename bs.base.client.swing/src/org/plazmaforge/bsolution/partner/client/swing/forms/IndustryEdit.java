...
import org.plazmaforge.bsolution.partner.common.services.IndustryService;
 ...
 */
public class IndustryEdit extends EXTEditForm {
    ...
    private void initialize() {
        this.setEntityClass(Industry.class);
        this.setEntityServiceClass(IndustryService.class);
    }
    ...
    private Industry getIndustry() {
        return (Industry) getEntity();
    }


    protected void updateView() throws ApplicationException {
        appendTitle(getIndustry().getName());
        codeField.setText(getIndustry().getCode());
        nameField.setText(getIndustry().getName());
    }

    protected void populateData() throws ApplicationException {
        getIndustry().setCode(codeField.getText());
        getIndustry().setName(nameField.getText());
    }
