...
/** 
 * @author Oleh Hapon
 * $Id: DatabaseRTFExporter.java,v 1.2 2010/04/28 06:34:34 ohapon Exp $
 */

public class DatabaseRTFExporter extends AbstractDatabaseExporter {
	...
	RTFExporter dataSetExporter =  new RTFExporter();
