...
public class StreetTypeEditForm_Gen extends EditForm {


  public StreetTypeEditForm_Gen() {
  }
  ...
  public void createUI() {
    ...
    setName("StreetTypeEditForm");
    setType("EditForm");
    setTitle(getString("StreetTypeEditForm.title"));
  ...
  public Composite createContent() {
    ...
    label1.setText(getString("StreetTypeEditForm.nameLabel.text"));
    content.add(label1);
    ...
    label2.setText(getString("StreetTypeEditForm.fullNameLabel.text"));
    content.add(label2);
