...
import org.plazmaforge.bsolution.bank.client.swing.forms.PaymentIncomeEdit;
 ...
 * Date: 18.07.2004
 * Time: 10:58:49
 * $Id: PaymentIncomeList.java,v 1.3 2010/12/05 07:56:46 ohapon Exp $
 */
public class PaymentIncomeList extends AbstractDocumentList {

    public PaymentIncomeList() throws ApplicationException {
        super(GUIBankEnvironment.getResources());
        initialize();
    }

    public PaymentIncomeList(Window window) throws ApplicationException {
    ...
    private void initialize() {
        ...
        this.setEntityEditFormClass(PaymentIncomeEdit.class);
    }
