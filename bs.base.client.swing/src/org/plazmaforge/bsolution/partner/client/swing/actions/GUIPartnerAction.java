 ...
 *
 */
public class GUIPartnerAction extends ResourceAction {

    public GUIPartnerAction() {
        super(GUIPartnerEnvironment.getResources());
    }


    public GUIPartnerAction(Resources resources) {
        super(resources == null ? GUIPartnerEnvironment.getResources() : resources);
    }
