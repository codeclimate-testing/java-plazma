 ...
 * Date: 05.12.2004
 * Time: 17:47:50
 * $Id: BankPackage.java,v 1.2 2010/04/28 06:24:24 ohapon Exp $
 */
public class BankPackage extends DefaultPackage {
    ...
    public CompressionExecutor getCompressionExecutor() {
        return getCompressionExecutor(BankCompressionExecutor.class);
    }
}
