 ...
 * @author Oleh Hapon
 *
 * $Id: CashIncomeList.java,v 1.3 2010/12/05 07:56:48 ohapon Exp $
 * 
 */

public class CashIncomeList extends AbstractDocumentList {

    public CashIncomeList() throws ApplicationException {
        super(GUICashEnvironment.getResources());
        initialize();
    }

    public CashIncomeList(Window window) throws ApplicationException {
    ...
    private void initialize() {
        ...
        this.setEntityEditFormClass(CashIncomeEdit.class);
    }
