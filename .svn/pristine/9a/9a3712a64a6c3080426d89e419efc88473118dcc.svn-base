...
public class FinanceDocumentTypeList extends EXTListForm {

    public FinanceDocumentTypeList() throws ApplicationException {
        super(GUIFinanceEnvironment.getResources());
        initialize();
    }

    public FinanceDocumentTypeList(Window window) throws ApplicationException {
    ...
    private void initialize() {
        ...
        this.setEntityEditFormClass(FinanceDocumentTypeEdit.class);
    }    
    ...
    protected List<ColumnProperty> createTableColumnProperties() throws ApplicationException {
        ...
        d = new ColumnProperty();
        d.setName(getString("table.column-move-type.name"));
        d.setFieldName("moveType");
        d.setColumnClass(String.class);
        d.setSize(20);
        columns.add(d);

        d = new ColumnProperty();
        d.setName(getString("table.column-include-tax-in-amount.name"));
        d.setFieldName("includeTaxInAmount");
