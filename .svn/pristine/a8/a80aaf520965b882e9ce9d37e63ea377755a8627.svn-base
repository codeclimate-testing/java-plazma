 ...
 */
package org.plazmaforge.bsolution.contact.common.beans.formatter.support.xu;
...
public class XUAddressFormatter extends XUAbstractContactFormatter implements AddressFormatter {
	...
	// COMPLEX ADDRESS
	String streetName = getStreetString(address.getStreetType(), address.getStreet());
	...
	if (!isEmpty(houseNum)) {
	    addString(buf, houseNum, isAdd);
	    isAdd = true;
	}

	String apartNum = getApartmentString(address.getApartmentType(), address.getApartNum());
	if (!isEmpty(apartNum)) {
	...
	return getTypeString(getDictionaryName(locality.getLocalityType()), getDictionaryName(locality));
    }

    private String getStreetString(StreetType streetType, String street) {
	return getTypeString(getDictionaryName(streetType), street);
    }

    private String getApartmentString(ApartmentType apartmentType, String apartmentNum) {
    ...
    public String formatAddress(City city, Locality locality, StreetType streetType, String street, String houseNum, String caseNum,
