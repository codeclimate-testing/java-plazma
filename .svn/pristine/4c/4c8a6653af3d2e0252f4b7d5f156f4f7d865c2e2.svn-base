...
public class ProjectRoleEditForm_Gen extends EditForm {


  public ProjectRoleEditForm_Gen() {
  }
  ...
  public void createUI() {
    ...
    setName("ProjectRoleEditForm");
    setType("EditForm");
    setTitle(getString("ProjectRoleEditForm.title"));
  ...
  public Composite createContent() {
    ...
    label1.setText(getString("ProjectRoleEditForm.codeLabel.text"));
    content.add(label1);
    ...
    label2.setText(getString("ProjectRoleEditForm.nameLabel.text"));
    content.add(label2);
    ...
    label3.setText(getString("ProjectRoleEditForm.descriptionLabel.text"));
    content.add(label3);
