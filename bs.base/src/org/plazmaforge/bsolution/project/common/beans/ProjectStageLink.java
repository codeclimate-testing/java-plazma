...
/** 
 * @author Oleh Hapon
 * $Id: ProjectStageLink.java,v 1.3 2010/12/05 07:55:58 ohapon Exp $
 */

public class ProjectStageLink  extends BaseEntity {
    ...
    public String getProjectStageName() {
        return projectStage == null ? null : projectStage.getName();
    }
