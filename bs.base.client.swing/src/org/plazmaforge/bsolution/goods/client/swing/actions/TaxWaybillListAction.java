...
import org.plazmaforge.bsolution.goods.client.swing.forms.TaxWaybillList;
...
public class TaxWaybillListAction extends GUIGoodsAction {

    public void perform(ActionEvent e) throws ApplicationException {
        SwingFormManager.showListForm(TaxWaybillList.class);
    }
}
