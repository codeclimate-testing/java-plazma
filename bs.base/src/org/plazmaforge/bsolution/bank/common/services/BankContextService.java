...
/**
 * @author Oleh Hapon
 * $Id: BankContextService.java,v 1.3 2010/12/05 07:56:01 ohapon Exp $
 */

public interface BankContextService extends ContextService, EntityService<BankContext, Integer> {

    BankContext load() throws DAOException, FinderException;
