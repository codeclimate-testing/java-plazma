 ...
 * Date: 27.05.2006
 * Time: 13:38:11
 * $Id: PartnerActivityTypeLink.java,v 1.3 2010/12/05 07:56:00 ohapon Exp $
 */
public class PartnerActivityTypeLink extends BaseEntity {
    ...
    public String getActivityTypeName() {
        return getActivityType() == null ? null : getActivityType().getName();
    }
