...
public class RegionListForm_Gen extends ListForm {


  public RegionListForm_Gen() {
  }
  ...
  public void createUI() {
    ...
    setName("RegionListForm");
    setType("ListForm");
    setTitle(getString("RegionListForm.title"));
  ...
  public Composite createContent() {
    ...
    column1.setText(getString("RegionListForm.nameColumn.text"));
    ...
    column2.setText(getString("RegionListForm.countryColumn.text"));
    column2.setWidth(200);
    column2.setProperty("countryName");
