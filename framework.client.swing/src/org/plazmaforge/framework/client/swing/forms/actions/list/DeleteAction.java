 ...
 * Date: 26.02.2004
 * Time: 9:49:27
 * $Id: DeleteAction.java,v 1.3 2010/12/05 07:52:08 ohapon Exp $
 */
public class DeleteAction  extends ListFormAction {

    public DeleteAction(ListForm listForm, Resources resources) {
        super(listForm, resources);
    }

    public void perform(ActionEvent evt) throws ApplicationException {
        listForm.doDelCommand();
    }
