...
public class Task extends OrganizableEntity implements IEntityConfigurable, IHistoryEntity, IStatusEntity, ICalendarEvent {

   
    public static final String CLASS_ID = "TASK";
