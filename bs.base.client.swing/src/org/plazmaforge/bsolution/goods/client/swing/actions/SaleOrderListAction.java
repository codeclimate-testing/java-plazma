...
import org.plazmaforge.bsolution.goods.client.swing.forms.SaleOrderList;
...
public class SaleOrderListAction extends GUIGoodsAction {

    public void perform(ActionEvent e) throws ApplicationException {
        SwingFormManager.showListForm(SaleOrderList.class);
    }
}
