...
/** 
 * @author Oleh Hapon
 * $Id: TaskContextService.java,v 1.3 2010/12/05 07:56:05 ohapon Exp $
 */

public interface TaskContextService extends ContextService, EntityService<TaskContext, Integer> {

    TaskContext load() throws DAOException, FinderException;
}
