 ...
 * Date: 12.09.2004
 * Time: 15:51:42
 * $Id: SaleInvoiceItem.java,v 1.2 2010/04/28 06:24:24 ohapon Exp $
 */
public class SaleInvoiceItem extends ProductDocumentItem {

    public SaleInvoice getSaleInvoice() {
        return (SaleInvoice) getProductDocument();
    }

    public void setSaleInvoice(SaleInvoice saleInvoice) {
        setProductDocument(saleInvoice);
    }
