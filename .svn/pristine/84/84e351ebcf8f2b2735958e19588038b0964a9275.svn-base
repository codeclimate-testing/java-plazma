 ...
 * Date: 18.03.2004
 * Time: 10:42:10
 * $Id: PartnerListAction.java,v 1.3 2010/12/05 07:56:43 ohapon Exp $
 */
public class PartnerListAction extends GUIPartnerAction {

    public void perform(ActionEvent e) throws ApplicationException {
        SwingFormManager.showListForm(PartnerList.class);
    }
}
