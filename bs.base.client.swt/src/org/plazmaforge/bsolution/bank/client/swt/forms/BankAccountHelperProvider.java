...
/** 
 * @author Oleh Hapon
 * $Id: BankAccountHelperProvider.java,v 1.2 2010/04/28 06:31:08 ohapon Exp $
 */

public interface BankAccountHelperProvider {

    PartnerService getPartnerService();
    
    BankAccountService getBankAccountService();
    
    IPartnerTitle getDocumentOrganization();
    
    IPartnerTitle getDocumentPartner();
}
