 ...
 *
 */
public abstract class AbstractProductEdit extends EXTChildEditForm implements ProductForm {
    
    private Product product;

    public AbstractProductEdit() {
        super();
    }
    
    public AbstractProductEdit(Resources resources) {
        super(resources);
    }
