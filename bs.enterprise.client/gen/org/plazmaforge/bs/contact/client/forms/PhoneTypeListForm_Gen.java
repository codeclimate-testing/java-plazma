...
public class PhoneTypeListForm_Gen extends ListForm {


  public PhoneTypeListForm_Gen() {
  }
  ...
  public void createUI() {
    ...
    setName("PhoneTypeListForm");
    setType("ListForm");
    setTitle(getString("PhoneTypeListForm.title"));
  ...
  public Composite createContent() {
    ...
    column1.setText(getString("PhoneTypeListForm.codeColumn.text"));
    ...
    column2.setText(getString("PhoneTypeListForm.nameColumn.text"));
