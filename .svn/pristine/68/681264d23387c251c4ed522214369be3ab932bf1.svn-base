 ...
 * Date: 18.07.2004
 * Time: 11:10:03
 * $Id: GUIFinanceAction.java,v 1.2 2010/04/28 06:28:13 ohapon Exp $
 */
public abstract class GUIFinanceAction extends ResourceAction {

    public GUIFinanceAction() {
        super(GUIFinanceEnvironment.getResources());
    }


    public GUIFinanceAction(Resources resources) {
