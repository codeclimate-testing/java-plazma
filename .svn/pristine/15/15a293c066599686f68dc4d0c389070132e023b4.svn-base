...
/**
 * @author Oleh Hapon
 * $Id: ProductStateInfo.java,v 1.2 2010/04/28 06:24:21 ohapon Exp $
 */

public class ProductStateInfo implements Serializable {

    private double availableQuantity;
    
    private double reserveQuantity;

    private double awaitQuantity;
    ...
    public double getAwaitQuantity() {
        return awaitQuantity;
    }

    public void setAwaitQuantity(double awaitQuantity) {
