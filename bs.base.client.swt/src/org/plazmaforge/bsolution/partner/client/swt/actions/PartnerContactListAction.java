...
/** 
 * @author Oleh Hapon
 * $Id: PartnerContactListAction.java,v 1.2 2010/04/28 06:31:03 ohapon Exp $
 */

public class PartnerContactListAction extends AbstractListFormAction  {
    
    public Class getListFormClass() {
	return ContactListForm.class;
    }
}