...
/** 
 * @author Oleh Hapon
 * $Id: PurchaseInvoiceItemEditForm.java,v 1.2 2010/04/28 06:31:04 ohapon Exp $
 */

public class PurchaseInvoiceItemEditForm extends AbstractGoodsDocumentItemEditForm {
    ...
    public  PurchaseInvoiceItemEditForm(Composite parent, int style) {
	super(parent, style);
	initialize();
    }
	...
	goodsLabel.setText(Messages.getString("PurchaseInvoiceItemEditForm.goodsLabel.text")); //$NON-NLS-1$
	...
	gridData.widthHint = 300;
    	...
    	productFeatureLabel.setText(Messages.getString("PurchaseInvoiceItemEditForm.productFeatureLabel.text")); //$NON-NLS-1$
	...
	unitLabel = new Label(this, SWT.NONE);
    	unitLabel.setText(Messages.getString("PurchaseInvoiceItemEditForm.unitLabel.text")); //$NON-NLS-1$
    	...
    	currencyBasePriceLabel.setText(Messages.getString("PurchaseInvoiceItemEditForm.currencyBasePriceLabel.text")); //$NON-NLS-1$
	...
	unitRateLabel.setText(Messages.getString("PurchaseInvoiceItemEditForm.unitRateLabel.text")); //$NON-NLS-1$
	...
	unitRateField.setLayoutData(gridData);
    	...
    	pricePercentLabel.setText(Messages.getString("PurchaseInvoiceItemEditForm.pricePercentLabel.text")); //$NON-NLS-1$
	...
	quantityLabel.setText(Messages.getString("PurchaseInvoiceItemEditForm.quantityLabel.text")); //$NON-NLS-1$
	...
	currencyPriceLabel.setText(Messages.getString("PurchaseInvoiceItemEditForm.currencyPriceLabel.text")); //$NON-NLS-1$
	...
	currencyAmountLabel.setText(Messages.getString("PurchaseInvoiceItemEditForm.currencyAmountLabel.text")); //$NON-NLS-1$
	...
	taxLabel.setText(Messages.getString("PurchaseInvoiceItemEditForm.taxLabel.text")); //$NON-NLS-1$
	...
	currencyTaxAmountLabel.setText(Messages.getString("PurchaseInvoiceItemEditForm.currencyTaxAmountLabel.text")); //$NON-NLS-1$
