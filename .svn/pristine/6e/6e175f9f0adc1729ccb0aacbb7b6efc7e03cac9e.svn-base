...
public class TaskRoleListForm_Gen extends ListForm {


  public TaskRoleListForm_Gen() {
  }
  ...
  public void createUI() {
    ...
    setName("TaskRoleListForm");
    setType("ListForm");
    setTitle(getString("TaskRoleListForm.title"));
  ...
  public Composite createContent() {
    ...
    column1.setText(getString("TaskRoleListForm.nameColumn.text"));
    ...
    column2.setText(getString("TaskRoleListForm.descriptionColumn.text"));
    ...
    column3.setText(getString("TaskRoleListForm.codeColumn.text"));
