...
import org.plazmaforge.bsolution.purchase.common.beans.PurchaseTaxWaybill;
import org.plazmaforge.bsolution.purchase.common.beans.PurchaseTaxWaybillItem;
...
/** 
 * @author Oleh Hapon
 * $Id: PurchaseTaxWaybillEditForm.java,v 1.7 2010/12/05 07:57:18 ohapon Exp $
 */

public class PurchaseTaxWaybillEditForm extends AbstractGoodsDocumentEditForm {
     ...
     * @param style
     */
    public PurchaseTaxWaybillEditForm(Composite parent, int style) {
	super(parent, style);
	initialize();
	...
	setTitle(Messages.getString("PurchaseTaxWaybillEditForm.title")); //$NON-NLS-1$
	setLayout(gridLayout);
    	...
    	generalTabItem.setText(Messages.getString("PurchaseTaxWaybillEditForm.generalTabItem.text")); //$NON-NLS-1$
    	...
    	documentNoLabel.setText(Messages.getString("PurchaseTaxWaybillEditForm.documentNoLabel.text")); //$NON-NLS-1$
	...
	documentDateLabel.setText(Messages.getString("PurchaseTaxWaybillEditForm.documentDateLabel.text")); //$NON-NLS-1$
	...
	gridData = new GridData(SWT.FILL, SWT.CENTER, false, false);
    	...
    	partnerLabel.setText(Messages.getString("PurchaseTaxWaybillEditForm.partnerLabel.text")); //$NON-NLS-1$
	...
	responsibleLabel.setText(Messages.getString("PurchaseTaxWaybillEditForm.responsibleLabel.text")); //$NON-NLS-1$
	...
	contractLabel.setText(Messages.getString("PurchaseTaxWaybillEditForm.contractLabel.text")); //$NON-NLS-1$
	...
	reasonDocumentLabel.setText(Messages.getString("PurchaseTaxWaybillEditForm.reasonDocumentLabel.text")); //$NON-NLS-1$
	...
	reasonLabel.setText(Messages.getString("PurchaseTaxWaybillEditForm.reasonLabel.text")); //$NON-NLS-1$
	...
	gridData = new GridData();
    	...
    	currencyLabel.setText(Messages.getString("PurchaseTaxWaybillEditForm.currencyLabel.text")); //$NON-NLS-1$
	...
	currencyRateLabel.setText(Messages.getString("PurchaseTaxWaybillEditForm.currencyRateLabel.text")); //$NON-NLS-1$
	...
	currencyRateDateLabel.setText(Messages.getString("PurchaseTaxWaybillEditForm.currencyRateDateLabel.text")); //$NON-NLS-1$
	...
	gridData = new GridData(SWT.FILL, SWT.CENTER, false, false);
    	...
    	noteTabItem.setText(Messages.getString("PurchaseTaxWaybillEditForm.noteTabItem.text")); //$NON-NLS-1$
    	...
    	createItemPanel();
    	createSummaryPanel();
    	AttributeValueView attributeView = new AttributeValueView(itemsTabFolder, PurchaseTaxWaybill.class);
    ...
    private void createItemPanel() {
        ...
        productTabItem.setText(Messages.getString("PurchaseTaxWaybillEditForm.productTabItem.text")); //$NON-NLS-1$
        ...
        productNameColumn.setText(Messages.getString("PurchaseTaxWaybillEditForm.productNameColumn.text")); //$NON-NLS-1$

        TableColumn unitNameColumn = new TableColumn(productTable, SWT.CENTER);
        unitNameColumn.setWidth(60);
        unitNameColumn.setText(Messages.getString("PurchaseTaxWaybillEditForm.unitNameColumn.text")); //$NON-NLS-1$

        TableColumn unitRateColumn = new TableColumn(productTable, SWT.RIGHT);
        unitRateColumn.setWidth(50);
        unitRateColumn.setText(Messages.getString("PurchaseTaxWaybillEditForm.unitRateColumn.text")); //$NON-NLS-1$

        TableColumn quantityColumn = new TableColumn(productTable, SWT.RIGHT);
        quantityColumn.setWidth(80);
        quantityColumn.setText(Messages.getString("PurchaseTaxWaybillEditForm.quanityColumn.text")); //$NON-NLS-1$
         
        TableColumn currencyPriceColumn = new TableColumn(productTable, SWT.RIGHT);
        currencyPriceColumn.setWidth(80);
        currencyPriceColumn.setText(Messages.getString("PurchaseTaxWaybillEditForm.currencyPriceColumn.text")); //$NON-NLS-1$
        
        TableColumn currencyAmountColumn = new TableColumn(productTable, SWT.RIGHT);
        currencyAmountColumn.setWidth(80);
        currencyAmountColumn.setText(Messages.getString("PurchaseTaxWaybillEditForm.currencyAmountColumn.text"));       //$NON-NLS-1$
        
        TableColumn currencyTaxAmountColumn = new TableColumn(productTable, SWT.RIGHT);
        currencyTaxAmountColumn.setWidth(80);
        currencyTaxAmountColumn.setText(Messages.getString("PurchaseTaxWaybillEditForm.currencyTaxAmountColumn.text"));         //$NON-NLS-1$
	...
	gridData = new GridData(SWT.FILL, SWT.CENTER, false, false);
    	...
    	currencyTotalLabel.setText(Messages.getString("PurchaseTaxWaybillEditForm.currencyTotalLabel.text")); //$NON-NLS-1$
	...
	gridData = new GridData();
    	...
    	currencyTaxTotalLabel.setText(Messages.getString("PurchaseTaxWaybillEditForm.currencyTaxTotalLabel.text")); //$NON-NLS-1$
	...
	gridData = new GridData();
    	...
    	currencyTotalWithTaxLabel.setText(Messages.getString("PurchaseTaxWaybillEditForm.currencyTotalWithTaxLabel.text")); //$NON-NLS-1$
	...
	public ProductItemProvider() {
	    setParentEntityClass(PurchaseTaxWaybill.class); // OWNER
	    setEntityClass(PurchaseTaxWaybillItem.class); // FORM ID
    ...
    private PurchaseTaxWaybill getPurchaseTaxWaybill() {
        return (PurchaseTaxWaybill) getEntity();
    }

    protected void initData() throws ApplicationException {
        super.initData();
        getPurchaseTaxWaybill().setPartner(EnterpriseEnvironment.getCustomer());
    }
