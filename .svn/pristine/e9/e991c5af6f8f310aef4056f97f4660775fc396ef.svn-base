...
/** 
 * @author Oleh Hapon
 * $Id: SalePlanItemEditForm.java,v 1.3 2010/04/28 06:31:06 ohapon Exp $
 */

public class SalePlanItemEditForm extends AbstractGoodsDocumentItemEditForm {
    ...
    public  SalePlanItemEditForm(Composite parent, int style) {
	super(parent, style);
	initialize();
    }
	...
	goodsLabel.setText(Messages.getString("SalePlanItemEditForm.goodsLabel.text")); //$NON-NLS-1$
	...
	unitLabel = new Label(this, SWT.NONE);
    	unitLabel.setText(Messages.getString("SalePlanItemEditForm.unitLabel.text")); //$NON-NLS-1$
	...
	unitRateLabel.setText(Messages.getString("SalePlanItemEditForm.unitRateLabel.text")); //$NON-NLS-1$
	...
	quantityLabel.setText(Messages.getString("SalePlanItemEditForm.quantityLabel.text")); //$NON-NLS-1$
	...
	currencyPriceLabel.setText(Messages.getString("SalePlanItemEditForm.currencyPriceLabel.text")); //$NON-NLS-1$
	...
	currencyAmountLabel.setText(Messages.getString("SalePlanItemEditForm.currencyAmountLabel.text")); //$NON-NLS-1$
	...
	taxLabel.setText(Messages.getString("SalePlanItemEditForm.taxLabel.text")); //$NON-NLS-1$
	...
	currencyTaxAmountLabel.setText(Messages.getString("SalePlanItemEditForm.currencyTaxAmountLabel.text")); //$NON-NLS-1$
