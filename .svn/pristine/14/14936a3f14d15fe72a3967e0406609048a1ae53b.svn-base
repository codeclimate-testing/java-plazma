...
/** 
 * @author Oleh Hapon
 * $Id: DatabaseCSVExporter.java,v 1.2 2010/04/28 06:34:31 ohapon Exp $
 */

public class DatabaseCSVExporter extends AbstractDatabaseExporter {
	...
	CSVExporter dataSetExporter =  new CSVExporter();
