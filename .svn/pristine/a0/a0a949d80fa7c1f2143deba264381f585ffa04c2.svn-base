 ...
 * Date: 26.02.2004
 * Time: 9:50:27
 * $Id: FilterAction.java,v 1.3 2010/12/05 07:52:08 ohapon Exp $
 */
public class FilterAction  extends ListFormAction {

    public FilterAction(ListForm listForm, Resources resources) {
        super(listForm, resources);
    }

    public void perform(ActionEvent evt) throws ApplicationException {
        listForm.doFilterCommand();
    }
