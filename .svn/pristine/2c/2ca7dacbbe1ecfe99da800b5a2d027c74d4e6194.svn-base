 ...
 * Date: 26.09.2004
 * Time: 10:06:07
 * $Id: AcademicDegreeList.java,v 1.3 2010/12/05 07:56:44 ohapon Exp $
 */
public class AcademicDegreeList extends EXTListForm {

    public AcademicDegreeList() throws ApplicationException {
        super(GUIPersonalityEnvironment.getResources());
        initialize();
    }

    public AcademicDegreeList(Window window) throws ApplicationException {
    ...
    private void initialize() {
        ...
        this.setEntityEditFormClass(AcademicDegreeEdit.class);
    }
