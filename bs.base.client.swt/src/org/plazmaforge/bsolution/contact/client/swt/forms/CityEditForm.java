...
/** 
 * @author Oleh Hapon
 * $Id: CityEditForm.java,v 1.2 2010/04/28 06:31:05 ohapon Exp $
 */
public class CityEditForm extends AbstractEditForm {
     ...
     * @param style
     */
    public CityEditForm(Composite parent, int style) {
	super(parent, style);
	initialize();
	...
	setTitle(Messages.getString("CityEditForm.title")); //$NON-NLS-1$
	GridData gridData;
	...
	setLayout(gridLayout);
    	...
    	countryLabel.setText(Messages.getString("CityEditForm.countryLabel.text")); //$NON-NLS-1$
    	...
    	regionLabel.setText(Messages.getString("CityEditForm.regionLabel.text")); //$NON-NLS-1$

    	regionField = new XComboEdit(this, SWT.BORDER, PWT.POPUP_BUTTON | PWT.VIEW_BUTTON | PWT.EDIT_BUTTON | PWT.DELETE_BUTTON);
    	regionField.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, true, false));
    
    	nameLabel = new Label(this, SWT.NONE);
    	nameLabel.setText(Messages.getString("CityEditForm.nameLabel.text")); //$NON-NLS-1$
