...
/**
 * @author Oleh Hapon Date: 27.02.2004 Time: 17:33:12 $Id:
 *         CountryListAction.java,v 1.1 2007/03/02 07:06:46 ohapon Exp $
 */
public class CountryListAction extends GUIBaseAction {

    public void perform(ActionEvent e) throws ApplicationException {
	SwingFormManager.showListForm(CountryList.class);
    }
}
