 ...
 * Date: 18.12.2004
 * Time: 12:06:56
 * $Id: StorableListAction.java,v 1.3 2010/12/05 07:56:44 ohapon Exp $
 */
public class StorableListAction extends GUIOrganizationAction {

    public void perform(ActionEvent e) throws ApplicationException {
        SwingFormManager.showListForm(StorableList.class);
    }
}
