...
/** 
 * @author Oleh Hapon
 * $Id: PurchaseServ.java,v 1.2 2010/04/28 06:24:18 ohapon Exp $
 */

public class PurchaseServ extends WarehouseProductDocument implements IPartnerableDocument {

    public static final String CLASS_ID = "PURCHASE_SERV";
