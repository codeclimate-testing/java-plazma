...
/** 
 * @author Oleh Hapon
 * $Id: SaleTaxWaybillItemEditForm.java,v 1.3 2010/04/28 06:31:06 ohapon Exp $
 */

public class SaleTaxWaybillItemEditForm extends AbstractGoodsDocumentItemEditForm {
    ...
    public  SaleTaxWaybillItemEditForm(Composite parent, int style) {
	super(parent, style);
	initialize();
    }
	...
	goodsLabel.setText(Messages.getString("SaleTaxWaybillItemEditForm.goodsLabel.text")); //$NON-NLS-1$
	...
	gridData.widthHint = 300;
    	...
    	productFeatureLabel.setText(Messages.getString("SaleTaxWaybillItemEditForm.productFeatureLabel.text")); //$NON-NLS-1$
	...
	unitLabel = new Label(this, SWT.NONE);
    	unitLabel.setText(Messages.getString("SaleTaxWaybillItemEditForm.unitLabel.text")); //$NON-NLS-1$
	...
	unitRateLabel.setText(Messages.getString("SaleTaxWaybillItemEditForm.unitRateLabel.text")); //$NON-NLS-1$
	...
	quantityLabel.setText(Messages.getString("SaleTaxWaybillItemEditForm.quantityLabel.text")); //$NON-NLS-1$
	...
	currencyPriceLabel.setText(Messages.getString("SaleTaxWaybillItemEditForm.currencyPriceLabel.text")); //$NON-NLS-1$
	...
	currencyAmountLabel.setText(Messages.getString("SaleTaxWaybillItemEditForm.currencyAmountLabel.text")); //$NON-NLS-1$
	...
	taxLabel.setText(Messages.getString("SaleTaxWaybillItemEditForm.taxLabel.text")); //$NON-NLS-1$
	...
	currencyTaxAmountLabel.setText(Messages.getString("SaleTaxWaybillItemEditForm.currencyTaxAmountLabel.text")); //$NON-NLS-1$
