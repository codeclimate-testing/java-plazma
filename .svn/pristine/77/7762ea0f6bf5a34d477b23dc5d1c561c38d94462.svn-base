...
import org.plazmaforge.bsolution.goods.client.swing.forms.SalePlanList;
 ...
 * Created 24.07.2006
 */
public class SalePlanListAction extends GUIGoodsAction {

    public void perform(ActionEvent e) throws ApplicationException {
        SwingFormManager.showListForm(SalePlanList.class);
    }
