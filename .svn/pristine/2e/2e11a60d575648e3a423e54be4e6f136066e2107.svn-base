...
/** 
 * @author Oleh Hapon
 * $Id: CountryEditForm.java,v 1.3 2010/05/17 11:17:43 ohapon Exp $
 */
public class CountryEditForm extends AbstractEditForm {
     ...
     * @param style
     */
    public CountryEditForm(Composite parent, int style) {
	super(parent, style);
	initialize();
	...
	setTitle(Messages.getString("CountryEditForm.title")); //$NON-NLS-1$
	GridData gridData;
	...
	codeLabel.setText(Messages.getString("CountryEditForm.codeLabel.text")); //$NON-NLS-1$
	...
	code3Label.setText(Messages.getString("CountryEditForm.code3Label.text")); //$NON-NLS-1$
    	...
    	numericCodeLabel.setText(Messages.getString("CountryEditForm.numericCodeLabel.text")); //$NON-NLS-1$
	...
	nameLabel.setText(Messages.getString("CountryEditForm.nameLabel.text")); //$NON-NLS-1$
