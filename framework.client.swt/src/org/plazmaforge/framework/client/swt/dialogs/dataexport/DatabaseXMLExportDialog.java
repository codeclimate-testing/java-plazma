...
/** 
 * @author Oleh Hapon
 * $Id: DatabaseXMLExportDialog.java,v 1.11 2010/05/16 09:47:54 ohapon Exp $
 */

public class DatabaseXMLExportDialog extends XMLExportDialog {

    private static final int FLAGS = FMT_ENCODING | FMT_NULL;
    
    
    public DatabaseXMLExportDialog(Shell parentShell) {
	super(parentShell);
    }
