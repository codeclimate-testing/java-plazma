 ...
 * Date: 19.09.2004
 * Time: 12:39:32
 * $Id: MilitaryStatusEdit.java,v 1.3 2010/12/05 07:56:44 ohapon Exp $
 */
public class MilitaryStatusEdit extends EXTEditForm {
    ...
    public MilitaryStatusEdit() throws ApplicationException {
        super(GUIPersonalityEnvironment.getResources());
        initialize();
    }
    
    private void initialize() {
        this.setEntityClass(MilitaryStatus.class);
        this.setEntityServiceClass(MilitaryStatusService.class);
    }
    ...
    private MilitaryStatus getMilitaryStatus() {
        return (MilitaryStatus) this.getEntity();
    }

    protected void updateView() throws ApplicationException {
        appendTitle(getMilitaryStatus().getName());
        codeField.setText(getMilitaryStatus().getCode());
        nameField.setText(getMilitaryStatus().getName());
    }

    protected void populateData() throws ApplicationException {
        getMilitaryStatus().setCode(codeField.getText());
        getMilitaryStatus().setName(nameField.getText());
    }
