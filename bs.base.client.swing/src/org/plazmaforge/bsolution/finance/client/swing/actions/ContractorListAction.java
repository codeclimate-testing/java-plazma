 ...
 * @author Oleh Hapon
 *
 * $Id: ContractorListAction.java,v 1.3 2010/12/05 07:56:46 ohapon Exp $
 * 
 */

public class ContractorListAction extends GUIFinanceAction {

    public void perform(ActionEvent e) throws ApplicationException {
        SwingFormManager.showListForm(ContractorList.class);
    }
}
