...
/** 
 * @author Oleh Hapon
 * $Id: InventoryRestItemEditForm.java,v 1.2 2010/04/28 06:31:08 ohapon Exp $
 */

public class InventoryRestItemEditForm extends AbstractGoodsDocumentItemEditForm {
    ...
    public  InventoryRestItemEditForm(Composite parent, int style) {
	super(parent, style);
	initialize();
    }
	...
	goodsLabel.setText(Messages.getString("InventoryRestItemEditForm.goodsLabel.text")); //$NON-NLS-1$
	...
	unitLabel = new Label(this, SWT.NONE);
    	unitLabel.setText(Messages.getString("InventoryRestItemEditForm.unitLabel.text")); //$NON-NLS-1$
	...
	unitRateLabel.setText(Messages.getString("InventoryRestItemEditForm.unitRateLabel.text")); //$NON-NLS-1$
	...
	quantityLabel.setText(Messages.getString("InventoryRestItemEditForm.quantityLabel.text")); //$NON-NLS-1$
	...
	currencyPriceLabel.setText(Messages.getString("InventoryRestItemEditForm.currencyPriceLabel.text")); //$NON-NLS-1$
	...
	currencyAmountLabel.setText(Messages.getString("InventoryRestItemEditForm.currencyAmountLabel.text")); //$NON-NLS-1$
