...
/** 
 * @author Oleh Hapon
 * $Id: ProjectStageGroupEditForm.java,v 1.1 2008/12/01 12:27:17 ohapon Exp $
 */

public class ProjectStageGroupEditForm extends AbstractEditForm {
     ...
     * @param style
     */
    public ProjectStageGroupEditForm(Composite parent, int style) {
	super(parent, style);
	initialize();
	...
	setTitle(Messages.getString("ProjectStageGroupEditForm.title")); //$NON-NLS-1$
	GridData gridData;
	...
	codeLabel.setText(Messages.getString("ProjectStageGroupEditForm.codeLabel.text")); //$NON-NLS-1$
	...
	nameLabel.setText(Messages.getString("ProjectStageGroupEditForm.nameLabel.text")); //$NON-NLS-1$
	...
	descriptionLabel.setLayoutData(new GridData(SWT.LEFT, SWT.TOP, false, false));
    	descriptionLabel.setText(Messages.getString("ProjectStageGroupEditForm.descriptionLabel.text")); //$NON-NLS-1$
