...
public class ProjectStageGroupListForm_Gen extends ListForm {


  public ProjectStageGroupListForm_Gen() {
  }
  ...
  public void createUI() {
    ...
    setName("ProjectStageGroupListForm");
    setType("ListForm");
    setTitle(getString("ProjectStageGroupListForm.title"));
  ...
  public Composite createContent() {
    ...
    column1.setText(getString("ProjectStageGroupListForm.nameColumn.text"));
    ...
    column2.setText(getString("ProjectStageGroupListForm.descriptionColumn.text"));
    ...
    column3.setText(getString("ProjectStageGroupListForm.codeColumn.text"));
