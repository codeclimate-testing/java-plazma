...
/** 
 * @author Oleh Hapon
 * $Id: PaymentOutcomeListForm.java,v 1.6 2010/12/05 07:57:18 ohapon Exp $
 */

public class PaymentOutcomeListForm extends AbstractFinanceDocumentListForm {
    ...
    public PaymentOutcomeListForm(Composite parent, int style) {
	super(parent, style);
	initialize();
    }
	...
	setTitle(Messages.getString("PaymentOutcomeListForm.title")); //$NON-NLS-1$
        ...
        documentNoColumn.setText(Messages.getString("PaymentOutcomeListForm.documentNoColumn.text")); //$NON-NLS-1$

        documentDateColumn = new TableColumn(table, SWT.NONE);
        documentDateColumn.setMoveable(true);
        documentDateColumn.setWidth(100);
        documentDateColumn.setText(Messages.getString("PaymentOutcomeListForm.documentDateColumn.text")); //$NON-NLS-1$

        partnerColumn = new TableColumn(table, SWT.NONE);
        partnerColumn.setMoveable(true);
        partnerColumn.setWidth(250);
        partnerColumn.setText(Messages.getString("PaymentOutcomeListForm.partnerColumn.text")); //$NON-NLS-1$
        ...
        paymentMissingColumn.setText(Messages.getString("PaymentOutcomeListForm.paymentMissingColumn.text"));         //$NON-NLS-1$
    	
        currencyTotalColumn = new TableColumn(table, SWT.RIGHT);
        currencyTotalColumn.setMoveable(true);
        currencyTotalColumn.setWidth(100);
        currencyTotalColumn.setText(Messages.getString("PaymentOutcomeListForm.currencyTotalColumn.text"));    	 //$NON-NLS-1$
        ...
        projectColumn.setText(Messages.getString("PaymentOutcomeListForm.projectColumn.text")); //$NON-NLS-1$
    }
