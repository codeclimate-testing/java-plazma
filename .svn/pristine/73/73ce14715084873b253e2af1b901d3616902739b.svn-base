...
import org.plazmaforge.bsolution.contact.client.swing.forms.CityList;
 ...
 * Time: 17:51:52
 */
public class CityListAction extends GUIContactAction {

    public void perform(ActionEvent e) throws ApplicationException {
        SwingFormManager.showListForm(CityList.class);
    }
