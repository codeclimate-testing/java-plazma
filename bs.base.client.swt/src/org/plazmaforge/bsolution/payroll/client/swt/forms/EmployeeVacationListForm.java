...
public class EmployeeVacationListForm extends AbstractDocumentListForm {
	...
	setTitle(Messages.getString("EmployeeVacationListForm.title"));  //$NON-NLS-1$
    	...
    	documentNoColumn.setText(Messages.getString("EmployeeVacationListForm.documentNoColumn.text")); //$NON-NLS-1$
    	
 	documentDateColumn = new TableColumn(table, SWT.NONE);
    	documentDateColumn.setWidth(100);
    	documentDateColumn.setText(Messages.getString("EmployeeVacationListForm.documentDateColumn.text")); //$NON-NLS-1$
    	
 	employeeColumn = new TableColumn(table, SWT.NONE);
    	employeeColumn.setWidth(300);
    	employeeColumn.setText(Messages.getString("EmployeeVacationListForm.employeeColumn.text")); //$NON-NLS-1$
    	

 	startDateColumn = new TableColumn(table, SWT.RIGHT);
    	startDateColumn.setWidth(100);
    	startDateColumn.setText(Messages.getString("EmployeeVacationListForm.startDateColumn.text")); //$NON-NLS-1$
    	
 	endDateColumn = new TableColumn(table, SWT.RIGHT);
    	endDateColumn.setWidth(100);
    	endDateColumn.setText(Messages.getString("EmployeeVacationListForm.endDateColumn.text")); //$NON-NLS-1$

        responsibleColumn = new TableColumn(table, SWT.NONE);
        responsibleColumn.setMoveable(true);
        responsibleColumn.setWidth(200);
        responsibleColumn.setText(Messages.getString("EmployeeVacationListForm.responsibleColumn.text")); //$NON-NLS-1$
