...
public class ProjectStatusEditForm extends AbstractEditForm {
	...
	setTitle(Messages.getString("ProjectStatusEditForm.title")); //$NON-NLS-1$
	GridData gridData;
	...
	codeLabel.setText(Messages.getString("ProjectStatusEditForm.codeLabel.text")); //$NON-NLS-1$
	...
	nameLabel.setText(Messages.getString("ProjectStatusEditForm.nameLabel.text")); //$NON-NLS-1$
	...
	descriptionLabel.setLayoutData(new GridData(SWT.LEFT, SWT.TOP, false, false));
    	descriptionLabel.setText(Messages.getString("ProjectStatusEditForm.descriptionLabel.text")); //$NON-NLS-1$
    	...
    	startStatusLabel.setText(Messages.getString("ProjectStatusEditForm.startStatusLabel.text")); //$NON-NLS-1$

    	startStatusField = new XCheckBox(this, SWT.NONE);

    	finishStatusLabel = new Label(this, SWT.NONE);
    	finishStatusLabel.setText(Messages.getString("ProjectStatusEditForm.finishStatusLabel.text")); //$NON-NLS-1$
