...
/** 
 * @author Oleh Hapon
 * $Id: WebEditForm.java,v 1.4 2010/12/05 07:57:21 ohapon Exp $
 */

public class WebEditForm extends AbstractEditForm {
     ...
     * @param style
     */
    public WebEditForm(Composite parent, int style) {
	super(parent, style);
	...
	setTitle(Messages.getString("WebEditForm.title")); //$NON-NLS-1$
	...
	GridData gridData;
    	...
    	generalTabItem.setText(Messages.getString("WebEditForm.generalTabItem.text")); //$NON-NLS-1$
	...
	gridLayout.marginTop = 10;
    	...
    	defaultLabel.setText(Messages.getString("WebEditForm.defaultLabel.text")); //$NON-NLS-1$
    	...
    	urlField = new XTextField(composite, SWT.BORDER);
    	...
    	noteTabItem.setText(Messages.getString("WebEditForm.noteTabItem.text")); //$NON-NLS-1$
	...
	bindControl(urlField, "url", urlLabel, REQUIRED);
	bindControl(noteField, "note");
    }
    
   private Web getWeb() {
       return (Web) getEntity();
   }
   ...
   public void updateForm() throws ApplicationException {
	...
	return element.isSimpleContactList(getWeb());
    }    
