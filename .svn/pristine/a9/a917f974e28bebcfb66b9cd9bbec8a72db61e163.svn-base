...
public interface IFormFactory {
    ...
    Class getFormClass(String formName);
    ...
    IForm getForm(Class formClass) throws ApplicationException;
    
    IForm getForm(Class formClass, Object parent) throws ApplicationException;
