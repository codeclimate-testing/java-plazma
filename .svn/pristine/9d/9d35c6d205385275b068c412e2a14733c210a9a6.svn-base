...
public class TaskTypeEditForm_Gen extends EditForm {


  public TaskTypeEditForm_Gen() {
  }
  ...
  public void createUI() {
    ...
    setName("TaskTypeEditForm");
    setType("EditForm");
    setTitle(getString("TaskTypeEditForm.title"));
  ...
  public Composite createContent() {
    ...
    label1.setText(getString("TaskTypeEditForm.codeLabel.text"));
    content.add(label1);
    ...
    label2.setText(getString("TaskTypeEditForm.nameLabel.text"));
    content.add(label2);
    ...
    label3.setText(getString("TaskTypeEditForm.descriptionLabel.text"));
    content.add(label3);
