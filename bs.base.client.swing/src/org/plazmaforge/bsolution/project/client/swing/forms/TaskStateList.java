...
public class TaskStateList extends EXTListForm {

    public TaskStateList() throws ApplicationException {
        super(GUIProjectEnvironment.getResources());
        initialize();
    }

    public TaskStateList(Window window) throws ApplicationException {
    ...
    private void initialize() {
        ...
        this.setEntityEditFormClass(TaskStateEdit.class);
    }
