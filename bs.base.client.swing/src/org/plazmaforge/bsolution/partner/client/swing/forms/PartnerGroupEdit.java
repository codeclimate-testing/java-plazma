 ...
 * Date: 15.09.2004
 * Time: 7:54:00
 * $Id: PartnerGroupEdit.java,v 1.3 2010/12/05 07:56:43 ohapon Exp $
 */
public class PartnerGroupEdit extends EXTEditForm {

    private JLabel nameLabel;
    private JTextField nameField;

    public PartnerGroupEdit() throws ApplicationException {
    ...
    private PartnerGroup getPartnerGroup() {
        return (PartnerGroup) this.getEntity();
    }

    protected void updateView() throws ApplicationException {
        appendTitle(getPartnerGroup().getName());
        nameField.setText(getPartnerGroup().getName());
    }

    protected void populateData() throws ApplicationException {
        getPartnerGroup().setName(nameField.getText());
    }
}
