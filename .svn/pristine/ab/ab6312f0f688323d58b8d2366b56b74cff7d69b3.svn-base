 ...
 * Created 31.05.2006
 */
public class SaleOrder extends WarehouseProductDocument implements IPartnerableDocument, IPayReasonDocument {

    public static final String CLASS_ID = "SALE_ORDER";
