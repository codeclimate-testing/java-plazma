...
/** 
 * @author Oleh Hapon
 * $Id: CashOutcomeListForm.java,v 1.6 2010/12/05 07:57:22 ohapon Exp $
 */

public class CashOutcomeListForm extends AbstractFinanceDocumentListForm {
    ...
    public CashOutcomeListForm(Composite parent, int style) {
	super(parent, style);
	initialize();
    }
	...
	setTitle(Messages.getString("CashOutcomeListForm.title")); //$NON-NLS-1$
        TableColumn tableColumn;
        TableColumn documentNoColumn;
        TableColumn documentDateColumn;
        TableColumn contractorColumn;
        ...
        documentNoColumn.setText(Messages.getString("CashOutcomeListForm.documentNoColumn.text")); //$NON-NLS-1$

        documentDateColumn = new TableColumn(table, SWT.NONE);
        documentDateColumn.setMoveable(true);
        documentDateColumn.setWidth(100);
        documentDateColumn.setText(Messages.getString("CashOutcomeListForm.documentDateColumn.text")); //$NON-NLS-1$

        contractorColumn = new TableColumn(table, SWT.NONE);
        contractorColumn.setMoveable(true);
        contractorColumn.setWidth(250);
        contractorColumn.setText(Messages.getString("CashOutcomeListForm.partnerColumn.text")); //$NON-NLS-1$
        ...
        paymentMissingColumn.setText(Messages.getString("CashOutcomeListForm.paymentMissingColumn.text")); //$NON-NLS-1$

        currencyTotalColumn = new TableColumn(table, SWT.RIGHT);
        currencyTotalColumn.setMoveable(true);
        currencyTotalColumn.setWidth(100);
        currencyTotalColumn.setText(Messages.getString("CashOutcomeListForm.currencyTotalColumn.text"));  //$NON-NLS-1$
    	
        responsibleColumn = new TableColumn(table, SWT.NONE);
        responsibleColumn.setMoveable(true);
        responsibleColumn.setWidth(200);
        responsibleColumn.setText(Messages.getString("CashOutcomeListForm.responsibleColumn.text")); //$NON-NLS-1$
