...
public class PIMPackage extends DefaultPackage {

    public void init() {
	CalendarEnvironment.getInstance().registerCalendarService("PIMAppointment", PIMAppointmentService.class);
	CalendarEnvironment.getInstance().registerCalendarService("PIMEvent", PIMEventService.class);
    }
}
