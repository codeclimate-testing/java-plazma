...
public class PIMEventListForm extends AbstractResponsableListForm implements IMyForm {
    ...
    public PIMEventListForm(Composite parent, int style) {
	super(parent, style);
	initialize();
    }
	...
	setTitle(Messages.getString("PIMEventListForm.title")); //$NON-NLS-1$
    	...
    	eventDateTimeColumn.setText(Messages.getString("PIMEventListForm.eventDateTimeColumn.text"));     //$NON-NLS-1$

    	nameColumn = new TableColumn(table, SWT.NONE);
    	nameColumn.setMoveable(true);
    	nameColumn.setWidth(300);
    	nameColumn.setText(Messages.getString("PIMEventListForm.nameColumn.text")); //$NON-NLS-1$

    	responsibleColumn = new TableColumn(table, SWT.NONE);
    	responsibleColumn.setWidth(200);
    	responsibleColumn.setText(Messages.getString("PIMEventListForm.responsibleColumn.text"));  //$NON-NLS-1$
	...
	if (isMyFormMode()) {
	    getDecorator().setTitle(Messages.getString("MyPIMEventListForm.title"));
	    return;
	}
