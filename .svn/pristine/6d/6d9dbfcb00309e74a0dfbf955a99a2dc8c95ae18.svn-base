 ...
 * 
 * @author Oleh Hapon
 * $Id: CarMtrlPurchaseReportListForm.java,v 1.4 2010/12/05 07:53:48 ohapon Exp $
 */
public class CarMtrlPurchaseReportListForm extends AbstractFinanceDocumentListForm {
    ...
    public CarMtrlPurchaseReportListForm(Composite parent, int style) {
	super(parent, style);
	initialize();
    }
	...
	setTitle(Messages.getString("CarMtrlPurchaseReportListForm.title")); //$NON-NLS-1$
        TableColumn tableColumn;
        
        TableColumn documentNoColumn;
        TableColumn documentDateColumn;
        TableColumn carMtrlPurchaseRequestColumn;
        TableColumn carServOrderColumn;
        ...
        documentNoColumn.setText(Messages.getString("CarMtrlPurchaseReportListForm.documentNoColumn.text")); //$NON-NLS-1$

        documentDateColumn = new TableColumn(table, SWT.NONE);
        documentDateColumn.setMoveable(true);
        documentDateColumn.setWidth(70);
        documentDateColumn.setText(Messages.getString("CarMtrlPurchaseReportListForm.documentDateColumn.text")); //$NON-NLS-1$

        carMtrlPurchaseRequestColumn = new TableColumn(table, SWT.NONE);
        carMtrlPurchaseRequestColumn.setMoveable(true);
        carMtrlPurchaseRequestColumn.setWidth(200);
        carMtrlPurchaseRequestColumn.setText(Messages.getString("CarMtrlPurchaseReportListForm.carMtrlPurchaseRequestColumn.text")); //$NON-NLS-1$
    	
    	
        carServOrderColumn = new TableColumn(table, SWT.NONE);
        carServOrderColumn.setMoveable(true);
        carServOrderColumn.setWidth(200);
        carServOrderColumn.setText(Messages.getString("CarMtrlPurchaseReportListForm.carServOrderColumn.text")); //$NON-NLS-1$
    	
        currencyTotalColumn = new TableColumn(table, SWT.RIGHT);
        currencyTotalColumn.setMoveable(true);
        currencyTotalColumn.setWidth(110);
        currencyTotalColumn.setText(Messages.getString("CarMtrlPurchaseReportListForm.currencyTotalColumn.text"));    	 //$NON-NLS-1$
    	
        currencyColumn = new TableColumn(table, SWT.CENTER);
        currencyColumn.setMoveable(true);
        currencyColumn.setWidth(70);
        currencyColumn.setText(Messages.getString("CarMtrlPurchaseReportListForm.currencyColumn.text")); //$NON-NLS-1$
        
        totalColumn = new TableColumn(table, SWT.RIGHT);
        totalColumn.setMoveable(true);
        totalColumn.setWidth(110);
        totalColumn.setText(Messages.getString("CarMtrlPurchaseReportListForm.totalColumn.text")); //$NON-NLS-1$
    }
	...
	bindColumn("carMtrlPurchaseRequestTitle");
	bindColumn("carServOrderTitle");
