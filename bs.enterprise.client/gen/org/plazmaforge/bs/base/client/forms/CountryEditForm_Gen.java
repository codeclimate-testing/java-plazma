...
public class CountryEditForm_Gen extends EditForm {


  public CountryEditForm_Gen() {
  }
  ...
  public void createUI() {
    ...
    setName("CountryEditForm");
    setType("EditForm");
    setTitle(getString("CountryEditForm.title"));
  ...
  public Composite createContent() {
    ...
    label1.setText(getString("CountryEditForm.codeLabel.text"));
    content.add(label1);
    ...
    label2.setText(getString("CountryEditForm.code3Label.text"));
    content.add(label2);
    ...
    label3.setText(getString("CountryEditForm.numericCodeLabel.text"));
    content.add(label3);
    ...
    label4.setText(getString("CountryEditForm.nameLabel.text"));
    content.add(label4);
