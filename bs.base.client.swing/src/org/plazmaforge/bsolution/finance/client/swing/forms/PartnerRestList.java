 ...
 * Date: 17.08.2004
 * Time: 8:14:31
 * $Id: PartnerRestList.java,v 1.3 2010/12/05 07:56:43 ohapon Exp $
 */
public class PartnerRestList extends AbstractFinanceDocumentList {

    public PartnerRestList() throws ApplicationException {
        super(GUIFinanceEnvironment.getResources());
        initialize();
    }

    public PartnerRestList(Window window) throws ApplicationException {
    ...
    private void initialize() {
        ...
        this.setEntityEditFormClass(PartnerRestEdit.class);
    }    
    ...
    protected List<ColumnProperty> createTableColumnProperties() throws ApplicationException {
        ...
        d.setName(getString("table.column-client.name"));
