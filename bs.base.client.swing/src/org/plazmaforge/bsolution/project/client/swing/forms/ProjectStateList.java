...
public class ProjectStateList extends EXTListForm {

    public ProjectStateList() throws ApplicationException {
        super(GUIProjectEnvironment.getResources());
        initialize();
    }

    public ProjectStateList(Window window) throws ApplicationException {
    ...
    private void initialize() {
        ...
        this.setEntityEditFormClass(ProjectStateEdit.class);
    }
    ...
    protected List<ColumnProperty> createTableColumnProperties() throws ApplicationException {
        ...
        d = new ColumnProperty();
        d.setName(getString("table.column-start.name"));
        d.setFieldName("start");
        d.setColumnClass(Boolean.class);
        d.setSize(20);
        columns.add(d);

        d = new ColumnProperty();
        d.setName(getString("table.column-finish.name"));
        d.setFieldName("finish");
        d.setColumnClass(Boolean.class);
        d.setSize(20);
        columns.add(d);
