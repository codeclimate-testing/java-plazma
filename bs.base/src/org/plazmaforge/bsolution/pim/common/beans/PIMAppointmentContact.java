...
public class PIMAppointmentContact extends BaseEntity {

    private PIMAppointmentHeader appointment;
    
    private ContactHeader contact;

    public PIMAppointmentHeader getAppointment() {
        return appointment;
    }

    public void setAppointment(PIMAppointmentHeader appointment) {
        this.appointment = appointment;
    }

    public String getAppointmentSubject() {
	return appointment == null ? null : appointment.getSubject();
    }
