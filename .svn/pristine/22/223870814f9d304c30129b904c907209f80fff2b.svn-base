...
/** 
 * @author Oleh Hapon
 * $Id: SaleOrderEditForm.java,v 1.7 2010/12/05 07:57:21 ohapon Exp $
 */

public class SaleOrderEditForm extends AbstractGoodsDocumentEditForm {
     ...
     * @param style
     */
    public SaleOrderEditForm(Composite parent, int style) {
	super(parent, style);
	initialize();
	...
	setTitle(Messages.getString("SaleOrderEditForm.title")); //$NON-NLS-1$
	setLayout(gridLayout);
    	...
    	generalTabItem.setText(Messages.getString("SaleOrderEditForm.generalTabItem.text")); //$NON-NLS-1$
    	...
    	documentNoLabel.setText(Messages.getString("SaleOrderEditForm.documentNoLabel.text")); //$NON-NLS-1$
	...
	documentDateLabel.setText(Messages.getString("SaleOrderEditForm.documentDateLabel.text")); //$NON-NLS-1$
	...
	documentStatusLabel.setText(Messages.getString("SaleOrderEditForm.documentStatusLabel.text")); //$NON-NLS-1$
	...
	gridData = new GridData(SWT.FILL, SWT.CENTER, false, false);
    	...
    	partnerLabel.setText(Messages.getString("SaleOrderEditForm.partnerLabel.text")); //$NON-NLS-1$
	...
	responsibleLabel.setText(Messages.getString("SaleOrderEditForm.responsibleLabel.text")); //$NON-NLS-1$
	...
	contractLabel.setText(Messages.getString("SaleOrderEditForm.contractLabel.text")); //$NON-NLS-1$
	...
	reasonDocumentLabel.setText(Messages.getString("SaleOrderEditForm.reasonDocumentLabel.text")); //$NON-NLS-1$
	...
	reasonLabel.setText(Messages.getString("SaleOrderEditForm.reasonLabel.text")); //$NON-NLS-1$
	...
	gridData = new GridData();
    	...
    	currencyLabel.setText(Messages.getString("SaleOrderEditForm.currencyLabel.text")); //$NON-NLS-1$
	...
	currencyRateLabel.setText(Messages.getString("SaleOrderEditForm.currencyRateLabel.text")); //$NON-NLS-1$
	...
	currencyRateDateLabel.setText(Messages.getString("SaleOrderEditForm.currencyRateDateLabel.text")); //$NON-NLS-1$
	...
	priceTypeLabel.setText(Messages.getString("SaleOrderEditForm.priceTypeLabel.text")); //$NON-NLS-1$
	...
	pricePercentLabel = new Label(composite, SWT.NONE);
    	...
    	pricePercentLabel.setText(Messages.getString("SaleOrderEditForm.pricePercentLabel.text")); //$NON-NLS-1$
	...
	warehouseLabel.setText(Messages.getString("SaleOrderEditForm.warehouseLabel.text")); //$NON-NLS-1$
	...
	mtrlResponsibleLabel.setText(Messages.getString("SaleOrderEditForm.mtrlResponsibleLabel.text")); //$NON-NLS-1$
	...
	gridData = new GridData(SWT.FILL, SWT.CENTER, false, false, 5, 1);
    	...
    	noteTabItem.setText(Messages.getString("SaleOrderEditForm.noteTabItem.text")); //$NON-NLS-1$
    	...
    	createItemPanel();
    	createSummaryPanel();
    	AttributeValueView attributeView = new AttributeValueView(itemsTabFolder, SaleOrder.class);
    	FileView fileView = new FileView(itemsTabFolder, SaleOrder.class);
    ...
    private void createItemPanel() {
        ...
        productTabItem.setText(Messages.getString("SaleOrderEditForm.productTabItem.text")); //$NON-NLS-1$
        ...
        productNameColumn.setText(Messages.getString("SaleOrderEditForm.productNameColumn.text")); //$NON-NLS-1$

        TableColumn unitNameColumn = new TableColumn(productTable, SWT.CENTER);
        unitNameColumn.setWidth(60);
        unitNameColumn.setText(Messages.getString("SaleOrderEditForm.unitNameColumn.text")); //$NON-NLS-1$

        TableColumn unitRateColumn = new TableColumn(productTable, SWT.RIGHT);
        unitRateColumn.setWidth(50);
        unitRateColumn.setText(Messages.getString("SaleOrderEditForm.unitRateColumn.text")); //$NON-NLS-1$

        TableColumn quantityColumn = new TableColumn(productTable, SWT.RIGHT);
        quantityColumn.setWidth(80);
        quantityColumn.setText(Messages.getString("SaleOrderEditForm.quantityColumn.text")); //$NON-NLS-1$
         
        TableColumn currencyBasePriceColumn = new TableColumn(productTable, SWT.RIGHT);
        currencyBasePriceColumn.setWidth(80);
        currencyBasePriceColumn.setText(Messages.getString("SaleOrderEditForm.currencyBasePriceColumn.text")); //$NON-NLS-1$

        TableColumn pricePercentColumn = new TableColumn(productTable, SWT.RIGHT);
        pricePercentColumn.setWidth(80);
        pricePercentColumn.setText(Messages.getString("SaleOrderEditForm.pricePercentColumn.text")); //$NON-NLS-1$

        
        TableColumn currencyPriceColumn = new TableColumn(productTable, SWT.RIGHT);
        currencyPriceColumn.setWidth(80);
        currencyPriceColumn.setText(Messages.getString("SaleOrderEditForm.currencyPriceColumn.text")); //$NON-NLS-1$
        
        TableColumn currencyAmountColumn = new TableColumn(productTable, SWT.RIGHT);
        currencyAmountColumn.setWidth(80);
        currencyAmountColumn.setText(Messages.getString("SaleOrderEditForm.currencyAmountColumn.text"));       //$NON-NLS-1$
        
        TableColumn currencyTaxAmountColumn = new TableColumn(productTable, SWT.RIGHT);
        currencyTaxAmountColumn.setWidth(80);
        currencyTaxAmountColumn.setText(Messages.getString("SaleOrderEditForm.currencyTaxAmountColumn.text"));         //$NON-NLS-1$
	...
	gridData = new GridData(SWT.FILL, SWT.CENTER, false, false);
    	...
    	currencyTotalLabel.setText(Messages.getString("SaleOrderEditForm.currencyTotalLabel.text")); //$NON-NLS-1$
	...
	gridData = new GridData();
    	...
    	currencyTaxTotalLabel.setText(Messages.getString("SaleOrderEditForm.currencyTaxTotalLabel.text")); //$NON-NLS-1$
	...
	gridData = new GridData();
    	...
    	currencyTotalWithTaxLabel.setText(Messages.getString("SaleOrderEditForm.currencyTotalWithTaxLabel.text")); //$NON-NLS-1$
	...
	public ProductItemProvider() {
	    setParentEntityClass(SaleOrder.class); // OWNER
	    setEntityClass(SaleOrderItem.class); // FORM ID
