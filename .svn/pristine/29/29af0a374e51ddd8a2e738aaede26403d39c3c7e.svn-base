...
/** 
 * @author Oleh Hapon
 * $Id: SaleInvoiceItemEditForm.java,v 1.3 2010/04/28 06:31:06 ohapon Exp $
 */

public class SaleInvoiceItemEditForm extends AbstractGoodsDocumentItemEditForm {
    ...
    public  SaleInvoiceItemEditForm(Composite parent, int style) {
	super(parent, style);
	initialize();
    }
	...
	goodsLabel.setText(Messages.getString("SaleInvoiceItemEditForm.goodsLabel.text")); //$NON-NLS-1$
	...
	gridData.widthHint = 300;
    	...
    	productFeatureLabel.setText(Messages.getString("SaleInvoiceItemEditForm.productFeatureLabel.text")); //$NON-NLS-1$
	...
	unitLabel = new Label(this, SWT.NONE);
    	unitLabel.setText(Messages.getString("SaleInvoiceItemEditForm.unitLabel.text")); //$NON-NLS-1$
    	...
    	currencyBasePriceLabel.setText(Messages.getString("SaleInvoiceItemEditForm.currencyBasePriceLabel.text")); //$NON-NLS-1$
	...
	unitRateLabel.setText(Messages.getString("SaleInvoiceItemEditForm.unitRateLabel.text")); //$NON-NLS-1$
	...
	unitRateField.setLayoutData(gridData);
    	...
    	pricePercentLabel.setText(Messages.getString("SaleInvoiceItemEditForm.pricePercentLabel.text")); //$NON-NLS-1$
	...
	quantityLabel.setText(Messages.getString("SaleInvoiceItemEditForm.quantityLabel.text")); //$NON-NLS-1$
	...
	currencyPriceLabel.setText(Messages.getString("SaleInvoiceItemEditForm.currencyPriceLabel.text")); //$NON-NLS-1$
	...
	currencyAmountLabel.setText(Messages.getString("SaleInvoiceItemEditForm.currencyAmountLabel.text")); //$NON-NLS-1$
	...
	taxLabel.setText(Messages.getString("SaleInvoiceItemEditForm.taxLabel.text")); //$NON-NLS-1$
	...
	currencyTaxAmountLabel.setText(Messages.getString("SaleInvoiceItemEditForm.currencyTaxAmountLabel.text")); //$NON-NLS-1$
