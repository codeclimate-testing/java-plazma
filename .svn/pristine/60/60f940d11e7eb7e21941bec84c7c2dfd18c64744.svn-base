 ...
 * Date: 04.10.2004
 * Time: 21:17:35
 * $Id: EmployeeCategoryService.java,v 1.2 2010/04/28 06:24:30 ohapon Exp $
 */
public interface EmployeeCategoryService extends EntityService<EmployeeCategory, Integer> {
