...
public class ProjectRoleListForm_Gen extends ListForm {


  public ProjectRoleListForm_Gen() {
  }
  ...
  public void createUI() {
    ...
    setName("ProjectRoleListForm");
    setType("ListForm");
    setTitle(getString("ProjectRoleListForm.title"));
  ...
  public Composite createContent() {
    ...
    column1.setText(getString("ProjectRoleListForm.nameColumn.text"));
    ...
    column2.setText(getString("ProjectRoleListForm.descriptionColumn.text"));
    ...
    column3.setText(getString("ProjectRoleListForm.codeColumn.text"));
