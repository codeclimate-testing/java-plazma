...
package org.plazmaforge.bsolution.pim.common.services;
...
public interface PIMContextService extends ContextService, EntityService<PIMContext, Integer> {

    PIMContext load() throws DAOException, FinderException;
