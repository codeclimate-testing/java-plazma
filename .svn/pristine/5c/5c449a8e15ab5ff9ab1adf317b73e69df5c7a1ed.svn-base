...
/** 
 * @author Oleh Hapon
 * $Id: StreetTypeEditForm.java,v 1.2 2010/04/28 06:31:04 ohapon Exp $
 */
public class StreetTypeEditForm extends AbstractEditForm {
     ...
     * @param style
     */
    public StreetTypeEditForm(Composite parent, int style) {
	super(parent, style);
	initialize();
	...
	setTitle(Messages.getString("StreetTypeEditForm.title")); //$NON-NLS-1$
	GridData gridData;
	...
	nameLabel.setText(Messages.getString("StreetTypeEditForm.nameLabel.text")); //$NON-NLS-1$
	...
	fullNameLabel.setText(Messages.getString("StreetTypeEditForm.fullNameLabel.text")); //$NON-NLS-1$
