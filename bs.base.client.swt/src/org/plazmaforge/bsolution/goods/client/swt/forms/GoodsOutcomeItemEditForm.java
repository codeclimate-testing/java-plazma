...
/** 
 * @author Oleh Hapon
 * $Id: GoodsOutcomeItemEditForm.java,v 1.3 2010/12/05 07:57:19 ohapon Exp $
 */

public class GoodsOutcomeItemEditForm extends AbstractGoodsDocumentItemEditForm {
    ...
    public  GoodsOutcomeItemEditForm(Composite parent, int style) {
	super(parent, style);
	initialize();
    }
	...
	goodsLabel.setText(Messages.getString("GoodsOutcomeItemEditForm.goodsLabel.text")); //$NON-NLS-1$
	...
	gridData.widthHint = 300;
    	...
    	productFeatureLabel.setText(Messages.getString("GoodsOutcomeItemEditForm.productFeatureLabel.text")); //$NON-NLS-1$
	...
	////
    	...
    	productInstanceLabel.setText(Messages.getString("GoodsOutcomeItemEditForm.productInstanceLabel.text")); //$NON-NLS-1$
	...
	unitLabel = new Label(this, SWT.NONE);
    	unitLabel.setText(Messages.getString("GoodsOutcomeItemEditForm.unitLabel.text")); //$NON-NLS-1$
	...
	unitRateLabel.setText(Messages.getString("GoodsOutcomeItemEditForm.unitRateLabel.text")); //$NON-NLS-1$
	...
	quantityLabel.setText(Messages.getString("GoodsOutcomeItemEditForm.quantityLabel.text")); //$NON-NLS-1$
	...
	currencyPriceLabel.setText(Messages.getString("GoodsOutcomeItemEditForm.currencyPriceLabel.text")); //$NON-NLS-1$
	...
	currencyAmountLabel.setText(Messages.getString("GoodsOutcomeItemEditForm.currencyAmountLabel.text")); //$NON-NLS-1$
	...
	taxLabel.setText(Messages.getString("GoodsOutcomeItemEditForm.taxLabel.text")); //$NON-NLS-1$
	...
	currencyTaxAmountLabel.setText(Messages.getString("GoodsOutcomeItemEditForm.currencyTaxAmountLabel.text")); //$NON-NLS-1$
