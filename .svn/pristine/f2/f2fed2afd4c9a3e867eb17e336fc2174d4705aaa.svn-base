...
/** 
 * @author Oleh Hapon
 * $Id: DatabaseHTMLExportDialog.java,v 1.11 2010/05/16 09:47:54 ohapon Exp $
 */

public class DatabaseHTMLExportDialog extends HTMLExportDialog {

    public DatabaseHTMLExportDialog(Shell parentShell) {
	super(parentShell);
    }
