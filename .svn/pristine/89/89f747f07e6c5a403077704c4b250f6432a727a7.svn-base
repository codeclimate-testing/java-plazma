 ...
 * Time: 13:23:23
 */
public class PhoneTypeList extends EXTListForm {

    public PhoneTypeList() throws ApplicationException {
        super(GUIContactEnvironment.getResources());
        initialize();
    }
        
    public PhoneTypeList(Window window) throws ApplicationException {
    ...
    private void initialize() {
        ...
        this.setEntityEditFormClass(PhoneTypeEdit.class);
