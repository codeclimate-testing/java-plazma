...
import org.plazmaforge.bsolution.goods.client.swing.forms.GoodsMoveEdit;
 ...
 * Date: 28.06.2004
 * Time: 20:02:18
 * $Id: GoodsMoveList.java,v 1.3 2010/12/05 07:56:43 ohapon Exp $
 */
public class GoodsMoveList extends AbstractFinanceDocumentList  {

    public GoodsMoveList() throws ApplicationException {
        super(GUIGoodsEnvironment.getResources());
        initialize();
    }

    public GoodsMoveList(Window window) throws ApplicationException {
    ...
    private void initialize() {
        ...
        this.setEntityEditFormClass(GoodsMoveEdit.class);
    }
    ...
    protected List<ColumnProperty> createTableColumnProperties() throws ApplicationException {
        ...
        d = new ColumnProperty();
        d.setName(getString("table.column-outcome-storable.name"));
        d.setFieldName("outcomeWarehouseName");
        d.setColumnClass(String.class);
        d.setSize(50);
        columns.add(d);

        d = new ColumnProperty();
        d.setName(getString("table.column-income-storable.name"));
        d.setFieldName("incomeWarehouseName");
        d.setColumnClass(String.class);
        d.setSize(50);
        columns.add(d);
