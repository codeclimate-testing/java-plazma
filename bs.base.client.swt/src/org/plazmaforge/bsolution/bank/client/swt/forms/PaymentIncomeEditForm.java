...
import org.plazmaforge.bsolution.sale.client.swt.forms.SaleInvoiceListForm;
...
/** 
 * @author Oleh Hapon
 * $Id: PaymentIncomeEditForm.java,v 1.11 2010/12/05 07:57:18 ohapon Exp $
 */

public class PaymentIncomeEditForm extends AbstractPaymentDocumentEditForm {
     ...
     * @param style
     */
    public PaymentIncomeEditForm(Composite parent, int style) {
	super(parent, style);
	initialize();
	...
	setTitle(Messages.getString("PaymentIncomeEditForm.title")); //$NON-NLS-1$
	...
	setLayout(new FillLayout());
    	...
    	generalTabItem.setText(Messages.getString("PaymentIncomeEditForm.generalTabItem.text")); //$NON-NLS-1$
    	...
    	documentNoLabel.setText(Messages.getString("PaymentIncomeEditForm.documentNoLabel.text")); //$NON-NLS-1$
    	...
    	documentDateLabel.setText(Messages.getString("PaymentIncomeEditForm.documentDateLabel.text")); //$NON-NLS-1$
    	...
    	organizationBankAccountLabel.setText(Messages.getString("PaymentIncomeEditForm.organizationBankAccountLabel.text")); //$NON-NLS-1$
    	...
    	partnerLabel.setText(Messages.getString("PaymentIncomeEditForm.partnerLabel.text")); //$NON-NLS-1$
	...
	partnerBankAccountLabel.setText(Messages.getString("PaymentIncomeEditForm.partnerBankAccountLabel.text")); //$NON-NLS-1$
	...
	partnerBankAccountField.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, false, false, 3, 1));
    	...
    	currencyAmountLabel.setText(Messages.getString("PaymentIncomeEditForm.currencyAmountLabel.text")); //$NON-NLS-1$
	...
	taxLabel.setLayoutData(new GridData(SWT.RIGHT, SWT.CENTER, false, false));
    	taxLabel.setText(Messages.getString("PaymentIncomeEditForm.taxLabel.text")); //$NON-NLS-1$
	...
	gridData = new GridData(SWT.FILL, SWT.CENTER, false, false);
    	...
    	currencyTaxAmountLabel.setText(Messages.getString("PaymentIncomeEditForm.currencyTaxAmountLabel.text")); //$NON-NLS-1$
    	...
    	paymentMissingLabel.setText(Messages.getString("PaymentIncomeEditForm.paymentMissingLabel.text")); //$NON-NLS-1$
    	...
    	paymentTypeLabel.setText(Messages.getString("PaymentIncomeEditForm.paymentTypeLabel.text")); //$NON-NLS-1$
    	...
    	paymentDateLabel.setText(Messages.getString("PaymentIncomeEditForm.paymentDateLabel.text")); //$NON-NLS-1$
    	...
    	taxPrintTypeLabel.setText(Messages.getString("PaymentIncomeEditForm.taxPrintTypeLabel.text")); //$NON-NLS-1$
    	...
    	responsibleLabel.setText(Messages.getString("PaymentIncomeEditForm.responsibleLabel.text")); //$NON-NLS-1$
	...
	if (isProjectInDocument()) {
	    ...
	    projectLabel.setText(Messages.getString("PaymentIncomeEditForm.projectLabel.text")); //$NON-NLS-1$
	...
	//
    	...
    	////
       	...
       	documentTabItem.setText(Messages.getString("PaymentIncomeEditForm.documentTabItem.text")); //$NON-NLS-1$
	...
	gridLayout.marginHeight = 0;
    	...
    	noteTabItem.setText(Messages.getString("PaymentIncomeEditForm.noteTabItem.text")); //$NON-NLS-1$
    ...
    private void createDocumentPanel(Composite parent) {
        ...
        productTabItem.setText(Messages.getString("PaymentIncomeEditForm.reasonDocumentTabItem.text")); //$NON-NLS-1$
        ...
        documentCodeColumn.setText(Messages.getString("PaymentIncomeEditForm.documentNoColumn.text")); //$NON-NLS-1$

        TableColumn documentDateColumn = new TableColumn(documentTable, SWT.NONE);
        documentDateColumn.setWidth(70);
        documentDateColumn.setText(Messages.getString("PaymentIncomeEditForm.documentDateColumn.text")); //$NON-NLS-1$

        TableColumn documentPartnerColumn = new TableColumn(documentTable, SWT.NONE);
        documentPartnerColumn.setWidth(200);
        documentPartnerColumn.setText(Messages.getString("PaymentIncomeEditForm.documentPartnerColumn.text")); //$NON-NLS-1$

        TableColumn documentAmountColumn = new TableColumn(documentTable, SWT.RIGHT);
        documentAmountColumn.setWidth(90);
        documentAmountColumn.setText(Messages.getString("PaymentIncomeEditForm.documentAmountColumn.text")); //$NON-NLS-1$
	...
	public DocumentItemProvider() {
	    setParentEntityClass(PaymentIncome.class); // OWNER
	...
	if (isInvoiceAndOrderReason()) {
		...
		return SaleInvoiceListForm.class;
