...
/** 
 * @author Oleh Hapon
 * $Id: AttributeService.java,v 1.4 2010/12/05 07:55:56 ohapon Exp $
 */

public interface AttributeService extends EntityService<Attribute, Integer> {

    public List<Attribute> findByEntity(IEntityConfig entity) throws DAOException;
    
    void removeByEntity(IEntityConfig entity) throws DAOException, RemoveException;
    
    List<Integer> findIdsByEntity(IEntityConfig entity) throws DAOException;
