...
/** 
 * @author Oleh Hapon
 * $Id: SaleInvoiceEditForm.java,v 1.8 2010/12/05 07:57:21 ohapon Exp $
 */

public class SaleInvoiceEditForm extends AbstractGoodsDocumentEditForm {
     ...
     * @param style
     */
    public SaleInvoiceEditForm(Composite parent, int style) {
	super(parent, style);
	initialize();
	...
	setTitle(Messages.getString("SaleInvoiceEditForm.title")); //$NON-NLS-1$
	setLayout(gridLayout);
    	...
    	generalTabItem.setText(Messages.getString("SaleInvoiceEditForm.generalTabItem.text")); //$NON-NLS-1$
    	...
    	documentNoLabel.setText(Messages.getString("SaleInvoiceEditForm.documentNoLabel.text")); //$NON-NLS-1$
	...
	documentDateLabel.setText(Messages.getString("SaleInvoiceEditForm.documentDateLabel.text")); //$NON-NLS-1$
	...
	documentStatusLabel.setText(Messages.getString("SaleInvoiceEditForm.documentStatusLabel.text")); //$NON-NLS-1$
	...
	gridData = new GridData(SWT.FILL, SWT.CENTER, false, false);
    	...
    	partnerLabel.setText(Messages.getString("SaleInvoiceEditForm.partnerLabel.text")); //$NON-NLS-1$
	...
	responsibleLabel.setText(Messages.getString("SaleInvoiceEditForm.responsibleLabel.text")); //$NON-NLS-1$
	...
	contractLabel.setText(Messages.getString("SaleInvoiceEditForm.contractLabel.text")); //$NON-NLS-1$
	...
	reasonDocumentLabel.setText(Messages.getString("SaleInvoiceEditForm.reasonDocumentLabel.text")); //$NON-NLS-1$
	...
	reasonLabel.setText(Messages.getString("SaleInvoiceEditForm.reasonLabel.text")); //$NON-NLS-1$
	...
	if (isProjectInDocument()) {
	    ...
	    projectLabel.setText(Messages.getString("SaleInvoiceEditForm.projectLabel.text")); //$NON-NLS-1$
	...
	gridData = new GridData();
    	...
    	currencyLabel.setText(Messages.getString("SaleInvoiceEditForm.currencyLabel.text")); //$NON-NLS-1$
	...
	currencyRateLabel.setText(Messages.getString("SaleInvoiceEditForm.currencyRateLabel.text")); //$NON-NLS-1$
	...
	currencyRateDateLabel.setText(Messages.getString("SaleInvoiceEditForm.currencyRateDateLabel.text")); //$NON-NLS-1$
	...
	priceTypeLabel.setText(Messages.getString("SaleInvoiceEditForm.priceTypeLabel.text")); //$NON-NLS-1$
	...
	pricePercentLabel = new Label(composite, SWT.NONE);
    	...
    	pricePercentLabel.setText(Messages.getString("SaleInvoiceEditForm.pricePercentLabel.text")); //$NON-NLS-1$
	...
	gridData = new GridData(SWT.FILL, SWT.CENTER, false, false);
    	...
    	noteTabItem.setText(Messages.getString("SaleInvoiceEditForm.noteTabItem.text")); //$NON-NLS-1$
    	...
    	createItemPanel();
    	createSummaryPanel();
    	AttributeValueView attributeView = new AttributeValueView(itemsTabFolder, SaleInvoice.class);
    	FileView fileView = new FileView(itemsTabFolder, SaleInvoice.class);
    ...
    private void createItemPanel() {
        ...
        productTabItem.setText(Messages.getString("SaleInvoiceEditForm.productTabItem.text")); //$NON-NLS-1$
        ...
        productNameColumn.setText(Messages.getString("SaleInvoiceEditForm.productNameColumn.text")); //$NON-NLS-1$

        TableColumn unitNameColumn = new TableColumn(productTable, SWT.CENTER);
        unitNameColumn.setWidth(60);
        unitNameColumn.setText(Messages.getString("SaleInvoiceEditForm.unitNameColumn.text")); //$NON-NLS-1$

        TableColumn unitRateColumn = new TableColumn(productTable, SWT.RIGHT);
        unitRateColumn.setWidth(50);
        unitRateColumn.setText(Messages.getString("SaleInvoiceEditForm.unitRateColumn.text")); //$NON-NLS-1$

        TableColumn quantityColumn = new TableColumn(productTable, SWT.RIGHT);
        quantityColumn.setWidth(80);
        quantityColumn.setText(Messages.getString("SaleInvoiceEditForm.quantityColumn.text")); //$NON-NLS-1$
         
        TableColumn currencyBasePriceColumn = new TableColumn(productTable, SWT.RIGHT);
        currencyBasePriceColumn.setWidth(80);
        currencyBasePriceColumn.setText(Messages.getString("SaleInvoiceEditForm.currencyBasePriceColumn.text")); //$NON-NLS-1$

        TableColumn pricePercentColumn = new TableColumn(productTable, SWT.RIGHT);
        pricePercentColumn.setWidth(80);
        pricePercentColumn.setText(Messages.getString("SaleInvoiceEditForm.pricePercentColumn.text")); //$NON-NLS-1$
        
        TableColumn currencyPriceColumn = new TableColumn(productTable, SWT.RIGHT);
        currencyPriceColumn.setWidth(80);
        currencyPriceColumn.setText(Messages.getString("SaleInvoiceEditForm.currencyPriceColumn.text")); //$NON-NLS-1$
        
        TableColumn currencyAmountColumn = new TableColumn(productTable, SWT.RIGHT);
        currencyAmountColumn.setWidth(80);
        currencyAmountColumn.setText(Messages.getString("SaleInvoiceEditForm.currencyAmountColumn.text"));       //$NON-NLS-1$
        
        TableColumn currencyTaxAmountColumn = new TableColumn(productTable, SWT.RIGHT);
        currencyTaxAmountColumn.setWidth(80);
        currencyTaxAmountColumn.setText(Messages.getString("SaleInvoiceEditForm.currencyTaxAmountColumn.text"));         //$NON-NLS-1$
	...
	gridData = new GridData(SWT.FILL, SWT.CENTER, false, false);
    	...
    	currencyTotalLabel.setText(Messages.getString("SaleInvoiceEditForm.currencyTotalLabel.text")); //$NON-NLS-1$
	...
	gridData = new GridData();
    	...
    	currencyTaxTotalLabel.setText(Messages.getString("SaleInvoiceEditForm.currencyTaxTotalLabel.text")); //$NON-NLS-1$
	...
	gridData = new GridData();
    	...
    	currencyTotalWithTaxLabel.setText(Messages.getString("SaleInvoiceEditForm.currencyTotalWithTaxLabel.text")); //$NON-NLS-1$
	...
	public ProductItemProvider() {
	    setParentEntityClass(SaleInvoice.class); // OWNER
	    setEntityClass(SaleInvoiceItem.class); // FORM ID
    ...
    private SaleInvoice getSaleInvoice() {
	return (SaleInvoice) getEntity();
    }

    protected void initData() throws ApplicationException {
	super.initData();
	getSaleInvoice().setPartner(EnterpriseEnvironment.getCustomer());
    }
