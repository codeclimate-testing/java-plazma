...
/** 
 * @author Oleh Hapon
 * $Id: GoodsIncomeItemEditForm.java,v 1.2 2010/04/28 06:31:00 ohapon Exp $
 */

public class GoodsIncomeItemEditForm extends AbstractGoodsDocumentItemEditForm {
    ...
    public  GoodsIncomeItemEditForm(Composite parent, int style) {
	super(parent, style);
	initialize();
    }
	...
	goodsLabel.setText(Messages.getString("GoodsIncomeItemEditForm.goodsLabel.text")); //$NON-NLS-1$
	...
	gridData.widthHint = 300;
    	...
    	productFeatureLabel.setText(Messages.getString("GoodsIncomeItemEditForm.productFeatureLabel.text")); //$NON-NLS-1$
	...
	unitLabel = new Label(this, SWT.NONE);
    	unitLabel.setText(Messages.getString("GoodsIncomeItemEditForm.unitLabel.text")); //$NON-NLS-1$
	...
	unitRateLabel.setText(Messages.getString("GoodsIncomeItemEditForm.unitRateLabel.text")); //$NON-NLS-1$
	...
	quantityLabel.setText(Messages.getString("GoodsIncomeItemEditForm.quantityLabel.text")); //$NON-NLS-1$
	...
	currencyPriceLabel.setText(Messages.getString("GoodsIncomeItemEditForm.currencyPriceLabel.text")); //$NON-NLS-1$
	...
	currencyAmountLabel.setText(Messages.getString("GoodsIncomeItemEditForm.currencyAmountLabel.text")); //$NON-NLS-1$
	...
	taxLabel.setText(Messages.getString("GoodsIncomeItemEditForm.taxLabel.text")); //$NON-NLS-1$
	...
	currencyTaxAmountLabel.setText(Messages.getString("GoodsIncomeItemEditForm.currencyTaxAmountLabel.text")); //$NON-NLS-1$
