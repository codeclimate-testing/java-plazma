...
/**
 * @author Oleh Hapon Date: 15.11.2004 Time: 9:13:42 $Id: ExitAction.java,v 1.3 2010/12/05 07:56:42 ohapon Exp $
 */
public class ExitAction extends GUIBaseAction {

    public void perform(ActionEvent e) throws ApplicationException {
	SwingEnvironment.exit();
    }
}
