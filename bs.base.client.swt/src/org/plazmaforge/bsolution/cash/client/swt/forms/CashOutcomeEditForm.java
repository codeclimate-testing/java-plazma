...
/** 
 * @author Oleh Hapon
 * $Id: CashOutcomeEditForm.java,v 1.5 2010/12/05 07:57:22 ohapon Exp $
 */

public class CashOutcomeEditForm extends AbstractFinanceDocumentEditForm {
     ...
     * @param style
     */
    public CashOutcomeEditForm(Composite parent, int style) {
	super(parent, style);
	initialize();
	...
	GridData gridData;
	setTitle(Messages.getString("CashOutcomeEditForm.title")); //$NON-NLS-1$
	setLayout(new FillLayout());
    	...
    	generalTabItem.setText(Messages.getString("CashOutcomeEditForm.generalTabItem.text")); //$NON-NLS-1$
    	...
    	documentNoLabel.setText(Messages.getString("CashOutcomeEditForm.documentNoLabel.text")); //$NON-NLS-1$
    	...
    	documentDateLabel.setText(Messages.getString("CashOutcomeEditForm.documentDateLabel.text")); //$NON-NLS-1$
    	...
    	contractorLabel.setText(Messages.getString("CashOutcomeEditForm.contractorLabel.text")); //$NON-NLS-1$
    	...
    	currencyAmountLabel.setText(Messages.getString("CashOutcomeEditForm.currencyAmountLabel.text")); //$NON-NLS-1$
	...
	taxLabel.setLayoutData(new GridData(SWT.RIGHT, SWT.CENTER, false, false));
    	taxLabel.setText(Messages.getString("CashOutcomeEditForm.taxLabel.text")); //$NON-NLS-1$
	...
	gridData = new GridData(SWT.FILL, SWT.CENTER, false, false);
    	...
    	currencyTaxAmountLabel.setText(Messages.getString("CashOutcomeEditForm.currencyTaxAmountLabel.text")); //$NON-NLS-1$
    	...
    	paymentMissingLabel.setText(Messages.getString("CashOutcomeEditForm.paymentMissingLabel.text")); //$NON-NLS-1$
	...
	responsibleLabel = new Label(composite, SWT.NONE);
    	responsibleLabel.setText(Messages.getString("CashOutcomeEditForm.responsibleLabel.text")); //$NON-NLS-1$
    	...
    	noteTabItem.setText(Messages.getString("CashOutcomeEditForm.noteTabItem.text")); //$NON-NLS-1$
