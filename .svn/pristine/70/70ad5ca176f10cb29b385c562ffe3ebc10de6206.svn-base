...
/** 
 * @author Oleh Hapon
 * $Id: GoodsOutcomeListForm.java,v 1.6 2010/12/05 07:57:19 ohapon Exp $
 */

public class GoodsOutcomeListForm extends AbstractFinanceDocumentListForm {
    ...
    public GoodsOutcomeListForm(Composite parent, int style) {
	super(parent, style);
	initialize();
    }
	...
	setTitle(Messages.getString("GoodsOutcomeListForm.title")); //$NON-NLS-1$
        ...
        documentNoColumn.setText(Messages.getString("GoodsOutcomeListForm.documentNoColumn.text")); //$NON-NLS-1$

        documentDateColumn = new TableColumn(table, SWT.NONE);
        documentDateColumn.setMoveable(true);
        documentDateColumn.setWidth(100);
        documentDateColumn.setText(Messages.getString("GoodsOutcomeListForm.documentDateColumn.text")); //$NON-NLS-1$

        partnerColumn = new TableColumn(table, SWT.NONE);
        partnerColumn.setMoveable(true);
        partnerColumn.setWidth(200);
        partnerColumn.setText(Messages.getString("GoodsOutcomeListForm.partnerColumn.text")); //$NON-NLS-1$
    	
        warehouseColumn = new TableColumn(table, SWT.NONE);
        warehouseColumn.setMoveable(true);
        warehouseColumn.setWidth(100);
        warehouseColumn.setText(Messages.getString("GoodsOutcomeListForm.warehouseColumn.text")); //$NON-NLS-1$
        ...
        mtrlResponsibleColumn.setText(Messages.getString("GoodsOutcomeListForm.mtrlResponsibleColumn.text")); //$NON-NLS-1$
    	
        currencyTotalColumn = new TableColumn(table, SWT.RIGHT);
        currencyTotalColumn.setMoveable(true);
        currencyTotalColumn.setWidth(120);
        currencyTotalColumn.setText(Messages.getString("GoodsOutcomeListForm.currencyTotalColumn.text"));    	 //$NON-NLS-1$
    	
        currencyColumn = new TableColumn(table, SWT.CENTER);
        currencyColumn.setMoveable(true);
        currencyColumn.setWidth(70);
        currencyColumn.setText(Messages.getString("GoodsOutcomeListForm.currencyColumn.text")); //$NON-NLS-1$
        
        totalColumn = new TableColumn(table, SWT.RIGHT);
        totalColumn.setMoveable(true);
        totalColumn.setWidth(120);
        totalColumn.setText(Messages.getString("GoodsOutcomeListForm.totalColumn.text")); //$NON-NLS-1$
    }
