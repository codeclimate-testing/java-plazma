 ...
 * Date: 19.09.2004
 * Time: 12:21:18
 * $Id: PersonDocumentTypeList.java,v 1.3 2010/12/05 07:56:44 ohapon Exp $
 */
public class PersonDocumentTypeList extends EXTListForm {

    public PersonDocumentTypeList() throws ApplicationException {
        super(GUIPersonalityEnvironment.getResources());
        initialize();
    }

    public PersonDocumentTypeList(Window window) throws ApplicationException {
    ...
    private void initialize() {
        ...
        this.setEntityEditFormClass(PersonDocumentTypeEdit.class);
    }
