...
public class TemplateEntryList extends EXTListForm {

    public TemplateEntryList() throws ApplicationException {
	super(GUIFinanceEnvironment.getResources());
	initialize();
    }

    public TemplateEntryList(Window window) throws ApplicationException {
	...
	this.setEntityEditFormClass(TemplateEntryEdit.class);
    }
	...
	d.setName(getString("table.column-document-type.name"));
	d.setFieldName("financeDocumentTypeName");
	d.setColumnClass(String.class);
	d.setSize(50);
	columns.add(d);
