...
public class ProjectStageGroupList extends EXTListForm {

    public ProjectStageGroupList() throws ApplicationException {
	super(GUIProjectEnvironment.getResources());
	initialize();
    }

    public ProjectStageGroupList(Window window) throws ApplicationException {
	...
	this.setEntityEditFormClass(ProjectStageGroupEdit.class);
    }
