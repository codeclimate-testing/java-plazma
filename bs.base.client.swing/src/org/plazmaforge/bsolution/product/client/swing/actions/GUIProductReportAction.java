 ...
 * Date: 09.07.2004
 * Time: 22:59:23
 * $Id: GUIProductReportAction.java,v 1.2 2010/04/28 06:28:14 ohapon Exp $
 */
public abstract class GUIProductReportAction extends AbstractSwingReportAction {

    public GUIProductReportAction(Resources resources) {
         super(resources == null ? GUIProductEnvironment.getResources() : resources);
    }

    public GUIProductReportAction() {
