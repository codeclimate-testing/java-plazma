...
/**
 * @author Oleh Hapon Date: 05.05.2004 Time: 16:59:10 $Id: CurrencyListAction.java,v 1.3 2010/12/05 07:56:42 ohapon Exp $
 */
public class CurrencyListAction extends GUIBaseAction {

    public void perform(ActionEvent e) throws ApplicationException {
	SwingFormManager.showListForm(CurrencyList.class);
    }
