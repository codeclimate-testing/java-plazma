...
/** 
 * @author Oleh Hapon
 * $Id: InventoryIncomeListForm.java,v 1.6 2010/12/05 07:57:21 ohapon Exp $
 */

public class InventoryIncomeListForm extends AbstractFinanceDocumentListForm {
    ...
    public InventoryIncomeListForm(Composite parent, int style) {
	super(parent, style);
	initialize();
    }
	...
	setTitle(Messages.getString("InventoryIncomeListForm.title")); //$NON-NLS-1$
        ...
        documentNoColumn.setText(Messages.getString("InventoryIncomeListForm.documentNoColumn.text")); //$NON-NLS-1$

        documentDateColumn = new TableColumn(table, SWT.NONE);
        documentDateColumn.setMoveable(true);
        documentDateColumn.setWidth(100);
        documentDateColumn.setText(Messages.getString("InventoryIncomeListForm.documentDateColumn.text")); //$NON-NLS-1$

        partnerColumn = new TableColumn(table, SWT.NONE);
        partnerColumn.setMoveable(true);
        partnerColumn.setWidth(200);
        partnerColumn.setText(Messages.getString("InventoryIncomeListForm.partnerColumn.text")); //$NON-NLS-1$
    	
        warehouseColumn = new TableColumn(table, SWT.NONE);
        warehouseColumn.setMoveable(true);
        warehouseColumn.setWidth(100);
        warehouseColumn.setText(Messages.getString("InventoryIncomeListForm.warehouseColumn.text")); //$NON-NLS-1$
        ...
        mtrlResponsibleColumn.setText(Messages.getString("InventoryIncomeListForm.mtrlResponsibleColumn.text")); //$NON-NLS-1$
    	
        currencyTotalColumn = new TableColumn(table, SWT.RIGHT);
        currencyTotalColumn.setMoveable(true);
        currencyTotalColumn.setWidth(120);
        currencyTotalColumn.setText(Messages.getString("InventoryIncomeListForm.currencyTotalColumn.text"));    	 //$NON-NLS-1$
    	
        currencyColumn = new TableColumn(table, SWT.CENTER);
        currencyColumn.setMoveable(true);
        currencyColumn.setWidth(70);
        currencyColumn.setText(Messages.getString("InventoryIncomeListForm.currencyColumn.text")); //$NON-NLS-1$
        
        totalColumn = new TableColumn(table, SWT.RIGHT);
        totalColumn.setMoveable(true);
        totalColumn.setWidth(120);
        totalColumn.setText(Messages.getString("InventoryIncomeListForm.totalColumn.text")); //$NON-NLS-1$
    }
