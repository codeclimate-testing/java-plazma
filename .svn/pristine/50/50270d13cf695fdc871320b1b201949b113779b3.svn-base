...
/** 
 * @author Oleh Hapon
 * $Id: DatabaseCSVExportDialog.java,v 1.11 2010/05/16 09:47:54 ohapon Exp $
 */

public class DatabaseCSVExportDialog extends CSVExportDialog {

    public DatabaseCSVExportDialog(Shell parentShell) {
	super(parentShell);
    }
