...
import org.plazmaforge.bsolution.base.client.swing.forms.TaxList;
import org.plazmaforge.framework.client.swing.SwingFormManager;
import org.plazmaforge.framework.core.exception.ApplicationException;


public class TaxListAction extends GUIBaseAction {

    public void perform(ActionEvent e) throws ApplicationException {
	SwingFormManager.showListForm(TaxList.class);
    }
