...
public class TaxWaybillList extends AbstractFinanceDocumentList {

    public TaxWaybillList() throws ApplicationException {
        super(GUIGoodsEnvironment.getResources());
        initialize();
    }

    public TaxWaybillList(Window window) throws ApplicationException {
    ...
    private void initialize() {
        ...
        this.setEntityEditFormClass(TaxWaybillEdit.class);
    }
