...
/** 
 * @author Oleh Hapon
 * $Id: EnumerationListForm.java,v 1.3 2010/12/05 07:57:20 ohapon Exp $
 */

public class EnumerationListForm extends AbstractListForm {
    ...
    public EnumerationListForm(Composite parent, int style) {
	super(parent, style);
	initialize();
    }
	...
	setTitle(Messages.getString("EnumerationListForm.title")); // Don't change this title //$NON-NLS-1$
    	...
    	codeColumn.setText(Messages.getString("EnumerationListForm.codeColumn.text")); //$NON-NLS-1$

    	nameColumn = new TableColumn(table, SWT.NONE);
    	nameColumn.setMoveable(true);
    	nameColumn.setWidth(300);
    	nameColumn.setText(Messages.getString("EnumerationListForm.nameColumn.text")); //$NON-NLS-1$
	...
	IEntityConfig entity = getEntityConfig();
	if (entity == null) {
	    throw new ApplicationException("Enumeration type is null");
	}
	return ((EnumerationService) getEntityService()).findByEntity(entity);
    }
