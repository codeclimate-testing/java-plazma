...
public class CarMtrlFindRequestListForm extends AbstractFinanceDocumentListForm {
    ...
    public CarMtrlFindRequestListForm(Composite parent, int style) {
	super(parent, style);
	initialize();
    }
	...
	setTitle(Messages.getString("CarMtrlFindRequestListForm.title")); //$NON-NLS-1$
        ...
        documentNoColumn.setText(Messages.getString("CarMtrlFindRequestListForm.documentNoColumn.text")); //$NON-NLS-1$

        documentDateColumn = new TableColumn(table, SWT.NONE);
        documentDateColumn.setMoveable(true);
        documentDateColumn.setWidth(70);
        documentDateColumn.setText(Messages.getString("CarMtrlFindRequestListForm.documentDateColumn.text")); //$NON-NLS-1$

        carServOrderColumn = new TableColumn(table, SWT.NONE);
        carServOrderColumn.setMoveable(true);
        carServOrderColumn.setWidth(200);
        carServOrderColumn.setText(Messages.getString("CarMtrlFindRequestListForm.carServOrderColumn.text")); //$NON-NLS-1$
    	
    	
        employeeColumn = new TableColumn(table, SWT.NONE);
        employeeColumn.setMoveable(true);
        employeeColumn.setWidth(200);
        employeeColumn.setText(Messages.getString("CarMtrlFindRequestListForm.employeeColumn.text")); //$NON-NLS-1$
    	
        currencyTotalColumn = new TableColumn(table, SWT.RIGHT);
        currencyTotalColumn.setMoveable(true);
        currencyTotalColumn.setWidth(110);
        currencyTotalColumn.setText(Messages.getString("CarMtrlFindRequestListForm.currencyTotalColumn.text"));    	 //$NON-NLS-1$
    	
        currencyColumn = new TableColumn(table, SWT.CENTER);
        currencyColumn.setMoveable(true);
        currencyColumn.setWidth(70);
        currencyColumn.setText(Messages.getString("CarMtrlFindRequestListForm.currencyColumn.text")); //$NON-NLS-1$
        
        totalColumn = new TableColumn(table, SWT.RIGHT);
        totalColumn.setMoveable(true);
        totalColumn.setWidth(110);
        totalColumn.setText(Messages.getString("CarMtrlFindRequestListForm.totalColumn.text")); //$NON-NLS-1$
    }
