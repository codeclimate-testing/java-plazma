...
/** 
 * @author Oleh Hapon
 * $Id: GoodsOutcomeEditForm.java,v 1.7 2010/12/05 07:57:19 ohapon Exp $
 */

public class GoodsOutcomeEditForm extends AbstractGoodsDocumentEditForm {
     ...
     * @param style
     */
    public GoodsOutcomeEditForm(Composite parent, int style) {
	super(parent, style);
	initialize();
	...
	setTitle(Messages.getString("GoodsOutcomeEditForm.title")); //$NON-NLS-1$
	setLayout(gridLayout);
    	...
    	generalTabItem.setText(Messages.getString("GoodsOutcomeEditForm.generalTabItem.text")); //$NON-NLS-1$
    	...
    	documentNoLabel.setText(Messages.getString("GoodsOutcomeEditForm.documentNoLabel.text")); //$NON-NLS-1$
	...
	documentDateLabel.setText(Messages.getString("GoodsOutcomeEditForm.documentDateLabel.text")); //$NON-NLS-1$
	...
	gridData = new GridData(SWT.FILL, SWT.CENTER, false, false);
    	...
    	partnerLabel.setText(Messages.getString("GoodsOutcomeEditForm.partnerLabel.text")); //$NON-NLS-1$
	...
	warehouseLabel.setText(Messages.getString("GoodsOutcomeEditForm.warehouseLabel.text")); //$NON-NLS-1$
	...
	mtrlResponsibleLabel.setText(Messages.getString("GoodsOutcomeEditForm.mtrlResponsibleLabel.text")); //$NON-NLS-1$
	...
	contractLabel.setText(Messages.getString("GoodsOutcomeEditForm.contractLabel.text")); //$NON-NLS-1$
	...
	reasonDocumentLabel.setText(Messages.getString("GoodsOutcomeEditForm.reasonDocumentLabel.text")); //$NON-NLS-1$
	...
	reasonLabel.setText(Messages.getString("GoodsOutcomeEditForm.reasonLabel.text")); //$NON-NLS-1$
	...
	gridData = new GridData();
    	...
    	currencyLabel.setText(Messages.getString("GoodsOutcomeEditForm.currencyLabel.text")); //$NON-NLS-1$
	...
	currencyRateLabel.setText(Messages.getString("GoodsOutcomeEditForm.currencyRateLabel.text")); //$NON-NLS-1$
	...
	currencyRateDateLabel.setText(Messages.getString("GoodsOutcomeEditForm.currencyRateDateLabel.text")); //$NON-NLS-1$
	...
	gridData = new GridData(SWT.FILL, SWT.CENTER, false, false);
    	...
    	noteTabItem.setText(Messages.getString("GoodsOutcomeEditForm.noteTabItem.text")); //$NON-NLS-1$
    	...
    	createSummaryPanel();
    	AttributeValueView attributeView = new AttributeValueView(itemsTabFolder, GoodsOutcome.class);
    ...
    private void createItemPanel() {
        ...
        productTabItem.setText(Messages.getString("GoodsOutcomeEditForm.productTabItem.text")); //$NON-NLS-1$
        ...
        productNameColumn.setText(Messages.getString("GoodsOutcomeEditForm.productNameColumn.text")); //$NON-NLS-1$

        TableColumn unitNameColumn = new TableColumn(productTable, SWT.CENTER);
        unitNameColumn.setWidth(60);
        unitNameColumn.setText(Messages.getString("GoodsOutcomeEditForm.unitNameColumn.text")); //$NON-NLS-1$

        TableColumn unitRateColumn = new TableColumn(productTable, SWT.RIGHT);
        unitRateColumn.setWidth(50);
        unitRateColumn.setText(Messages.getString("GoodsOutcomeEditForm.unitRateColumn.text")); //$NON-NLS-1$

        TableColumn quantityColumn = new TableColumn(productTable, SWT.RIGHT);
        quantityColumn.setWidth(80);
        quantityColumn.setText(Messages.getString("GoodsOutcomeEditForm.quantityColumn.text")); //$NON-NLS-1$
         
        TableColumn currencyPriceColumn = new TableColumn(productTable, SWT.RIGHT);
        currencyPriceColumn.setWidth(80);
        currencyPriceColumn.setText(Messages.getString("GoodsOutcomeEditForm.currencyPriceColumn.text")); //$NON-NLS-1$
        
        TableColumn currencyAmountColumn = new TableColumn(productTable, SWT.RIGHT);
        currencyAmountColumn.setWidth(80);
        currencyAmountColumn.setText(Messages.getString("GoodsOutcomeEditForm.currencyAmountColumn.text"));       //$NON-NLS-1$
        
        TableColumn currencyTaxAmountColumn = new TableColumn(productTable, SWT.RIGHT);
        currencyTaxAmountColumn.setWidth(80);
        currencyTaxAmountColumn.setText(Messages.getString("GoodsOutcomeEditForm.currencyTaxAmountColumn.text"));         //$NON-NLS-1$
	...
	gridData = new GridData(SWT.FILL, SWT.CENTER, false, false);
    	...
    	currencyTotalLabel.setText(Messages.getString("GoodsOutcomeEditForm.currencyTotalLabel.text")); //$NON-NLS-1$
	...
	gridData = new GridData();
    	...
    	currencyTaxTotalLabel.setText(Messages.getString("GoodsOutcomeEditForm.currencyTaxTotalLabel.text")); //$NON-NLS-1$
	...
	gridData = new GridData();
    	...
    	currencyTotalWithTaxLabel.setText(Messages.getString("GoodsOutcomeEditForm.currencyTotalWithTaxLabel.text")); //$NON-NLS-1$
	...
	public ProductItemProvider() {
	    setParentEntityClass(GoodsOutcome.class); // OWNER
	    setEntityClass(GoodsOutcomeItem.class); // FORM ID
