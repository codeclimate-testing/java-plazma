...
public class TaskRoleList extends EXTListForm {

    public TaskRoleList() throws ApplicationException {
        super(GUIProjectEnvironment.getResources());
        initialize();
    }

    public TaskRoleList(Window window) throws ApplicationException {
    ...
    private void initialize() {
        ...
        this.setEntityEditFormClass(TaskRoleEdit.class);
    }
