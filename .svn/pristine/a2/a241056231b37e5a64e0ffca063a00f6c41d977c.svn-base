...
public class AddressTypeListForm_Gen extends ListForm {


  public AddressTypeListForm_Gen() {
  }
  ...
  public void createUI() {
    ...
    setName("AddressTypeListForm");
    setType("ListForm");
    setTitle(getString("AddressTypeListForm.title"));
  ...
  public Composite createContent() {
    ...
    column1.setText(getString("AddressTypeListForm.codeColumn.text"));
    ...
    column2.setText(getString("AddressTypeListForm.nameColumn.text"));
