 ...
 * Date: 29.02.2004
 * Time: 20:21:14
 * $Id: EditFormAction.java,v 1.2 2010/04/28 06:36:11 ohapon Exp $
 */
public abstract class EditFormAction extends ResourceAction {

    protected EditForm editForm;

    public EditFormAction(EditForm editForm, Resources resources) {
        super(resources);
        if (editForm == null) {
            throw new IllegalArgumentException("EditForm is null");
        }
