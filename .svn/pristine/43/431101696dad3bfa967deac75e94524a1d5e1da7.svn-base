...
import org.plazmaforge.bsolution.goods.client.swing.forms.GoodsRestEdit;
 ...
 * Date: 09.05.2004
 * Time: 14:53:04
 * $Id: GoodsRestList.java,v 1.3 2010/12/05 07:56:43 ohapon Exp $
 */
public class GoodsRestList extends AbstractFinanceDocumentList {

    public GoodsRestList() throws ApplicationException {
        super(GUIGoodsEnvironment.getResources());
        initialize();
    }

    public GoodsRestList(Window window) throws ApplicationException {
    ...
    private void initialize() {
        ...
        this.setEntityEditFormClass(GoodsRestEdit.class);
    }
