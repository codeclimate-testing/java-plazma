...
/** 
 * @author Oleh Hapon
 * $Id: PurchasePlanListForm.java,v 1.6 2010/12/05 07:57:18 ohapon Exp $
 */

public class PurchasePlanListForm extends AbstractFinanceDocumentListForm {
    ...
    public PurchasePlanListForm(Composite parent, int style) {
	super(parent, style);
	initialize();
    }
	...
	setTitle(Messages.getString("PurchasePlanListForm.title")); //$NON-NLS-1$
