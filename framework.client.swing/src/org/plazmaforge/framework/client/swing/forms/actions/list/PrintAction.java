 ...
 * Date: 26.02.2004
 * Time: 9:49:58
 * $Id: PrintAction.java,v 1.3 2010/12/05 07:52:08 ohapon Exp $
 */
public class PrintAction  extends ListFormAction {

    public PrintAction(ListForm listForm, Resources resources) {
        super(listForm, resources);
    }

    public void perform(ActionEvent evt) throws ApplicationException {
        listForm.doPrintCommand();
    }
