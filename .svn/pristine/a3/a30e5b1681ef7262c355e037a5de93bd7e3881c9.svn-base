 ...
 * Date: 19.09.2004
 * Time: 12:20:55
 * $Id: MilitarySpecialityList.java,v 1.3 2010/12/05 07:56:44 ohapon Exp $
 */
public class MilitarySpecialityList extends EXTListForm {

    public MilitarySpecialityList() throws ApplicationException {
        super(GUIPersonalityEnvironment.getResources());
        initialize();
    }

    public MilitarySpecialityList(Window window) throws ApplicationException {
    ...
    private void initialize() {
        ...
        this.setEntityEditFormClass(MilitarySpecialityEdit.class);
    }
