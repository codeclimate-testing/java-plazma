 ...
 * Time: 13:23:23
 */
public class StreetTypeList extends EXTListForm {

    public StreetTypeList() throws ApplicationException {
        super(GUIContactEnvironment.getResources());
        initialize();
    }

    public StreetTypeList(Window window) throws ApplicationException {
    ...
    private void initialize() {
        ...
        this.setEntityEditFormClass(StreetTypeEdit.class);
    }
