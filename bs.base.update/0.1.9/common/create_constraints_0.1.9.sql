...
alter table DOCUMENT_ATTR
   add constraint FK_DOCUMENT_DA_DAG_DOCUMENT foreign key (ATTR_GROUP_ID)
      references DOCUMENT_ATTR_GROUP (ID);

alter table DOCUMENT_ATTR
   add constraint FK_DOCUMENT_DA_DOCT_DOCUMENT foreign key (DOCUMENT_TYPE_ID)
      references DOCUMENT_TYPE (ID);

alter table DOCUMENT_ATTR
   add constraint FK_DOCUMENT_DA_DT_DATA_TYP foreign key (DATA_TYPE_ID)
      references DATA_TYPE (ID);

alter table DOCUMENT_ATTR_GROUP
   add constraint FK_DOCUMENT_DAG_DT_DOCUMENT foreign key (DOCUMENT_TYPE_ID)
      references DOCUMENT_TYPE (ID);

alter table DOCUMENT_ATTR_VALUE
   add constraint FK_DOCUMENT_DAV_DA_DOCUMENT foreign key (ATTR_ID)
      references DOCUMENT_ATTR (ID);

alter table DOCUMENT_ATTR_VALUE
   add constraint FK_DOCUMENT_DAV_DT_DOCUMENT foreign key (DOCUMENT_TYPE_ID)
      references DOCUMENT_TYPE (ID);

alter table DOCUMENT_ATTR_VALUE
   add constraint FK_DOCUMENT_DOC_AV_DO_DOCUMENT foreign key (DOCUMENT_ID)
      references DOCUMENT (ID);
...
alter table SYS_ATTR
   add constraint FK_SYS_ATTR_SA_DAT_TY_DATA_TYP foreign key (DATA_TYPE_ID)
      references DATA_TYPE (ID);

alter table SYS_ATTR
   add constraint FK_SYS_ATTR_SA_SAG_SYS_ATTR foreign key (ATTR_GROUP_ID)
      references SYS_ATTR_GROUP (ID);

alter table SYS_ATTR
   add constraint FK_SYS_ATTR_SA_SE_SYS_ENTI foreign key (ENTITY_ID)
      references SYS_ENTITY (ID);

alter table SYS_ATTR_GROUP
   add constraint FK_SYS_ATTR_SAG_SE_SYS_ENTI foreign key (ENTITY_ID)
      references SYS_ENTITY (ID);

alter table SYS_ATTR_VALUE
   add constraint FK_SYS_ATTR_SAV_SA_SYS_ATTR foreign key (ATTR_ID)
      references SYS_ATTR (ID);

alter table SYS_ATTR_VALUE
   add constraint FK_SYS_ATTR_SAV_SE_SYS_ENTI foreign key (ENTITY_ID)
      references SYS_ENTITY (ID);
...
alter table SYS_INFO
   add constraint FK_SYS_INFO_SI_BRANCH_BRANCH foreign key (BRANCH_ID)
      references BRANCH (ID);

alter table SYS_INFO
   add constraint FK_SYS_INFO_SI_CST_PARTNER foreign key (CUSTOMER_ID)
      references PARTNER (ID);

alter table SYS_INFO
   add constraint FK_SYS_INFO_SI_EMP_EMPLOYEE foreign key (RESPONSIBLE_ID)
      references EMPLOYEE (ID);

alter table SYS_INFO
   add constraint FK_SYS_INFO_SI_IWRH_WAREHOUS foreign key (INCOME_WAREHOUSE_ID)
      references WAREHOUSE (ID);

alter table SYS_INFO
   add constraint FK_SYS_INFO_SI_OWRH_WAREHOUS foreign key (OUTCOME_WAREHOUSE_ID)
      references WAREHOUSE (ID);

alter table SYS_INFO
   add constraint FK_SYS_INFO_SI_PRT_PARTNER foreign key (PARTNER_ID)
      references PARTNER (ID);

alter table SYS_INFO
   add constraint FK_SYS_INFO_SI_RSP_RESPONSI foreign key (MATERIAL_RESPONSIBLE_ID)
      references RESPONSIBLE (ID);

alter table SYS_INFO
   add constraint FK_SYS_INFO_SI_SPP_PARTNER foreign key (SUPPLIER_ID)
      references PARTNER (ID);

alter table SYS_INFO
   add constraint FK_SYS_INFO_SI_WRH_WAREHOUS foreign key (WAREHOUSE_ID)
      references WAREHOUSE (ID);

alter table SYS_INFO
   add constraint FK_SYS_INFO_SYS_CURRE_CURRENCY foreign key (CURRENCY_ID)
      references CURRENCY (ID);
...
alter table SYS_INFO
   add constraint FK_SYS_INFO_SYS_PERIO_PERIOD foreign key (PERIOD_ID)
      references PERIOD (ID);

alter table SYS_INFO
   add constraint FK_SYS_INFO_SYS_TAX_TAX foreign key (TAX_ID)
      references TAX (ID);

alter table SYS_INFO
   add constraint FK_SYS_INFO_SYS_UNIT_UNIT foreign key (UNIT_ID)
      references UNIT (ID);
...
alter table SYS_REFERENCE
   add constraint FK_SYS_REFE_REF_ENTIT_SYS_ENTI foreign key (ENTITY_ID)
      references SYS_ENTITY (ID);

alter table SYS_ROLE_UI
...
alter table SYS_VARIABLE
   add constraint FK_SYS_VARI_SYSVAR_DA_DATA_TYP foreign key (DATA_TYPE_ID)
      references DATA_TYPE (ID);

alter table SYS_VARIABLE
   add constraint FK_SYS_VARI_SYSVAR_SY_SYS_ENTI foreign key (ENTITY_ID)
      references SYS_ENTITY (ID);
