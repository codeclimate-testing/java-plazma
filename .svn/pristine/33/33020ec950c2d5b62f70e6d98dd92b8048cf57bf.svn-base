...
/** 
 * @author Oleh Hapon
 * $Id: IndustryEditForm.java,v 1.2 2010/04/28 06:31:07 ohapon Exp $
 */

public class IndustryEditForm extends AbstractEditForm {
     ...
     * @param style
     */
    public IndustryEditForm(Composite parent, int style) {
	super(parent, style);
	initialize();
	...
	setTitle(Messages.getString("IndustryEditForm.title")); //$NON-NLS-1$
	GridData gridData;
	...
	codeLabel.setText(Messages.getString("IndustryEditForm.codeLabel.text")); //$NON-NLS-1$
	...
	nameLabel.setText(Messages.getString("IndustryEditForm.nameLabel.text")); //$NON-NLS-1$
