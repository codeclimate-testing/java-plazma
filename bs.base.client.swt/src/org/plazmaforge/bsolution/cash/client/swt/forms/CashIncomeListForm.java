...
/** 
 * @author Oleh Hapon
 * $Id: CashIncomeListForm.java,v 1.6 2010/12/05 07:57:22 ohapon Exp $
 */

public class CashIncomeListForm extends AbstractFinanceDocumentListForm {
    ...
    public CashIncomeListForm(Composite parent, int style) {
	super(parent, style);
	initialize();
    }
	...
	setTitle(Messages.getString("CashIncomeListForm.title")); //$NON-NLS-1$
        ...
        documentNoColumn.setText(Messages.getString("CashIncomeListForm.documentNoColumn.text")); //$NON-NLS-1$

        documentDateColumn = new TableColumn(table, SWT.NONE);
        documentDateColumn.setMoveable(true);
        documentDateColumn.setWidth(100);
        documentDateColumn.setText(Messages.getString("CashIncomeListForm.documentDateColumn.text")); //$NON-NLS-1$

        contractorColumn = new TableColumn(table, SWT.NONE);
        contractorColumn.setMoveable(true);
        contractorColumn.setWidth(250);
        contractorColumn.setText(Messages.getString("CashIncomeListForm.partnerColumn.text")); //$NON-NLS-1$
        ...
        paymentMissingColumn.setText(Messages.getString("CashIncomeListForm.paymentMissingColumn.text")); //$NON-NLS-1$

        
        currencyTotalColumn = new TableColumn(table, SWT.RIGHT);
        currencyTotalColumn.setMoveable(true);
        currencyTotalColumn.setWidth(100);
        currencyTotalColumn.setText(Messages.getString("CashIncomeListForm.currencyTotalColumn.text"));    	 //$NON-NLS-1$
    	
        responsibleColumn = new TableColumn(table, SWT.NONE);
        responsibleColumn.setMoveable(true);
        responsibleColumn.setWidth(200);
        responsibleColumn.setText(Messages.getString("CashIncomeListForm.responsibleColumn.text")); //$NON-NLS-1$
