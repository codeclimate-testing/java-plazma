 ...
 * 
 * @author Oleh Hapon
 * $Id: CarServOrderItemEditFormRP.java,v 1.4 2010/12/05 07:53:48 ohapon Exp $
 */
public class CarServOrderItemEditFormRP extends AbstractGoodsDocumentItemEditForm {
    ...
    public  CarServOrderItemEditFormRP(Composite parent, int style) {
	super(parent, style);
	initialize();
    }
