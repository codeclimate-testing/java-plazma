 ...
 * Date: 26.09.2004
 * Time: 10:07:53
 * $Id: EducationInstituteList.java,v 1.3 2010/12/05 07:56:44 ohapon Exp $
 */
public class EducationInstituteList extends EXTListForm {

    public EducationInstituteList() throws ApplicationException {
        super(GUIPersonalityEnvironment.getResources());
        initialize();
    }

    public EducationInstituteList(Window window) throws ApplicationException {
    ...
    private void initialize() {
        ...
        this.setEntityEditFormClass(EducationInstituteEdit.class);
    }
