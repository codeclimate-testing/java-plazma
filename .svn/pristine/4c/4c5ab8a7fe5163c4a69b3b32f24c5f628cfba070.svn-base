...
public class NewDictionaryAction extends GUIBaseAction {

    public void perform(ActionEvent e) throws ApplicationException {
	List entities = ((SystemEntityService) ServiceFactory
		.getService(SystemEntityService.class))
		.findByEntityType("DICTIONARY");
