...
package org.plazmaforge.bsolution.cash.server.services;
...
/** 
 * @author Oleh Hapon
 * $Id: CashCompressionExecutorImpl.java,v 1.3 2010/12/05 07:56:03 ohapon Exp $
 */

public class CashCompressionExecutorImpl extends BaseCompressionExecutor implements CashCompressionExecutor {

    private final String PRODUCT_DOCUMENT_TYPE_SET = "'CASH'"; // TODO: STUB
