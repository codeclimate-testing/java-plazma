...
public class PartnerCategoryListForm_Gen extends ListForm {


  public PartnerCategoryListForm_Gen() {
  }
  ...
  public void createUI() {
    ...
    setName("PartnerCategoryListForm");
    setType("ListForm");
    setTitle(getString("PartnerCategoryListForm.title"));
  ...
  public Composite createContent() {
    ...
    column1.setText(getString("PartnerCategoryListForm.nameColumn.text"));
