...
/** 
 * @author Oleh Hapon
 * $Id: InventoryOutcomeListForm.java,v 1.6 2010/12/05 07:57:21 ohapon Exp $
 */

public class InventoryOutcomeListForm extends AbstractFinanceDocumentListForm {
    ...
    public InventoryOutcomeListForm(Composite parent, int style) {
	super(parent, style);
	initialize();
    }
	...
	setTitle(Messages.getString("InventoryOutcomeListForm.title")); //$NON-NLS-1$
        ...
        documentNoColumn.setText(Messages.getString("InventoryOutcomeListForm.documentNoColumn.text")); //$NON-NLS-1$

        documentDateColumn = new TableColumn(table, SWT.NONE);
        documentDateColumn.setMoveable(true);
        documentDateColumn.setWidth(100);
        documentDateColumn.setText(Messages.getString("InventoryOutcomeListForm.documentDateColumn.text")); //$NON-NLS-1$

        partnerColumn = new TableColumn(table, SWT.NONE);
        partnerColumn.setMoveable(true);
        partnerColumn.setWidth(200);
        partnerColumn.setText(Messages.getString("InventoryOutcomeListForm.partnerColumn.text")); //$NON-NLS-1$
    	
        warehouseColumn = new TableColumn(table, SWT.NONE);
        warehouseColumn.setMoveable(true);
        warehouseColumn.setWidth(100);
        warehouseColumn.setText(Messages.getString("InventoryOutcomeListForm.warehouseColumn.text")); //$NON-NLS-1$
        ...
        mtrlResponsibleColumn.setText(Messages.getString("InventoryOutcomeListForm.mtrlResponsibleColumn.text")); //$NON-NLS-1$
    	
        currencyTotalColumn = new TableColumn(table, SWT.RIGHT);
        currencyTotalColumn.setMoveable(true);
        currencyTotalColumn.setWidth(120);
        currencyTotalColumn.setText(Messages.getString("InventoryOutcomeListForm.currencyTotalColumn.text"));    	 //$NON-NLS-1$
    	
        currencyColumn = new TableColumn(table, SWT.CENTER);
        currencyColumn.setMoveable(true);
        currencyColumn.setWidth(70);
        currencyColumn.setText(Messages.getString("InventoryOutcomeListForm.currencyColumn.text")); //$NON-NLS-1$
        
        totalColumn = new TableColumn(table, SWT.RIGHT);
        totalColumn.setMoveable(true);
        totalColumn.setWidth(120);
        totalColumn.setText(Messages.getString("InventoryOutcomeListForm.totalColumn.text")); //$NON-NLS-1$
    }
