 ...
 * Date: 19.09.2004
 * Time: 12:38:04
 * $Id: MilitaryRankEdit.java,v 1.3 2010/12/05 07:56:44 ohapon Exp $
 */
public class MilitaryRankEdit extends EXTEditForm {
    ...
    public MilitaryRankEdit() throws ApplicationException {
    ...
    private MilitaryRank getMilitaryRank() {
        return (MilitaryRank) this.getEntity();
    }

    protected void updateView() throws ApplicationException {
        appendTitle(getMilitaryRank().getName());
        codeField.setText(getMilitaryRank().getCode());
        nameField.setText(getMilitaryRank().getName());
    }

    protected void populateData() throws ApplicationException {
        getMilitaryRank().setCode(codeField.getText());
        getMilitaryRank().setName(nameField.getText());
    }
