...
/** 
 * @author Oleh Hapon
 * $Id: SaleTaxWaybillEditForm.java,v 1.7 2010/12/05 07:57:21 ohapon Exp $
 */

public class SaleTaxWaybillEditForm extends AbstractGoodsDocumentEditForm {
     ...
     * @param style
     */
    public SaleTaxWaybillEditForm(Composite parent, int style) {
	super(parent, style);
	initialize();
	...
	setTitle(Messages.getString("SaleTaxWaybillEditForm.title")); //$NON-NLS-1$
	setLayout(gridLayout);
    	...
    	generalTabItem.setText(Messages.getString("SaleTaxWaybillEditForm.generalTabItem.text")); //$NON-NLS-1$
    	...
    	documentNoLabel.setText(Messages.getString("SaleTaxWaybillEditForm.documentNoLabel.text")); //$NON-NLS-1$
	...
	documentDateLabel.setText(Messages.getString("SaleTaxWaybillEditForm.documentDateLabel.text")); //$NON-NLS-1$
	...
	gridData = new GridData(SWT.FILL, SWT.CENTER, false, false);
    	...
    	partnerLabel.setText(Messages.getString("SaleTaxWaybillEditForm.partnerLabel.text")); //$NON-NLS-1$
	...
	responsibleLabel.setText(Messages.getString("SaleTaxWaybillEditForm.responsibleLabel.text")); //$NON-NLS-1$
	...
	contractLabel.setText(Messages.getString("SaleTaxWaybillEditForm.contractLabel.text")); //$NON-NLS-1$
	...
	reasonDocumentLabel.setText(Messages.getString("SaleTaxWaybillEditForm.reasonDocumentLabel.text")); //$NON-NLS-1$
	...
	reasonLabel.setText(Messages.getString("SaleTaxWaybillEditForm.reasonLabel.text")); //$NON-NLS-1$
	...
	gridData = new GridData();
    	...
    	currencyLabel.setText(Messages.getString("SaleTaxWaybillEditForm.currencyLabel.text")); //$NON-NLS-1$
	...
	currencyRateLabel.setText(Messages.getString("SaleTaxWaybillEditForm.currencyRateLabel.text")); //$NON-NLS-1$
	...
	currencyRateDateLabel.setText(Messages.getString("SaleTaxWaybillEditForm.currencyRateDateLabel.text")); //$NON-NLS-1$
	...
	gridData = new GridData(SWT.FILL, SWT.CENTER, false, false);
    	...
    	noteTabItem.setText(Messages.getString("SaleTaxWaybillEditForm.noteTabItem.text")); //$NON-NLS-1$
    	...
    	createItemPanel();
    	createSummaryPanel();
    	AttributeValueView attributeView = new AttributeValueView(itemsTabFolder, SaleTaxWaybill.class);
    ...
    private void createItemPanel() {
        ...
        productTabItem.setText(Messages.getString("SaleTaxWaybillEditForm.productTabItem.text")); //$NON-NLS-1$
        ...
        productNameColumn.setText(Messages.getString("SaleTaxWaybillEditForm.productNameColumn.text")); //$NON-NLS-1$

        TableColumn unitNameColumn = new TableColumn(productTable, SWT.CENTER);
        unitNameColumn.setWidth(60);
        unitNameColumn.setText(Messages.getString("SaleTaxWaybillEditForm.unitNameColumn.text")); //$NON-NLS-1$

        TableColumn unitRateColumn = new TableColumn(productTable, SWT.RIGHT);
        unitRateColumn.setWidth(50);
        unitRateColumn.setText(Messages.getString("SaleTaxWaybillEditForm.unitRateColumn.text")); //$NON-NLS-1$

        TableColumn quantityColumn = new TableColumn(productTable, SWT.RIGHT);
        quantityColumn.setWidth(80);
        quantityColumn.setText(Messages.getString("SaleTaxWaybillEditForm.quanityColumn.text")); //$NON-NLS-1$
         
        TableColumn currencyPriceColumn = new TableColumn(productTable, SWT.RIGHT);
        currencyPriceColumn.setWidth(80);
        currencyPriceColumn.setText(Messages.getString("SaleTaxWaybillEditForm.currencyPriceColumn.text")); //$NON-NLS-1$
        
        TableColumn currencyAmountColumn = new TableColumn(productTable, SWT.RIGHT);
        currencyAmountColumn.setWidth(80);
        currencyAmountColumn.setText(Messages.getString("SaleTaxWaybillEditForm.currencyAmountColumn.text"));       //$NON-NLS-1$
        
        TableColumn currencyTaxAmountColumn = new TableColumn(productTable, SWT.RIGHT);
        currencyTaxAmountColumn.setWidth(80);
        currencyTaxAmountColumn.setText(Messages.getString("SaleTaxWaybillEditForm.currencyTaxAmountColumn.text"));         //$NON-NLS-1$
	...
	gridData = new GridData(SWT.FILL, SWT.CENTER, false, false);
    	...
    	currencyTotalLabel.setText(Messages.getString("SaleTaxWaybillEditForm.currencyTotalLabel.text")); //$NON-NLS-1$
	...
	gridData = new GridData();
    	...
    	currencyTaxTotalLabel.setText(Messages.getString("SaleTaxWaybillEditForm.currencyTaxTotalLabel.text")); //$NON-NLS-1$
	...
	gridData = new GridData();
    	...
    	currencyTotalWithTaxLabel.setText(Messages.getString("SaleTaxWaybillEditForm.currencyTotalWithTaxLabel.text")); //$NON-NLS-1$
	...
	public ProductItemProvider() {
	    setParentEntityClass(SaleTaxWaybill.class); // OWNER
	    setEntityClass(SaleTaxWaybillItem.class); // FORM ID
    ...
    private SaleTaxWaybill getSaleTaxWaybill() {
        return (SaleTaxWaybill) this.getEntity();
    }

    protected void initData() throws ApplicationException {
        super.initData();
        getSaleTaxWaybill().setPartner(EnterpriseEnvironment.getCustomer());
    }
