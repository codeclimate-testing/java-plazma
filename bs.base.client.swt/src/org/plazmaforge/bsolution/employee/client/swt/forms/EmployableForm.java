...
/** 
 * @author Oleh Hapon
 * $Id: EmployableForm.java,v 1.2 2010/04/28 06:31:04 ohapon Exp $
 */

public interface EmployableForm {
    ...
    void setPeriodId(Integer periodId);

    EmployeeHeader getEmployee();

    void setEmployee(EmployeeHeader employee);
}
