...
/**
 * @author Oleh Hapon Date: 21.09.2004 Time: 8:39:35 $Id: LanguageList.java,v 1.3 2010/12/05 07:56:44 ohapon Exp $
 */
public class LanguageList extends EXTListForm {

    public LanguageList() throws ApplicationException {
	super(GUIBaseEnvironment.getResources());
	initialize();
    }

    public LanguageList(Window window) throws ApplicationException {
	...
	this.setEntityEditFormClass(LanguageEdit.class);
    }
