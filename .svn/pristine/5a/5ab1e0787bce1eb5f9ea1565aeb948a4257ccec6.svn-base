 ...
 * Date: 15.08.2004
 * Time: 15:36:57
 * $Id: GUIGoodsAction.java,v 1.2 2010/04/28 06:28:13 ohapon Exp $
 */
public abstract class GUIGoodsAction extends ResourceAction {


    public GUIGoodsAction() {
        super(GUIGoodsEnvironment.getResources());
    }

    public GUIGoodsAction(Resources resources) {
