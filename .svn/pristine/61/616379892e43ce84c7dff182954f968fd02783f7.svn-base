...
/** 
 * @author Oleh Hapon
 * $Id: PurchasePlanEditForm.java,v 1.6 2010/12/05 07:57:18 ohapon Exp $
 */

public class PurchasePlanEditForm extends AbstractGoodsDocumentEditForm {
     ...
     * @param style
     */
    public PurchasePlanEditForm(Composite parent, int style) {
	super(parent, style);
	initialize();
	...
	setTitle(Messages.getString("PurchasePlanEditForm.title")); //$NON-NLS-1$
	setLayout(gridLayout);
    	...
    	generalTabItem.setText(Messages.getString("PurchasePlanEditForm.generalTabItem.text")); //$NON-NLS-1$
    	...
    	documentNoLabel.setText(Messages.getString("PurchasePlanEditForm.documentNoLabel.text")); //$NON-NLS-1$
	...
	documentDateLabel.setText(Messages.getString("PurchasePlanEditForm.documentDateLabel.text")); //$NON-NLS-1$
	...
	gridData = new GridData(SWT.FILL, SWT.CENTER, false, false);
    	...
    	priceTypeLabel.setText(Messages.getString("PurchasePlanEditForm.priceTypeLabel.text")); //$NON-NLS-1$
	...
	responsibleLabel.setText(Messages.getString("PurchasePlanEditForm.responsibleLabel.text")); //$NON-NLS-1$
	...
	departmentLabel.setText(Messages.getString("PurchasePlanEditForm.departmentLabel.text")); //$NON-NLS-1$
	...
	if (isProjectInDocument()) {
	    ...
	    projectLabel.setText(Messages.getString("PurchasePlanEditForm.projectLabel.text")); //$NON-NLS-1$
	...
	gridData = new GridData();
    	...
    	currencyLabel.setText(Messages.getString("PurchasePlanEditForm.currencyLabel.text")); //$NON-NLS-1$
	...
	currencyRateLabel.setText(Messages.getString("PurchasePlanEditForm.currencyRateLabel.text")); //$NON-NLS-1$
	...
	currencyRateDateLabel.setText(Messages.getString("PurchasePlanEditForm.currencyRateDateLabel.text")); //$NON-NLS-1$
	...
	gridData = new GridData(SWT.FILL, SWT.CENTER, false, false);
    	...
    	noteTabItem.setText(Messages.getString("PurchasePlanEditForm.noteTabItem.text")); //$NON-NLS-1$
    ...
    private void createItemPanel() {
        ...
        productTabItem.setText(Messages.getString("PurchasePlanEditForm.productTabItem.text")); //$NON-NLS-1$
        ...
        productNameColumn.setText(Messages.getString("PurchasePlanEditForm.productNameColumn.text")); //$NON-NLS-1$

        TableColumn unitNameColumn = new TableColumn(productTable, SWT.CENTER);
        unitNameColumn.setWidth(60);
        unitNameColumn.setText(Messages.getString("PurchasePlanEditForm.unitNameColumn.text")); //$NON-NLS-1$

        TableColumn unitRateColumn = new TableColumn(productTable, SWT.RIGHT);
        unitRateColumn.setWidth(50);
        unitRateColumn.setText(Messages.getString("PurchasePlanEditForm.unitRateColumn.text")); //$NON-NLS-1$

        TableColumn quantityColumn = new TableColumn(productTable, SWT.RIGHT);
        quantityColumn.setWidth(80);
        quantityColumn.setText(Messages.getString("PurchasePlanEditForm.quantityColumn.text")); //$NON-NLS-1$
         
        TableColumn currencyPriceColumn = new TableColumn(productTable, SWT.RIGHT);
        currencyPriceColumn.setWidth(80);
        currencyPriceColumn.setText(Messages.getString("PurchasePlanEditForm.currencyPriceColumn.text")); //$NON-NLS-1$
        
        TableColumn currencyAmountColumn = new TableColumn(productTable, SWT.RIGHT);
        currencyAmountColumn.setWidth(80);
        currencyAmountColumn.setText(Messages.getString("PurchasePlanEditForm.currencyAmountColumn.text"));       //$NON-NLS-1$
        
        TableColumn currencyTaxAmountColumn = new TableColumn(productTable, SWT.RIGHT);
        currencyTaxAmountColumn.setWidth(80);
        currencyTaxAmountColumn.setText(Messages.getString("PurchasePlanEditForm.currencyTaxAmountColumn.text"));         //$NON-NLS-1$
	...
	gridData = new GridData(SWT.FILL, SWT.CENTER, false, false);
    	...
    	currencyTotalLabel.setText(Messages.getString("PurchasePlanEditForm.currencyTotalLabel.text")); //$NON-NLS-1$
	...
	gridData = new GridData();
    	...
    	currencyTaxTotalLabel.setText(Messages.getString("PurchasePlanEditForm.currencyTaxTotalLabel.text")); //$NON-NLS-1$
	...
	gridData = new GridData();
    	...
    	currencyTotalWithTaxLabel.setText(Messages.getString("PurchasePlanEditForm.currencyTotalWithTaxLabel.text")); //$NON-NLS-1$
	...
	public ProductItemProvider() {
	    setParentEntityClass(PurchasePlan.class); // OWNER
	    setEntityClass(PurchasePlanItem.class); // FORM ID
    ...
    private PurchasePlan getPurchasePlan() {
        return (PurchasePlan) getEntity();
    }
    
    protected void initData() throws ApplicationException {
        super.initData();
        getPurchasePlan().setResponsible(getDefaultResponsible());
    }  
