...
import org.plazmaforge.bsolution.base.client.swing.forms.UserList;
 ...
 */
public class UserListAction extends GUIBaseAction {

    public void perform(ActionEvent e) throws ApplicationException {
	SwingFormManager.showListForm(UserList.class);
    }
}
