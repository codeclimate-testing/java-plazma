...
public class TaskTypeList extends EXTListForm {

    public TaskTypeList() throws ApplicationException {
	super(GUIProjectEnvironment.getResources());
	initialize();
    }

    public TaskTypeList(Window window) throws ApplicationException {
	...
	this.setEntityEditFormClass(TaskTypeEdit.class);
    }
