...
/** 
 * @author Oleh Hapon
 * $Id: InventoryWriteoffItemEditForm.java,v 1.2 2010/04/28 06:31:08 ohapon Exp $
 */

public class InventoryWriteoffItemEditForm extends AbstractGoodsDocumentItemEditForm {
    ...
    public  InventoryWriteoffItemEditForm(Composite parent, int style) {
	super(parent, style);
	initialize();
    }
	...
	goodsLabel.setText(Messages.getString("InventoryWriteoffItemEditForm.goodsLabel.text")); //$NON-NLS-1$
	...
	unitLabel = new Label(this, SWT.NONE);
    	unitLabel.setText(Messages.getString("InventoryWriteoffItemEditForm.unitLabel.text")); //$NON-NLS-1$
	...
	unitRateLabel.setText(Messages.getString("InventoryWriteoffItemEditForm.unitRateLabel.text")); //$NON-NLS-1$
	...
	quantityLabel.setText(Messages.getString("InventoryWriteoffItemEditForm.quantityLabel.text")); //$NON-NLS-1$
	...
	currencyPriceLabel.setText(Messages.getString("InventoryWriteoffItemEditForm.currencyPriceLabel.text")); //$NON-NLS-1$
	...
	currencyAmountLabel.setText(Messages.getString("InventoryWriteoffItemEditForm.currencyAmountLabel.text")); //$NON-NLS-1$
