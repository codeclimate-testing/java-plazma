 ...
 * Date: 26.02.2004
 * Time: 9:49:47
 * $Id: AddCycleAction.java,v 1.3 2010/12/05 07:52:08 ohapon Exp $
 */
public class AddCycleAction  extends ListFormAction {

    public AddCycleAction(ListForm listForm, Resources resources) {
        super(listForm, resources);
    }

    public void perform(ActionEvent evt) throws ApplicationException {
        listForm.doEditCommand(EditableMode.ADD_CYCLE);
    }
