...
public class SaleOrderList extends AbstractFinanceDocumentList {

    public SaleOrderList() throws ApplicationException {
        super(GUIGoodsEnvironment.getResources());
        initialize();
    }

    public SaleOrderList(Window window) throws ApplicationException {
    ...
    private void initialize() {
        ...
        this.setEntityEditFormClass(SaleOrderEdit.class);
    }
