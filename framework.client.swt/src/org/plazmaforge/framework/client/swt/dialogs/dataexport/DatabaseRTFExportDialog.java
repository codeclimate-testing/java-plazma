...
/** 
 * @author Oleh Hapon
 * $Id: DatabaseRTFExportDialog.java,v 1.11 2010/05/16 09:47:54 ohapon Exp $
 */

public class DatabaseRTFExportDialog extends RTFExportDialog {

      
    public DatabaseRTFExportDialog(Shell parentShell) {
	super(parentShell);
    }
