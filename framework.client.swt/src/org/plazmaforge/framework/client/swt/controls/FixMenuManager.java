 ...
 * </p>
 */
public class FixMenuManager extends ContributionManager implements IMenuManager {
     ...
     */
    public FixMenuManager(String text) {
        this(text, null, null);
    }
     ...
     */
    public FixMenuManager(String text, String id) {
        this(text, null, id);
    }
     ...
     * @since 3.4
     */
    public FixMenuManager(String text, ImageDescriptor image, String id) {
        this.menuText = text;
        this.image = image;
        this.id = id;
    }
    ...
    public Menu createMenu(Menu parent) {
        if (!menuExist()) {
            menu = new Menu(parent);
            initializeMenu();
        }
