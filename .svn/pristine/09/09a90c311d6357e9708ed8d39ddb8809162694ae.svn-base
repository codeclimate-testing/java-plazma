 ...
 */
public class XDataTypeComboBox extends XComboBox {

    public XDataTypeComboBox() {
	init();
    }

    private void init() {
	try {
	    List items = ((DataTypeService) ServiceFactory.getService(DataTypeService.class)).findAll();
