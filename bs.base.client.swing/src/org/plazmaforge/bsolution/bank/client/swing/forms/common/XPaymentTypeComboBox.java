 ...
 * Date: 18.07.2004
 * Time: 19:31:52
 * $Id: XPaymentTypeComboBox.java,v 1.3 2010/12/05 07:56:46 ohapon Exp $
 */
public class XPaymentTypeComboBox extends XComboBox {

    public XPaymentTypeComboBox() throws DAOException {
        super(((PaymentTypeService) ServiceFactory.getService(PaymentTypeService.class)).findAll());
    }
