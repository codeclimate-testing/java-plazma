...
public class TaskStatusListForm_Gen extends ListForm {


  public TaskStatusListForm_Gen() {
  }
  ...
  public void createUI() {
    ...
    setName("TaskStatusListForm");
    setType("ListForm");
    setTitle(getString("TaskStatusListForm.title"));
  ...
  public Composite createContent() {
    ...
    column1.setText(getString("TaskStatusListForm.nameColumn.text"));
    ...
    column2.setText(getString("TaskStatusListForm.descriptionColumn.text"));
    ...
    column3.setText(getString("TaskStatusListForm.codeColumn.text"));
    ...
    column4.setText(getString("TaskStatusListForm.startColumn.text"));
    ...
    column5.setText(getString("TaskStatusListForm.finishColumn.text"));
