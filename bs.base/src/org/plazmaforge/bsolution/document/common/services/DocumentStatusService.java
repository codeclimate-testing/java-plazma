...
public interface DocumentStatusService extends EntityService<DocumentStatus, Integer> {

    List<DocumentStatus> findByType(String documentType) throws DAOException;
}
