...
/** 
 * @author Oleh Hapon
 * $Id: TaskTypeEditForm.java,v 1.1 2008/12/01 12:27:17 ohapon Exp $
 */

public class TaskTypeEditForm extends AbstractEditForm {
     ...
     * @param style
     */
    public TaskTypeEditForm(Composite parent, int style) {
	super(parent, style);
	initialize();
	...
	setTitle(Messages.getString("TaskTypeEditForm.title")); //$NON-NLS-1$
	GridData gridData;
	...
	codeLabel.setText(Messages.getString("TaskTypeEditForm.codeLabel.text")); //$NON-NLS-1$
	...
	nameLabel.setText(Messages.getString("TaskTypeEditForm.nameLabel.text")); //$NON-NLS-1$
	...
	descriptionLabel.setLayoutData(new GridData(SWT.LEFT, SWT.TOP, false, false));
    	descriptionLabel.setText(Messages.getString("TaskTypeEditForm.descriptionLabel.text")); //$NON-NLS-1$
