...
import org.plazmaforge.bsolution.base.client.swt.dialogs.AboutDialog;
...
/** 
 * @author Oleh Hapon
 * $Id: AboutAction.java,v 1.3 2010/12/05 07:57:18 ohapon Exp $
 */

public class AboutAction extends DefaultAction {

    public void execute() throws ApplicationException {
	AboutDialog dialog = new AboutDialog(SWTEnvironment.getShell()); 
	dialog.open();
    }
}
