 ...
 * Date: 19.09.2004
 * Time: 12:20:22
 * $Id: FamilyStatusList.java,v 1.3 2010/12/05 07:56:44 ohapon Exp $
 */
public class FamilyStatusList extends EXTListForm {

    public FamilyStatusList() throws ApplicationException {
        super(GUIPersonalityEnvironment.getResources());
        initialize();
    }

    public FamilyStatusList(Window window) throws ApplicationException {
    ...
    private void initialize() {
        ...
        this.setEntityEditFormClass(FamilyStatusEdit.class);
    }
    ...
    protected void initShell() throws ApplicationException {
        super.initShell();
        getShell().setSize(300,DEFAULT_HEIGHT);
    }
