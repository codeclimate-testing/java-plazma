 ...
 * Date: 26.02.2004
 * Time: 9:34:45
 * $Id: ListFormAction.java,v 1.2 2010/04/28 06:36:09 ohapon Exp $
 */
public abstract class ListFormAction extends ResourceAction {

    protected ListForm listForm;

    public ListFormAction(ListForm listForm, Resources resources) {
        super(resources);
        if (listForm == null) {
            throw new IllegalArgumentException("ListForm is null");
        }
