...
import org.plazmaforge.bsolution.inventory.common.beans.InventoryOutcome;
import org.plazmaforge.bsolution.inventory.common.beans.InventoryOutcomeItem;
...
/** 
 * @author Oleh Hapon
 * $Id: InventoryOutcomeEditForm.java,v 1.7 2010/12/05 07:57:21 ohapon Exp $
 */

public class InventoryOutcomeEditForm extends AbstractGoodsDocumentEditForm {
     ...
     * @param style
     */
    public InventoryOutcomeEditForm(Composite parent, int style) {
	super(parent, style);
	initialize();
	...
	setTitle(Messages.getString("InventoryOutcomeEditForm.title")); //$NON-NLS-1$
	setLayout(gridLayout);
    	...
    	generalTabItem.setText(Messages.getString("InventoryOutcomeEditForm.generalTabItem.text")); //$NON-NLS-1$
    	...
    	documentNoLabel.setText(Messages.getString("InventoryOutcomeEditForm.documentNoLabel.text")); //$NON-NLS-1$
	...
	documentDateLabel.setText(Messages.getString("InventoryOutcomeEditForm.documentDateLabel.text")); //$NON-NLS-1$
	...
	gridData = new GridData(SWT.FILL, SWT.CENTER, false, false);
    	...
    	partnerLabel.setText(Messages.getString("InventoryOutcomeEditForm.partnerLabel.text")); //$NON-NLS-1$
	...
	warehouseLabel.setText(Messages.getString("InventoryOutcomeEditForm.warehouseLabel.text")); //$NON-NLS-1$
	...
	mtrlResponsibleLabel.setText(Messages.getString("InventoryOutcomeEditForm.mtrlResponsibleLabel.text")); //$NON-NLS-1$
	...
	contractLabel.setText(Messages.getString("InventoryOutcomeEditForm.contractLabel.text")); //$NON-NLS-1$
	...
	reasonDocumentLabel.setText(Messages.getString("InventoryOutcomeEditForm.reasonDocumentLabel.text")); //$NON-NLS-1$
	...
	reasonLabel.setText(Messages.getString("InventoryOutcomeEditForm.reasonLabel.text")); //$NON-NLS-1$
	...
	gridData = new GridData();
    	...
    	currencyLabel.setText(Messages.getString("InventoryOutcomeEditForm.currencyLabel.text")); //$NON-NLS-1$
	...
	currencyRateLabel.setText(Messages.getString("InventoryOutcomeEditForm.currencyRateLabel.text")); //$NON-NLS-1$
	...
	currencyRateDateLabel.setText(Messages.getString("InventoryOutcomeEditForm.currencyRateDateLabel.text")); //$NON-NLS-1$
	...
	gridData = new GridData(SWT.FILL, SWT.CENTER, false, false);
    	...
    	noteTabItem.setText(Messages.getString("InventoryOutcomeEditForm.noteTabItem.text")); //$NON-NLS-1$
    	...
    	createSummaryPanel();
    	AttributeValueView attributeView = new AttributeValueView(itemsTabFolder, InventoryOutcome.class);
    ...
    private void createItemPanel() {
        ...
        productTabItem.setText(Messages.getString("InventoryOutcomeEditForm.productTabItem.text")); //$NON-NLS-1$
        ...
        productNameColumn.setText(Messages.getString("InventoryOutcomeEditForm.productNameColumn.text")); //$NON-NLS-1$

        TableColumn unitNameColumn = new TableColumn(productTable, SWT.CENTER);
        unitNameColumn.setWidth(60);
        unitNameColumn.setText(Messages.getString("InventoryOutcomeEditForm.unitNameColumn.text")); //$NON-NLS-1$

        TableColumn unitRateColumn = new TableColumn(productTable, SWT.RIGHT);
        unitRateColumn.setWidth(50);
        unitRateColumn.setText(Messages.getString("InventoryOutcomeEditForm.unitRateColumn.text")); //$NON-NLS-1$

        TableColumn quantityColumn = new TableColumn(productTable, SWT.RIGHT);
        quantityColumn.setWidth(80);
        quantityColumn.setText(Messages.getString("InventoryOutcomeEditForm.quantityColumn.text")); //$NON-NLS-1$
         
        TableColumn currencyPriceColumn = new TableColumn(productTable, SWT.RIGHT);
        currencyPriceColumn.setWidth(80);
        currencyPriceColumn.setText(Messages.getString("InventoryOutcomeEditForm.currencyPriceColumn.text")); //$NON-NLS-1$
        
        TableColumn currencyAmountColumn = new TableColumn(productTable, SWT.RIGHT);
        currencyAmountColumn.setWidth(80);
        currencyAmountColumn.setText(Messages.getString("InventoryOutcomeEditForm.currencyAmountColumn.text"));       //$NON-NLS-1$
        
        TableColumn currencyTaxAmountColumn = new TableColumn(productTable, SWT.RIGHT);
        currencyTaxAmountColumn.setWidth(80);
        currencyTaxAmountColumn.setText(Messages.getString("InventoryOutcomeEditForm.currencyTaxAmountColumn.text"));         //$NON-NLS-1$
	...
	gridData = new GridData(SWT.FILL, SWT.CENTER, false, false);
    	...
    	currencyTotalLabel.setText(Messages.getString("InventoryOutcomeEditForm.currencyTotalLabel.text")); //$NON-NLS-1$
	...
	gridData = new GridData();
    	...
    	currencyTaxTotalLabel.setText(Messages.getString("InventoryOutcomeEditForm.currencyTaxTotalLabel.text")); //$NON-NLS-1$
	...
	gridData = new GridData();
    	...
    	currencyTotalWithTaxLabel.setText(Messages.getString("InventoryOutcomeEditForm.currencyTotalWithTaxLabel.text")); //$NON-NLS-1$
	...
	public ProductItemProvider() {
	    setParentEntityClass(InventoryOutcome.class); // OWNER
	    setEntityClass(InventoryOutcomeItem.class); // FORM ID
    ...
    private InventoryOutcome getInventoryOutcome() {
	return (InventoryOutcome) getEntity();
    }

    protected void initData() throws ApplicationException {
	super.initData();
	getInventoryOutcome().setPartner(EnterpriseEnvironment.getCustomer());
	getInventoryOutcome().setMtrlResponsible(EnterpriseEnvironment.getMtrlResponsible());
	getInventoryOutcome().setWarehouse(EnterpriseEnvironment.getOutcomeWharehouse());
    }
