...
public class TaskResultList extends EXTListForm {

    public TaskResultList() throws ApplicationException {
	super(GUIProjectEnvironment.getResources());
	initialize();
    }

    public TaskResultList(Window window) throws ApplicationException {
	...
	this.setEntityEditFormClass(TaskResultEdit.class);
    }
