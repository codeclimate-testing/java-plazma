...
public class XTreeComboEdit extends XComboEdit {
    ...
    public XTreeComboEdit(Composite parent, int style) {
	super(parent, style);
    }


    public XTreeComboEdit(Composite parent, int style, int toolStyle) {
