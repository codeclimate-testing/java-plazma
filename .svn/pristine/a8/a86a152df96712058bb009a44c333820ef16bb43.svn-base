 ...
 * 
 * @author Oleh Hapon
 * $Id: ReinitSytemAction.java,v 1.6 2010/12/05 07:57:18 ohapon Exp $
 */
public class ReinitSytemAction extends SWTProcessAction {
	...
	runner.setConfirmMessage(Messages.getString("ReinitSytemAction.confirm"));
	runner.setResultMessage(Messages.getString("ReinitSytemAction.result"));
    }
