 ...
 * @author Oleh Hapon
 * 
 * $Id: BooleanUtils.java,v 1.3 2010/04/28 06:34:30 ohapon Exp $
 */
...
public class BooleanUtils {
    ...
    /**
     * Return string presentation of boolean value.
     * If value is false and isNullIfFalse is true then return null.
     * @param value
     * @param isNullIfFalse
     * @return
     */
...
*/    
     ...
     * @return
     */
    public static String getBooleanStringNullIfFalse(boolean value) {
	if (!value) {
	    return null;
	}
	return toBooleanString(value);
     ...
     * @return
     */
    public static String getBooleanStringNullIfTrue(boolean value) {
	if (value) {
	    return null;
	}
	return toBooleanString(value);
