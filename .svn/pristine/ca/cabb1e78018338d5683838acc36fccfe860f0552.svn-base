 ...
 * @author Oleh Hapon
 *
 * $Id: LedgerAccountRestService.java,v 1.2 2010/04/28 06:24:29 ohapon Exp $
 * 
 */

public interface LedgerAccountRestService extends DocumentService<LedgerAccountRest, Integer> {
