...
import org.plazmaforge.bsolution.finance.common.beans.CurrencyHolder;
...
public class Project extends ProjectHeader implements ICurrencyHolder, ITaxHolder, IEntityConfigurable, IStatusEntity  {
