...
public class EJBServiceLocator extends AbstractInvokeServiceLocator {

 
    protected ServiceInvoker getServiceInvoker() throws Exception {
	return EJBServiceEnvironment.getStatelessSessionBean();
    }
    
    protected ServiceProxy getServiceProxy(ServiceInvoker invoker) {
	return new EJBServiceProxy(invoker);
    }
