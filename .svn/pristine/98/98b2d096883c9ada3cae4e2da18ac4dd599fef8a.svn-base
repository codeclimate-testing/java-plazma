...
public class SaleServItemEditForm extends AbstractGoodsDocumentItemEditForm {
	...
	goodsLabel.setText(Messages.getString("SaleServItemEditForm.goodsLabel.text")); //$NON-NLS-1$
	...
	gridData.widthHint = 300;
    	...
    	productFeatureLabel.setText(Messages.getString("SaleServItemEditForm.productFeatureLabel.text")); //$NON-NLS-1$
	...
	unitLabel = new Label(this, SWT.NONE);
    	unitLabel.setText(Messages.getString("SaleServItemEditForm.unitLabel.text")); //$NON-NLS-1$
	...
	unitRateLabel.setText(Messages.getString("SaleServItemEditForm.unitRateLabel.text")); //$NON-NLS-1$
	...
	quantityLabel.setText(Messages.getString("SaleServItemEditForm.quantityLabel.text")); //$NON-NLS-1$
	...
	currencyPriceLabel.setText(Messages.getString("SaleServItemEditForm.currencyPriceLabel.text")); //$NON-NLS-1$
	...
	currencyAmountLabel.setText(Messages.getString("SaleServItemEditForm.currencyAmountLabel.text")); //$NON-NLS-1$
	...
	taxLabel.setText(Messages.getString("SaleServItemEditForm.taxLabel.text")); //$NON-NLS-1$
	...
	currencyTaxAmountLabel.setText(Messages.getString("SaleServItemEditForm.currencyTaxAmountLabel.text")); //$NON-NLS-1$
