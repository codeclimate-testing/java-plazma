...
/** 
 * @author Oleh Hapon
 * $Id: ProductableService.java,v 1.3 2010/04/28 06:24:26 ohapon Exp $
 */

public interface ProductableService<E, PK extends Serializable> extends OrganizableService<E, PK>, BusinessableService<E, PK>,

	AttributeServiceHolder, FileServiceHolder {
