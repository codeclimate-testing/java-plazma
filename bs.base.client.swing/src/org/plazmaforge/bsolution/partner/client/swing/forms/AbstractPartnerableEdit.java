 ...
 *
 */
public abstract class AbstractPartnerableEdit extends EXTEditForm implements PartnerableForm {

    private IPartnerHeader partner;
    
    public AbstractPartnerableEdit(Resources resources) {
        super(resources);
    }

    public AbstractPartnerableEdit() {
        super();
    }
