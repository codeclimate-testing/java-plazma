 ...
 *
 */
package org.plazmaforge.bsolution.partner;
 ...
 *
 */
public class PartnerPackage extends DefaultPackage {
    
    public void init() {
    }
    
    public CompressionExecutor getCompressionExecutor() {
        return getCompressionExecutor(PartnerCompressionExecutor.class);
    }
