 ...
 * @author Oleh Hapon
 * 
 * $Id: SaleServItem.java,v 1.2 2010/04/28 06:24:24 ohapon Exp $
 *
 */
public class SaleServItem extends ProductDocumentItem {
	
	
    public SaleServ getSaleServ() {
        return (SaleServ) getProductDocument();
    }

    public void setSaleServ(SaleServ saleServ) {
        setProductDocument(saleServ);
    }
}
